...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->blurperformed:Z
...
.method protected makeStatusBarView(Lcom/android/internal/statusbar/RegisterStatusBarResult;)V
    ...
    iput-object v0, v7, Lcom/android/systemui/statusbar/phone/StatusBar;->mQSBlurView:Landroid/widget/ImageView;
...
.method public start()V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->loadPremiumTweaks(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setEdgeAnimOnUnreadNotifs(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setEdgeAnimRepeatCount(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setStatusbarAccentColor(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setStatusbarAccentColorQs(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setHorizonLightRepeatMode(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setNotificationColors(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setDisableSmartReplies(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setStatusbarDateSettings(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setAmbientWeather(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setQsExpansionVibration(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setQsBlur(Landroid/content/Context;)V
    
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setQsRamBar(Landroid/content/Context;)V
...
.method public onContentChanged(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setQsHeaderColorsForTheme(Landroid/content/Context;)V
    ...
    :cond_136
    const-string v0, "tweaks_statusbar_clock_day_color"
    ...
    :cond_137
    const-string v0, "tweaks_statusbar_clock_date_color"
    ...
    :cond_138
    const-string v0, "tweaks_right_volume_menu_landscape"
...
.method public registerObserver()V
    ...
    .line 72
    const-string v1, "tweaks_brightness_slider_position"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 73
    const-string v1, "tweaks_aod_appname"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 74
    const-string v1, "tweaks_aod_icon"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 75
    const-string v1, "tweaks_aod_title"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 76
    const-string v1, "tweaks_aod_small_text"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 77
    const-string v1, "tweaks_aod_fingerprint"
    ...
    .line 79
    const-string v1, "tweaks_edge_notif_unread"
    ...
    .line 137
    const-string v1, "tweaks_notification_primary_text_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 138
    const-string v1, "tweaks_notification_secondary_text_color"
    ...
    .line 142
    const-string v1, "tweaks_show_statusbar_date"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 143
    const-string v1, "tweaks_show_statusbar_day"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 144
    const-string v1, "tweaks_statusbar_day_style"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 145
    const-string v1, "tweaks_statusbar_year_style"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 146
    const-string v1, "tweaks_statusbar_date_layout"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 147
    const-string v1, "tweaks_statusbar_date_format"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 148
    const-string v1, "tweaks_statusbar_clock_ampm_style"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 149
    const-string v1, "tweaks_statusbar_date_divider_style"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 150
    const-string v1, "tweaks_statusbar_day_size"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 151
    const-string v1, "tweaks_statusbar_hour_size"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 152
    const-string v1, "tweaks_statusbar_date_size"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 153
    const-string v1, "tweaks_statusbar_clock_hour_font"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 154
    const-string v1, "tweaks_statusbar_date_font"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 155
    const-string v1, "tweaks_statusbar_day_font"
    ...
    .line 158
    const-string v1, "tweaks_notification_header_text_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 159
    const-string v1, "tweaks_notification_expand_button_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 160
    const-string v1, "tweaks_notification_reply_button_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 161
    const-string v1, "tweaks_notification_other_text_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 162
    const-string v1, "tweaks_notification_other_button_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 163
    const-string v1, "tweaks_notification_smart_text_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 164
    const-string v1, "tweaks_notification_smart_outline_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_always_on_notifications"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_always_on_notifications_timeout"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_always_on_notifications_info"
    ...
    const-string v1, "tweaks_qs_ram_bar_used_background_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_qs_ram_bar_free_background_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_qs_ram_bar_used_text_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_qs_ram_bar_free_text_color"
    ...
    const-string v1, "tweaks_fp_dim_color"
    ...
    const-string v1, "tweaks_qs_scrim_lockscreen"
    ...
    const-string v1, "tweaks_statusbar_clock_day_color"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    
    const-string v1, "tweaks_statusbar_clock_date_color"
...
.method public updateEdgeNotificationAnimation()V
    .locals 1
...
.method static synthetic access$0001(Lcom/android/systemui/statusbar/phone/StatusBar;)I
    .locals 1
...
.method static synthetic access$1001(Lcom/android/systemui/statusbar/phone/StatusBar;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/systemui/statusbar/phone/StatusBar;->adjustBrightness(I)V

    return-void
.end method

.method static synthetic access$2020(Lcom/android/systemui/statusbar/phone/StatusBar;I)I
    .locals 0

    iput p1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLinger:I
...
.method private adjustBrightness(I)V
    ...
    iget v1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mScreenWidth:F
    ...
    sget-boolean v6, Lcom/android/mwilky/Renovate;->mAutoBrightnessEnabled:Z
    ...
    iget-object v7, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mDisplayManager:Landroid/hardware/display/DisplayManager;

    invoke-virtual {v7, v5}, Landroid/hardware/display/DisplayManager;->setTemporaryAutoBrightnessAdjustment(F)V

    new-instance v7, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$e1A66PKw22hxPtJd4s0OjQjRxFA;

    invoke-direct {v7, p0, v5}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$e1A66PKw22hxPtJd4s0OjQjRxFA;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;F)V
    ...
    iget v6, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mMinBrightness:I
    ...
    invoke-virtual {v7, v6}, Landroid/hardware/display/DisplayManager;->setTemporaryBrightness(I)V

    new-instance v7, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$gDlNxq6KeX-fQuzRTZ0jr-yPHc8;

    invoke-direct {v7, p0, v6}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBar$gDlNxq6KeX-fQuzRTZ0jr-yPHc8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;I)V
...
.method private prepareBrightness()V
    .locals 4
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mMinBrightness:I
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mPeekHeight:I
...
.method public brightnessControl(Landroid/view/MotionEvent;)V
    ...
    iput v5, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLinger:I
    ...
    iput-boolean v6, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mJustPeeked:Z
    ...
    iput v5, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mScreenWidth:F

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLongPressBrightnessChange:Ljava/lang/Runnable;

    invoke-virtual {v3, v5}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    const/16 v5, 0x2ee

    iget-object v6, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLongPressBrightnessChange:Ljava/lang/Runnable;
    ...
    iget v5, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLinger:I
    ...
    :cond_2
    iget v5, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mInitialTouchX:I
    ...
    iget v7, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mInitialTouchY:I
    ...
    iget-object v8, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mContext:Landroid/content/Context;
    ...
    iget v9, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLinger:I

    add-int/2addr v9, v6

    iput v9, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mLinger:I
    ...
    :cond_6
    iget v6, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mPeekHeight:I

    if-le v2, v6, :cond_7

    iput-boolean v5, p0, Lcom/android/systemui/statusbar/phone/StatusBar;->mJustPeeked:Z
...
.method public synthetic lambda$adjustBrightness$0$StatusBar(F)V
    .locals 3
...
.method public synthetic lambda$adjustBrightness$1$StatusBar(I)V
    .locals 3
...
.method updateNotificationTextColors()V
	.locals 3
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->updateNotificationViews()V
...
.method private sendTheme()V
    ...
    .line 47
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/StatusBar;->enableTheme(Ljava/util/HashMap;)I
    ...
    new-instance v2, Lcom/android/systemui/statusbar/phone/StatusBar$ColorsUpdate;

    invoke-direct {v2, p0}, Lcom/android/systemui/statusbar/phone/StatusBar$ColorsUpdate;-><init>(Lcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method updateHybridNotificationView()V
    .locals 2
    
    const-string v0, "hybrid_notification"
...
.method public updateBlurView()V
    ...
    invoke-virtual {v5, v0, v0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->setPanelAlpha(IZ)Z
...
.method public updateBlurVisibility()V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/phone/PanelView;->getExpandedFraction()F
...
.method public updateQsRamBar()V
    .locals 1
