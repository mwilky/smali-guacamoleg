...
.method public constructor <init>(Ljava/util/Set;Lorg/bouncycastle/util/dma;)V
    ...
    iput p1, p0, Lorg/bouncycastle/x509/sis;->rna:I

    sget-object p1, Ljava/util/Collections;->EMPTY_SET:Ljava/util/Set;

    iput-object p1, p0, Lorg/bouncycastle/x509/sis;->sna:Ljava/util/Set;
...
.method public _f()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/sis;->sna:Ljava/util/Set;
...
.method public clone()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/x509/tsu;->Vf()Lorg/bouncycastle/util/dma;
...
.method public getMaxPathLength()I
    ...
    iget p0, p0, Lorg/bouncycastle/x509/sis;->rna:I
...
.method public rtg(Ljava/util/Set;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/x509/sis;->sna:Ljava/util/Set;
...
.method protected you(Ljava/security/cert/PKIXParameters;)V
    ...
    iget v1, v0, Lorg/bouncycastle/x509/sis;->rna:I

    iput v1, p0, Lorg/bouncycastle/x509/sis;->rna:I

    new-instance v1, Ljava/util/HashSet;

    iget-object v0, v0, Lorg/bouncycastle/x509/sis;->sna:Ljava/util/Set;

    invoke-direct {v1, v0}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v1, p0, Lorg/bouncycastle/x509/sis;->sna:Ljava/util/Set;
