...
# instance fields
.field private Ana:Lorg/bouncycastle/x509/cno;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->vna:Z

    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->wna:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/bouncycastle/x509/kth;->xna:Ljava/math/BigInteger;

    iput-object v1, p0, Lorg/bouncycastle/x509/kth;->yna:[B
...
.method public V(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->wna:Z
...
.method public W(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->vna:Z
...
.method public ag()Lorg/bouncycastle/x509/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->Ana:Lorg/bouncycastle/x509/cno;
...
.method public bg()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->yna:[B
...
.method public cg()Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->xna:Ljava/math/BigInteger;
...
.method public clone()Ljava/lang/Object;
    ...
    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->vna:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->vna:Z

    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->wna:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->wna:Z

    iget-object v1, p0, Lorg/bouncycastle/x509/kth;->xna:Ljava/math/BigInteger;

    iput-object v1, v0, Lorg/bouncycastle/x509/kth;->xna:Ljava/math/BigInteger;

    iget-object v1, p0, Lorg/bouncycastle/x509/kth;->Ana:Lorg/bouncycastle/x509/cno;

    iput-object v1, v0, Lorg/bouncycastle/x509/kth;->Ana:Lorg/bouncycastle/x509/cno;
    ...
    iput-object p0, v0, Lorg/bouncycastle/x509/kth;->yna:[B
...
.method public cno([B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->yna:[B
...
.method public dg()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->wna:Z
...
.method public eg()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->vna:Z
...
.method public match(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/kth;->xna:Ljava/math/BigInteger;
    ...
    :cond_4
    iget-boolean v0, p0, Lorg/bouncycastle/x509/kth;->zna:Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/kth;->yna:[B
...
.method public sis(Ljava/math/BigInteger;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->xna:Ljava/math/BigInteger;
...
.method public zta(Lorg/bouncycastle/x509/cno;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->Ana:Lorg/bouncycastle/x509/cno;
