.class public Lorg/bouncycastle/asn1/bvj;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/asn1/bvj$zta;
    }
.end annotation


# static fields
.field private static final spa:J = 0xffffffffffff80L

.field private static final tpa:Ljava/util/concurrent/ConcurrentMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/asn1/bvj;->tpa:Ljava/util/concurrent/ConcurrentMap;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/asn1/bvj;->identifier:Ljava/lang/String;
...
.method constructor <init>(Lorg/bouncycastle/asn1/bvj;Ljava/lang/String;)V
    .locals 1
...
.method constructor <init>([B)V
    ...
    invoke-direct/range {p0 .. p0}, Lorg/bouncycastle/asn1/vdb;-><init>()V
    ...
    iput-object v2, v0, Lorg/bouncycastle/asn1/bvj;->identifier:Ljava/lang/String;

    invoke-static/range {p1 .. p1}, Lorg/bouncycastle/util/zta;->vdb([B)[B

    move-result-object v1

    iput-object v1, v0, Lorg/bouncycastle/asn1/bvj;->body:[B
...
.method private declared-synchronized getBody()[B
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/asn1/bvj;->body:[B
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/asn1/bvj;->zta(Ljava/io/ByteArrayOutputStream;)V

    invoke-virtual {v0}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/asn1/bvj;->body:[B
...
.method public static getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/bvj;
    .locals 3

    if-eqz p0, :cond_3

    instance-of v0, p0, Lorg/bouncycastle/asn1/bvj;
    ...
    instance-of v1, v0, Lorg/bouncycastle/asn1/bvj;
...
.method static wtn([B)Lorg/bouncycastle/asn1/bvj;
    ...
    sget-object v1, Lorg/bouncycastle/asn1/bvj;->tpa:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-direct {v0, p0}, Lorg/bouncycastle/asn1/bvj;-><init>([B)V

    :cond_0
    return-object v0
.end method

.method public static zta(Lorg/bouncycastle/asn1/lqr;Z)Lorg/bouncycastle/asn1/bvj;
    .locals 0
    ...
    instance-of p1, p0, Lorg/bouncycastle/asn1/bvj;
...
.method private zta(Ljava/io/ByteArrayOutputStream;)V
    .locals 7

    new-instance v0, Lorg/bouncycastle/asn1/ha;

    iget-object v1, p0, Lorg/bouncycastle/asn1/bvj;->identifier:Ljava/lang/String;

    invoke-direct {v0, v1}, Lorg/bouncycastle/asn1/ha;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ha;->nextToken()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v5, v6}, Lorg/bouncycastle/asn1/bvj;->zta(Ljava/io/ByteArrayOutputStream;J)V
    ...
    invoke-direct {p0, p1, v1}, Lorg/bouncycastle/asn1/bvj;->zta(Ljava/io/ByteArrayOutputStream;Ljava/math/BigInteger;)V

    :goto_0
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ha;->hasMoreTokens()Z
    ...
    invoke-direct {p0, p1, v1, v2}, Lorg/bouncycastle/asn1/bvj;->zta(Ljava/io/ByteArrayOutputStream;J)V
    ...
    invoke-direct {p0, p1, v2}, Lorg/bouncycastle/asn1/bvj;->zta(Ljava/io/ByteArrayOutputStream;Ljava/math/BigInteger;)V
...
.method private zta(Ljava/io/ByteArrayOutputStream;J)V
    .locals 5
...
.method private zta(Ljava/io/ByteArrayOutputStream;Ljava/math/BigInteger;)V
    .locals 5
...
.method public getId()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncycastle/asn1/bvj;->identifier:Ljava/lang/String;
...
.method public intern()Lorg/bouncycastle/asn1/bvj;
    .locals 2
...
.method public tsu(Lorg/bouncycastle/asn1/bvj;)Z
    .locals 2
...
.method public wa(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-direct {v0, p0, p1}, Lorg/bouncycastle/asn1/bvj;-><init>(Lorg/bouncycastle/asn1/bvj;Ljava/lang/String;)V
...
.method zta(Lorg/bouncycastle/asn1/vdb;)Z
    ...
    :cond_0
    instance-of v0, p1, Lorg/bouncycastle/asn1/bvj;
    ...
    iget-object p1, p1, Lorg/bouncycastle/asn1/bvj;->identifier:Ljava/lang/String;
