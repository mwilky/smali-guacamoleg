.class public Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/tsu;
.super Ljava/lang/Object;
.source ""


# static fields
.field public static final NBa:[Lorg/bouncycastle/asn1/bvj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/tsu;->NBa:[Lorg/bouncycastle/asn1/bvj;
...
.method public static you(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/wtn/you;
    ...
    new-instance v2, Lorg/bouncycastle/crypto/wtn/ywr;
    ...
    invoke-direct {v2, v3, v4, p0}, Lorg/bouncycastle/crypto/wtn/ywr;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v0, v1, v2}, Lorg/bouncycastle/crypto/wtn/qbh;-><init>(Ljava/math/BigInteger;Lorg/bouncycastle/crypto/wtn/ywr;)V
...
.method public static ywr(Lorg/bouncycastle/asn1/bvj;)Z
    .locals 4
    ...
    :goto_0
    sget-object v2, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/tsu;->NBa:[Lorg/bouncycastle/asn1/bvj;
...
.method static zta(Ljava/math/BigInteger;Ljava/security/interfaces/DSAParams;)Ljava/lang/String;
    .locals 3
    ...
    invoke-static {p0, v1, v2, p1}, Lorg/bouncycastle/util/zta;->zta([B[B[B[B)[B
...
.method public static zta(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/wtn/you;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->tj()Lorg/bouncycastle/crypto/wtn/oif;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->tj()Lorg/bouncycastle/crypto/wtn/oif;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->tj()Lorg/bouncycastle/crypto/wtn/oif;
...
.method static zta(Ljava/security/interfaces/DSAParams;)Lorg/bouncycastle/crypto/wtn/ywr;
    .locals 3
    ...
    invoke-direct {v0, v1, v2, p0}, Lorg/bouncycastle/crypto/wtn/ywr;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
