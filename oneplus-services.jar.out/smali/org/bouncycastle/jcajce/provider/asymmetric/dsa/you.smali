.class public Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;
.super Ljava/security/AlgorithmParametersSpi;
.source ""


# instance fields
.field Vla:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineGetEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->Vla:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v1}, Ljava/security/spec/DSAParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->Vla:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v2}, Ljava/security/spec/DSAParameterSpec;->getQ()Ljava/math/BigInteger;

    move-result-object v2

    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->Vla:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {p0}, Ljava/security/spec/DSAParameterSpec;->getG()Ljava/math/BigInteger;

    move-result-object p0

    invoke-direct {v0, v1, v2, p0}, Lorg/bouncycastle/asn1/x509/ywr;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method protected engineGetEncoded(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->sa(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->engineGetEncoded()[B
...
.method protected engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->zta(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->Vla:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineInit([B)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->Vla:Ljava/security/spec/DSAParameterSpec;
    :try_end_0
...
.method protected engineInit([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->sa(Ljava/lang/String;)Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/you;->engineInit([B)V
