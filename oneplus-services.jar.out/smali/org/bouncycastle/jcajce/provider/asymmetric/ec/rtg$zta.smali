...
# static fields
.field private static gma:Ljava/util/Hashtable;


# instance fields
.field Ula:Ljava/security/SecureRandom;

.field algorithm:Ljava/lang/String;

.field cma:Lorg/bouncycastle/crypto/ssp/bio;

.field configuration:Lorg/bouncycastle/jcajce/provider/config/sis;

.field ema:Z

.field fma:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->gma:Ljava/util/Hashtable;

    sget-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->gma:Ljava/util/Hashtable;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->cma:Lorg/bouncycastle/crypto/ssp/bio;

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->fma:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->Ula:Ljava/security/SecureRandom;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->ema:Z
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/config/sis;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->cma:Lorg/bouncycastle/crypto/ssp/bio;

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->fma:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->Ula:Ljava/security/SecureRandom;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->ema:Z
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->ema:Z
    ...
    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->cma:Lorg/bouncycastle/crypto/ssp/bio;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->fma:Ljava/lang/Object;
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->Ula:Ljava/security/SecureRandom;
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->Ula:Ljava/security/SecureRandom;
    ...
    invoke-interface {p1}, Lorg/bouncycastle/jcajce/provider/config/sis;->gwm()Lyou/zta/you/you/rtg;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->fma:Ljava/lang/Object;
    ...
    :goto_3
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->cma:Lorg/bouncycastle/crypto/ssp/bio;
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->ema:Z
...
.method protected ta(Ljava/lang/String;)Lyou/zta/you/you/tsu;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/InvalidAlgorithmParameterException;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/you;->Ga(Ljava/lang/String;)Lorg/bouncycastle/asn1/ibl/vju;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/jcajce/provider/config/sis;->lqr()Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ibl/vju;->Ei()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ibl/vju;->Di()Ljava/math/BigInteger;
...
.method protected zta(Lyou/zta/you/you/rtg;Ljava/security/SecureRandom;)Lorg/bouncycastle/crypto/wtn/gwm;
    ...
    invoke-virtual {p1}, Lyou/zta/you/you/rtg;->Ei()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p1}, Lyou/zta/you/you/rtg;->Di()Ljava/math/BigInteger;
...
.method protected zta(Ljava/lang/String;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/rtg$zta;->ta(Ljava/lang/String;)Lyou/zta/you/you/tsu;
