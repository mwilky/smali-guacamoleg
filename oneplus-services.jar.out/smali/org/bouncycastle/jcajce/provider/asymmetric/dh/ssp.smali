...
.field cma:Lorg/bouncycastle/crypto/ssp/sis;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->cma:Lorg/bouncycastle/crypto/ssp/sis;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->Ula:Ljava/security/SecureRandom;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->ema:Z
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->ema:Z
    ...
    invoke-interface {v1, v2}, Lorg/bouncycastle/jcajce/provider/config/sis;->cno(I)Ljavax/crypto/spec/DHParameterSpec;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->Ula:Ljava/security/SecureRandom;
    ...
    invoke-static {v4}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/gck;->ga(I)I

    move-result v4

    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->Ula:Ljava/security/SecureRandom;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->Ula:Ljava/security/SecureRandom;
    ...
    :goto_2
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->cma:Lorg/bouncycastle/crypto/ssp/sis;
    ...
    :cond_3
    :goto_3
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->cma:Lorg/bouncycastle/crypto/ssp/sis;
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->Ula:Ljava/security/SecureRandom;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->ema:Z
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/ssp;->cma:Lorg/bouncycastle/crypto/ssp/sis;
