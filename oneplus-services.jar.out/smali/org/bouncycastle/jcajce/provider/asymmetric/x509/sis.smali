.class Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;
...
.field private tna:Lorg/bouncycastle/asn1/bvj/tsu;

.field private una:Z


# direct methods
.method protected constructor <init>(Lorg/bouncycastle/asn1/x509/e$zta;)V
    .locals 0

    invoke-direct {p0}, Ljava/security/cert/X509CRLEntry;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->c:Lorg/bouncycastle/asn1/x509/e$zta;

    const/4 p1, 0x0

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->tna:Lorg/bouncycastle/asn1/bvj/tsu;

    return-void
.end method

.method protected constructor <init>(Lorg/bouncycastle/asn1/x509/e$zta;ZLorg/bouncycastle/asn1/bvj/tsu;)V
    .locals 0
    ...
    invoke-direct {p0, p2, p3}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->zta(ZLorg/bouncycastle/asn1/bvj/tsu;)Lorg/bouncycastle/asn1/bvj/tsu;
...
.method private _a(Z)Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->c:Lorg/bouncycastle/asn1/x509/e$zta;
...
.method private zta(ZLorg/bouncycastle/asn1/bvj/tsu;)Lorg/bouncycastle/asn1/bvj/tsu;
    ...
    :cond_0
    sget-object p1, Lorg/bouncycastle/asn1/x509/gwm;->tna:Lorg/bouncycastle/asn1/bvj;

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->ssp(Lorg/bouncycastle/asn1/bvj;)Lorg/bouncycastle/asn1/x509/gwm;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v0, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;

    if-eqz v0, :cond_1

    check-cast p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;

    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->c:Lorg/bouncycastle/asn1/x509/e$zta;

    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->c:Lorg/bouncycastle/asn1/x509/e$zta;
...
.method public getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->tna:Lorg/bouncycastle/asn1/bvj/tsu;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->_a(Z)Ljava/util/Set;
...
.method public getExtensionValue(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->ssp(Lorg/bouncycastle/asn1/bvj;)Lorg/bouncycastle/asn1/x509/gwm;
...
.method public getSerialNumber()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/e$zta;->ri()Lorg/bouncycastle/asn1/ywr;
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->getCriticalExtensionOIDs()Ljava/util/Set;
...
.method public hashCode()I
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->una:Z
    ...
    iput v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->hashValue:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->una:Z

    :cond_0
    iget p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->hashValue:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->getSerialNumber()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->getRevocationDate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/sis;->getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_0
    sget-object v5, Lorg/bouncycastle/asn1/x509/gwm;->reasonCode:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_1
    sget-object v5, Lorg/bouncycastle/asn1/x509/gwm;->tna:Lorg/bouncycastle/asn1/bvj;
