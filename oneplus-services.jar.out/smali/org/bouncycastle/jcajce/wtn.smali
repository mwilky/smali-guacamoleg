...
# instance fields
.field private final ABa:Lorg/bouncycastle/jcajce/cno;

.field private final BBa:Ljava/util/List;
...
.field private final CBa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.field private final DBa:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private final EBa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/bouncycastle/asn1/x509/zgw;",
...
.field private final FBa:Z

.field private final GBa:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.method private constructor <init>(Lorg/bouncycastle/jcajce/wtn$zta;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->zBa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->BBa:Ljava/util/List;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->CBa:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->DBa:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn;->GBa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn;->nna:I
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->EBa:Ljava/util/Map;
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->ona:Z
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->CBa:Ljava/util/Map;
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->ABa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->DBa:Ljava/util/List;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->BBa:Ljava/util/List;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->zBa:Ljava/security/cert/PKIXParameters;
...
# virtual methods
.method public Vf()Lorg/bouncycastle/jcajce/cno;
    .locals 0
...
.method public getTrustAnchors()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->GBa:Ljava/util/Set;
...
.method public isRevocationEnabled()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->FBa:Z
...
.method public rj()Ljava/util/Map;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public sj()Ljava/util/Map;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
