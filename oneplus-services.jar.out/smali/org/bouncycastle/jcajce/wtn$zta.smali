...
# instance fields
.field private ABa:Lorg/bouncycastle/jcajce/cno;

.field private BBa:Ljava/util/List;
...
.field private CBa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.field private EBa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/bouncycastle/asn1/x509/zgw;",
...
.field private GBa:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.field private final zBa:Ljava/security/cert/PKIXParameters;
...
.method public constructor <init>(Ljava/security/cert/PKIXParameters;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->BBa:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->CBa:Ljava/util/Map;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->DBa:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->EBa:Ljava/util/Map;

    const/4 v0, 0x0

    iput v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->nna:I

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ona:Z
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->zBa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ABa:Lorg/bouncycastle/jcajce/cno;
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->FBa:Z

    invoke-virtual {p1}, Ljava/security/cert/PKIXParameters;->getTrustAnchors()Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->GBa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ona:Z
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn$zta;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ABa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic igw(Lorg/bouncycastle/jcajce/wtn$zta;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->nna:I
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->FBa:Z
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->DBa:Ljava/util/List;
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->BBa:Ljava/util/List;
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->EBa:Ljava/util/Map;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->CBa:Ljava/util/Map;
...
.method static synthetic wtn(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->GBa:Ljava/util/Set;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->zBa:Ljava/security/cert/PKIXParameters;
...
# virtual methods
.method public U(Z)Lorg/bouncycastle/jcajce/wtn$zta;
    .locals 0

    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ona:Z

    return-object p0
.end method

.method public V(I)Lorg/bouncycastle/jcajce/wtn$zta;
    .locals 0

    iput p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->nna:I
...
.method public setRevocationEnabled(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->FBa:Z
...
.method public you(Lorg/bouncycastle/jcajce/cno;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ABa:Lorg/bouncycastle/jcajce/cno;
...
.method public zta(Lorg/bouncycastle/asn1/x509/zgw;Lorg/bouncycastle/jcajce/rtg;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->CBa:Ljava/util/Map;
...
.method public zta(Lorg/bouncycastle/asn1/x509/zgw;Lorg/bouncycastle/jcajce/you;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->EBa:Ljava/util/Map;
...
.method public zta(Lorg/bouncycastle/jcajce/rtg;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->BBa:Ljava/util/List;
...
.method public zta(Lorg/bouncycastle/jcajce/you;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->DBa:Ljava/util/List;
