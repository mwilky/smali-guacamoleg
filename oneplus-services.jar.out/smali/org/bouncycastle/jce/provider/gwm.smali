.class public Lorg/bouncycastle/jce/provider/gwm;
...
# direct methods
.method public constructor <init>(Lorg/bouncycastle/asn1/x509/dma;)V
    .locals 2
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jce/provider/gwm;->Uma:Z

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/gwm;->c:Lorg/bouncycastle/asn1/x509/dma;

    :try_start_0
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/dma;->Ng()Lorg/bouncycastle/asn1/x509/zta;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/gwm;->Rma:Ljava/lang/String;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/gwm;->Sma:[B
    ...
    :goto_0
    invoke-static {p0}, Lorg/bouncycastle/jce/provider/gwm;->zta(Ljava/security/cert/X509CRL;)Z

    move-result p1

    iput-boolean p1, p0, Lorg/bouncycastle/jce/provider/gwm;->Tma:Z
    :try_end_0
...
.method private Vs()Ljava/util/Set;
    .locals 6
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/gwm;->c:Lorg/bouncycastle/asn1/x509/dma;

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/dma;->Mh()Ljava/util/Enumeration;
    ...
    new-instance v4, Lorg/bouncycastle/jce/provider/ibl;

    iget-boolean v5, p0, Lorg/bouncycastle/jce/provider/gwm;->Tma:Z

    invoke-direct {v4, v3, v5, v2}, Lorg/bouncycastle/jce/provider/ibl;-><init>(Lorg/bouncycastle/asn1/x509/e$zta;ZLorg/bouncycastle/asn1/bvj/tsu;)V

    invoke-interface {v0, v4}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-boolean v4, p0, Lorg/bouncycastle/jce/provider/gwm;->Tma:Z
    ...
    sget-object v4, Lorg/bouncycastle/asn1/x509/gwm;->tna:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/gwm;->Uh()Lorg/bouncycastle/asn1/ssp;
...
.method private _a(Z)Ljava/util/Set;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getVersion()I
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/gwm;->c:Lorg/bouncycastle/asn1/x509/dma;
...
.method private zta(Ljava/security/PublicKey;Ljava/security/Signature;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/gwm;->c:Lorg/bouncycastle/asn1/x509/dma;

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/dma;->Ng()Lorg/bouncycastle/asn1/x509/zta;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getTBSCertList()[B

    move-result-object p1

    invoke-virtual {p2, p1}, Ljava/security/Signature;->update([B)V

    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getSignature()[B
...
.method public static zta(Ljava/security/cert/X509CRL;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/ire;->bi()Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    instance-of v0, p1, Lorg/bouncycastle/jce/provider/gwm;

    if-eqz v0, :cond_3

    check-cast p1, Lorg/bouncycastle/jce/provider/gwm;

    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/gwm;->Uma:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p1, Lorg/bouncycastle/jce/provider/gwm;->Uma:Z

    if-eqz v0, :cond_2

    iget v0, p1, Lorg/bouncycastle/jce/provider/gwm;->Vma:I

    iget v2, p0, Lorg/bouncycastle/jce/provider/gwm;->Vma:I
    ...
    iget-object p1, p1, Lorg/bouncycastle/jce/provider/gwm;->c:Lorg/bouncycastle/asn1/x509/dma;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/gwm;->_a(Z)Ljava/util/Set;
...
.method public getRevokedCertificate(Ljava/math/BigInteger;)Ljava/security/cert/X509CRLEntry;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/dma;->Mh()Ljava/util/Enumeration;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/e$zta;->ri()Lorg/bouncycastle/asn1/ywr;
    ...
    new-instance p1, Lorg/bouncycastle/jce/provider/ibl;

    iget-boolean p0, p0, Lorg/bouncycastle/jce/provider/gwm;->Tma:Z

    invoke-direct {p1, v3, p0, v2}, Lorg/bouncycastle/jce/provider/ibl;-><init>(Lorg/bouncycastle/asn1/x509/e$zta;ZLorg/bouncycastle/asn1/bvj/tsu;)V
...
.method public getRevokedCertificates()Ljava/util/Set;
    ...
    invoke-direct {p0}, Lorg/bouncycastle/jce/provider/gwm;->Vs()Ljava/util/Set;
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/gwm;->Rma:Ljava/lang/String;
...
.method public getSigAlgOID()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/dma;->Ng()Lorg/bouncycastle/asn1/x509/zta;
...
.method public getSigAlgParams()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/gwm;->Sma:[B
...
.method public getVersion()I
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/dma;->Lh()I
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getCriticalExtensionOIDs()Ljava/util/Set;
...
.method public hashCode()I
    ...
    iput v0, p0, Lorg/bouncycastle/jce/provider/gwm;->Vma:I

    :cond_0
    iget p0, p0, Lorg/bouncycastle/jce/provider/gwm;->Vma:I
...
.method public isRevoked(Ljava/security/cert/Certificate;)Z
    ...
    iget-boolean v6, p0, Lorg/bouncycastle/jce/provider/gwm;->Tma:Z
    ...
    sget-object v7, Lorg/bouncycastle/asn1/x509/gwm;->tna:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/x509/gwm;->Uh()Lorg/bouncycastle/asn1/ssp;
    ...
    :cond_1
    invoke-virtual {v5}, Lorg/bouncycastle/asn1/x509/e$zta;->ri()Lorg/bouncycastle/asn1/ywr;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getIssuerDN()Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getThisUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getNextUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getSigAlgName()Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, p0, Lorg/bouncycastle/jce/provider/gwm;->c:Lorg/bouncycastle/asn1/x509/dma;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/ugm;->Wh()Ljava/util/Enumeration;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/x509/gwm;->Th()Lorg/bouncycastle/asn1/ibl;
    ...
    :try_start_0
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->qra:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v7}, Lorg/bouncycastle/asn1/ywr;->Eg()Ljava/math/BigInteger;
    ...
    :cond_4
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->vna:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/asn1/ywr;->Eg()Ljava/math/BigInteger;
    ...
    :cond_5
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->yna:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_6
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->ura:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_7
    sget-object v6, Lorg/bouncycastle/asn1/x509/gwm;->Ara:Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_9
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/gwm;->getRevokedCertificates()Ljava/util/Set;
...
.method public verify(Ljava/security/PublicKey;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jce/provider/gwm;->zta(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jce/provider/gwm;->zta(Ljava/security/PublicKey;Ljava/security/Signature;)V
