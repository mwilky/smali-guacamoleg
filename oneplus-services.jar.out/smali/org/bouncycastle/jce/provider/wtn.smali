...
# instance fields
.field private Xma:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/x509/tsu;->Qf()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/x509/sis;->_f()Ljava/util/Set;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/bio;->oj()Lorg/bouncycastle/jcajce/wtn;

    move-result-object v1

    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/wtn;->Vf()Lorg/bouncycastle/jcajce/cno;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/wtn;->qj()Ljava/util/List;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/wtn;->Xma:Ljava/lang/Exception;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/wtn;->Xma:Ljava/lang/Exception;
...
.method protected zta(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/bio;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    :cond_0
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/bio;->_f()Ljava/util/Set;
    ...
    :try_start_1
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/bio;->oj()Lorg/bouncycastle/jcajce/wtn;
    ...
    :try_start_5
    sget-object v2, Lorg/bouncycastle/asn1/x509/gwm;->pra:Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/jcajce/wtn;->sj()Ljava/util/Map;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jce/provider/wtn;->Xma:Ljava/lang/Exception;
