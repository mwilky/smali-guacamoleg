...
.field private Txa:Lorg/bouncycastle/crypto/qbh;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;Lorg/bouncycastle/crypto/qbh;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->cma:Lorg/bouncycastle/crypto/zta;

    iput-object p3, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {p2}, Lorg/bouncycastle/crypto/qbh;->les()I

    move-result p1

    new-array p1, p1, [B

    iput-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
...
.method private zta([BIII)[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {v1}, Lorg/bouncycastle/crypto/qbh;->les()I
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object p4, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {p4, p1, p2, p3}, Lorg/bouncycastle/crypto/qbh;->update([BII)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;

    array-length p2, v2

    invoke-interface {p1, v2, v3, p2}, Lorg/bouncycastle/crypto/qbh;->update([BII)V

    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/zta;->Txa:Lorg/bouncycastle/crypto/qbh;
...
.method public b()Lorg/bouncycastle/crypto/zta;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/zta;->cma:Lorg/bouncycastle/crypto/zta;
...
.method public d()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->cma:Lorg/bouncycastle/crypto/zta;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/zta;->d()I

    move-result v0

    iget-boolean v1, p0, Lorg/bouncycastle/crypto/tsu/zta;->zwa:Z
...
.method public rtg([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/zta;->cma:Lorg/bouncycastle/crypto/zta;

    invoke-interface {p2}, Lorg/bouncycastle/crypto/zta;->ivd()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
    ...
    :goto_1
    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
    ...
    :goto_2
    iget-object v3, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
...
.method public ssp([BII)[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/tsu/zta;->d()I
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/zta;->Ula:Ljava/security/SecureRandom;
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
    ...
    :cond_0
    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/zta;->Sxa:[B
...
.method public you([BII)[B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->zwa:Z
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->Ula:Ljava/security/SecureRandom;

    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->cma:Lorg/bouncycastle/crypto/zta;

    invoke-interface {v0, p1, p2}, Lorg/bouncycastle/crypto/zta;->zta(ZLorg/bouncycastle/crypto/kth;)V

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->zwa:Z
