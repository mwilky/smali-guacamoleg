...
.field private final Pma:Lorg/bouncycastle/crypto/rtg;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->Pma:Lorg/bouncycastle/crypto/rtg;

    iget-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->Pma:Lorg/bouncycastle/crypto/rtg;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/rtg;->getBlockSize()I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I

    iget p1, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I

    new-array v0, p1, [B

    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->Uwa:[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->bxa:[B

    const/4 p1, 0x0

    iput p1, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
...
.method private e(J)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I

    int-to-long v0, v0

    add-long/2addr v0, p1

    iget v2, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/bio/kth;->mc(I)V
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/bio/kth;->lc(I)V

    iget v2, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/bio/kth;->kc(I)V
    ...
    invoke-direct {p0, v3}, Lorg/bouncycastle/crypto/bio/kth;->kc(I)V
    ...
    iput v3, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
    ...
    iget p2, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I

    add-int/2addr p2, p1

    iput p2, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
...
.method private gt()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->Uwa:[B

    array-length v0, v0

    iget v1, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I
    ...
    :goto_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/kth;->Uwa:[B
...
.method private lc(I)V
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/bio/kth;->mc(I)V
...
.method public getBlockSize()I
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/kth;->Pma:Lorg/bouncycastle/crypto/rtg;
...
.method public getPosition()J
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/kth;->Uwa:[B
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
...
.method public reset()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->Pma:Lorg/bouncycastle/crypto/rtg;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/rtg;->reset()V

    iput v1, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
...
.method protected sis(B)B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/kth;->bxa:[B

    invoke-interface {v0, v2, v1, v3, v1}, Lorg/bouncycastle/crypto/rtg;->zta([BI[BI)I

    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/kth;->bxa:[B

    iget v1, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/bouncycastle/crypto/bio/kth;->Zwa:I
    ...
    :cond_0
    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/kth;->bxa:[B
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/bio/kth;->mc(I)V

    invoke-direct {p0}, Lorg/bouncycastle/crypto/bio/kth;->gt()V
...
.method public skip(J)J
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/kth;->bxa:[B
...
.method public zta([BI[BI)I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/bio/kth;->Cwa:I
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/kth;->Uwa:[B
