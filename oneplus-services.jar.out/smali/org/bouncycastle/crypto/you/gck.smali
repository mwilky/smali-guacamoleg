...
# static fields
.field private static final Cxa:I = 0x5a827999

.field private static final Dxa:I = 0x6ed9eba1

.field private static final Exa:I = -0x70e44324

.field private static final Fxa:I = -0x359d3e2a

.field private static final kxa:I = 0x14
...
.method public constructor <init>([B)V
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/gck;->hxa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/gck;->ixa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/gck;->Bxa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/gck;->jxa:I

    const/4 v0, 0x0

    :goto_0
    iget v1, p0, Lorg/bouncycastle/crypto/you/gck;->jxa:I
...
.method private zta(Lorg/bouncycastle/crypto/you/gck;)V
    ...
    iget v0, p1, Lorg/bouncycastle/crypto/you/gck;->hxa:I
    ...
    iget v0, p1, Lorg/bouncycastle/crypto/you/gck;->ixa:I

    iput v0, p0, Lorg/bouncycastle/crypto/you/gck;->ixa:I

    iget v0, p1, Lorg/bouncycastle/crypto/you/gck;->Bxa:I
    ...
    iget p1, p1, Lorg/bouncycastle/crypto/you/gck;->jxa:I

    iput p1, p0, Lorg/bouncycastle/crypto/you/gck;->jxa:I
...
.method protected Xi()V
    ...
    :cond_0
    iget v1, p0, Lorg/bouncycastle/crypto/you/gck;->hxa:I

    iget v2, p0, Lorg/bouncycastle/crypto/you/gck;->H2:I

    iget v3, p0, Lorg/bouncycastle/crypto/you/gck;->H3:I

    iget v4, p0, Lorg/bouncycastle/crypto/you/gck;->ixa:I

    iget v5, p0, Lorg/bouncycastle/crypto/you/gck;->Bxa:I
    ...
    invoke-direct {p0, v3, v4, v7}, Lorg/bouncycastle/crypto/you/gck;->qbh(III)I
    ...
    invoke-direct {p0, v2, v3, v4}, Lorg/bouncycastle/crypto/you/gck;->qbh(III)I
    ...
    invoke-direct {p0, v5, v2, v3}, Lorg/bouncycastle/crypto/you/gck;->qbh(III)I
    ...
    invoke-direct {p0, v7, v5, v2}, Lorg/bouncycastle/crypto/you/gck;->qbh(III)I
    ...
    invoke-direct {p0, v4, v7, v5}, Lorg/bouncycastle/crypto/you/gck;->qbh(III)I
    ...
    iput v1, p0, Lorg/bouncycastle/crypto/you/gck;->hxa:I
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/you/gck;->ixa:I

    add-int/2addr v1, v7

    iput v1, p0, Lorg/bouncycastle/crypto/you/gck;->ixa:I

    iget v1, p0, Lorg/bouncycastle/crypto/you/gck;->Bxa:I

    add-int/2addr v1, v5

    iput v1, p0, Lorg/bouncycastle/crypto/you/gck;->Bxa:I

    iput v6, p0, Lorg/bouncycastle/crypto/you/gck;->jxa:I
...
.method protected cjf(J)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/you/gck;->jxa:I

    const/16 v1, 0xe

    if-le v0, v1, :cond_0

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/you/gck;->Xi()V
...
.method public doFinal([BI)I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/you/gck;->hxa:I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/you/gck;->ixa:I

    add-int/lit8 v1, p2, 0xc

    invoke-static {v0, p1, v1}, Lorg/bouncycastle/util/igw;->you(I[BI)V

    iget v0, p0, Lorg/bouncycastle/crypto/you/gck;->Bxa:I
...
.method public ire()[B
    ...
    :goto_0
    iget v2, p0, Lorg/bouncycastle/crypto/you/gck;->jxa:I
