...
.field private static final kxa:I = 0x1c
...
.method public constructor <init>([B)V
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->hxa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->ixa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->Bxa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->Gxa:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->jxa:I

    const/4 v0, 0x0

    :goto_0
    iget v1, p0, Lorg/bouncycastle/crypto/you/dma;->jxa:I
...
.method private zta(Lorg/bouncycastle/crypto/you/dma;)V
    ...
    iget v0, p1, Lorg/bouncycastle/crypto/you/dma;->hxa:I
    ...
    iget v0, p1, Lorg/bouncycastle/crypto/you/dma;->ixa:I

    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->ixa:I

    iget v0, p1, Lorg/bouncycastle/crypto/you/dma;->Bxa:I

    iput v0, p0, Lorg/bouncycastle/crypto/you/dma;->Bxa:I

    iget v0, p1, Lorg/bouncycastle/crypto/you/dma;->Gxa:I
    ...
    iget p1, p1, Lorg/bouncycastle/crypto/you/dma;->jxa:I

    iput p1, p0, Lorg/bouncycastle/crypto/you/dma;->jxa:I
...
.method protected Xi()V
    ...
    invoke-direct {p0, v3}, Lorg/bouncycastle/crypto/you/dma;->qc(I)I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/you/dma;->pc(I)I
    ...
    :cond_0
    iget v1, p0, Lorg/bouncycastle/crypto/you/dma;->hxa:I

    iget v2, p0, Lorg/bouncycastle/crypto/you/dma;->H2:I

    iget v3, p0, Lorg/bouncycastle/crypto/you/dma;->H3:I

    iget v4, p0, Lorg/bouncycastle/crypto/you/dma;->ixa:I

    iget v5, p0, Lorg/bouncycastle/crypto/you/dma;->Bxa:I

    iget v6, p0, Lorg/bouncycastle/crypto/you/dma;->Gxa:I

    iget v7, p0, Lorg/bouncycastle/crypto/you/dma;->Hxa:I

    iget v8, p0, Lorg/bouncycastle/crypto/you/dma;->Ixa:I
    ...
    invoke-direct {p0, v6}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v6, v7, v8}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v5}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v5, v6, v7}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v10}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v4, v5, v6}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v8}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v3}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v3, v4, v5}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v7}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v2, v3, v4}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v6}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v10}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v10, v2, v3}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v5}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v8}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v8, v10, v2}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    invoke-direct {p0, v7}, Lorg/bouncycastle/crypto/you/dma;->oc(I)I

    move-result v12

    invoke-direct {p0, v7, v8, v10}, Lorg/bouncycastle/crypto/you/dma;->ibl(III)I
    ...
    invoke-direct {p0, v3}, Lorg/bouncycastle/crypto/you/dma;->nc(I)I
    ...
    iput v1, p0, Lorg/bouncycastle/crypto/you/dma;->hxa:I
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/you/dma;->ixa:I

    add-int/2addr v1, v5

    iput v1, p0, Lorg/bouncycastle/crypto/you/dma;->ixa:I

    iget v1, p0, Lorg/bouncycastle/crypto/you/dma;->Bxa:I

    add-int/2addr v1, v6

    iput v1, p0, Lorg/bouncycastle/crypto/you/dma;->Bxa:I

    iget v1, p0, Lorg/bouncycastle/crypto/you/dma;->Gxa:I

    add-int/2addr v1, v7

    iput v1, p0, Lorg/bouncycastle/crypto/you/dma;->Gxa:I
    ...
    iput v9, p0, Lorg/bouncycastle/crypto/you/dma;->jxa:I
...
.method protected cjf(J)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/you/dma;->jxa:I

    const/16 v1, 0xe

    if-le v0, v1, :cond_0

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/you/dma;->Xi()V
...
.method public doFinal([BI)I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/you/dma;->hxa:I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/you/dma;->ixa:I

    add-int/lit8 v1, p2, 0xc

    invoke-static {v0, p1, v1}, Lorg/bouncycastle/util/igw;->you(I[BI)V

    iget v0, p0, Lorg/bouncycastle/crypto/you/dma;->Bxa:I

    add-int/lit8 v1, p2, 0x10

    invoke-static {v0, p1, v1}, Lorg/bouncycastle/util/igw;->you(I[BI)V

    iget v0, p0, Lorg/bouncycastle/crypto/you/dma;->Gxa:I
...
.method public ire()[B
    ...
    :goto_0
    iget v2, p0, Lorg/bouncycastle/crypto/you/dma;->jxa:I
