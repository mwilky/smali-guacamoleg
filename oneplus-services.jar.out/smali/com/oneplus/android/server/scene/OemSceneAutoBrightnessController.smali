...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v3, p0, Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;->mIsAutoBackSettingChangedByUsWhenBoot:Z
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;->mResolver:Landroid/content/ContentResolver;

    sget-object v2, Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;->URI_BLOCK_AUTO_BACKLIGHT_SETTING:Landroid/net/Uri;

    iget-object v3, p0, Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;->mBlockAutoBackLightSettingsContentObserver:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController$you;

    invoke-virtual {p1, v2, v0, v3, v1}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController;->mAutoBackLightSettingsContentObserver:Lcom/oneplus/android/server/scene/OemSceneAutoBrightnessController$zta;

    invoke-virtual {p1, v2, v0, p0, v1}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
