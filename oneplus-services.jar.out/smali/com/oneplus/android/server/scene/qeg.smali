...
.method constructor <init>(Lcom/oneplus/android/server/scene/ivd;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/qeg;->this$0:Lcom/oneplus/android/server/scene/ivd;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/qeg;->this$0:Lcom/oneplus/android/server/scene/ivd;

    invoke-static {p0}, Lcom/oneplus/android/server/scene/ivd;->you(Lcom/oneplus/android/server/scene/ivd;)Landroid/content/ContentResolver;
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/wtn$zta;->Td()V
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/qeg;->this$0:Lcom/oneplus/android/server/scene/ivd;

    invoke-static {p1, v3}, Lcom/oneplus/android/server/scene/ivd;->zta(Lcom/oneplus/android/server/scene/ivd;Z)Z

    iget-object p0, p0, Lcom/oneplus/android/server/scene/qeg;->this$0:Lcom/oneplus/android/server/scene/ivd;

    invoke-static {p0}, Lcom/oneplus/android/server/scene/ivd;->rtg(Lcom/oneplus/android/server/scene/ivd;)V
    ...
    invoke-static {p1}, Lcom/oneplus/android/server/scene/ivd;->dma(Lcom/oneplus/android/server/scene/ivd;)Z
    ...
    invoke-static {p1}, Lcom/oneplus/android/server/scene/ivd;->bio(Lcom/oneplus/android/server/scene/ivd;)Z
    ...
    invoke-static {p1, v3, p2}, Lcom/oneplus/android/server/scene/ivd;->zta(Lcom/oneplus/android/server/scene/ivd;ZZ)V

    iget-object p0, p0, Lcom/oneplus/android/server/scene/qeg;->this$0:Lcom/oneplus/android/server/scene/ivd;

    invoke-static {p0, p2}, Lcom/oneplus/android/server/scene/ivd;->zta(Lcom/oneplus/android/server/scene/ivd;Z)Z
    ...
    iget-object p2, p0, Lcom/oneplus/android/server/scene/qeg;->this$0:Lcom/oneplus/android/server/scene/ivd;

    invoke-static {p2}, Lcom/oneplus/android/server/scene/ivd;->igw(Lcom/oneplus/android/server/scene/ivd;)Landroid/content/Context;
    ...
    invoke-static {p2, v0, p1}, Lcom/oneplus/android/server/scene/ivd;->zta(Lcom/oneplus/android/server/scene/ivd;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-static {p0}, Lcom/oneplus/android/server/scene/ivd;->igw(Lcom/oneplus/android/server/scene/ivd;)Landroid/content/Context;
