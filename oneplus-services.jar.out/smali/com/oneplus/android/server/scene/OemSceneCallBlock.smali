...
.method static constructor <clinit>()V
    ...
    const-string v1, "persist.debug.scene.imcall"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Lcom/oneplus/android/server/scene/OemSceneCallBlock;->DBG_LOGV:Z

    const-string v1, "persist.debug.scene.dump"
...
.method private blockerEnabled(IZ)Z
    ...
    invoke-static {v1, v3, p1}, Landroid/provider/Settings$System;->getStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_4
    iput-boolean v2, p0, Lcom/oneplus/android/server/scene/OemSceneCallBlock;->mIsNotifyBlocked:Z
...
.method private initHandler()V
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/ugm;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lcom/oneplus/android/server/scene/ugm;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Landroid/os/Looper;)V
...
.method private initOnlineConfig()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneCallBlock;->mSceneCallBlockConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method private isCallBlocked(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)Z
    ...
    :goto_2
    invoke-direct {p0, p1, v3, v5}, Lcom/oneplus/android/server/scene/OemSceneCallBlock;->isForegroundAppWithUid(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string v5, ") is running in the foreground."
    ...
    const-string v5, ") is running in the background."
...
.method private popNotify(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;)V
    ...
    invoke-direct {v1, v7, v8, v13}, Lcom/oneplus/android/server/scene/oif;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;ILjava/lang/String;)V

    invoke-virtual {v0, v1}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v4, Lcom/oneplus/android/server/scene/bvj;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/oneplus/android/server/scene/bvj;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Landroid/content/Intent;ILjava/lang/String;Ljava/lang/String;I)V

    invoke-virtual {v12, v11}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v0, Lcom/oneplus/android/server/scene/ibl;

    invoke-direct {v0, v7, v8, v13}, Lcom/oneplus/android/server/scene/ibl;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;ILjava/lang/String;)V
...
.method private resolveAdditionalConfig(Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/oneplus/android/server/scene/gwm;

    invoke-direct {v0, p0, p1}, Lcom/oneplus/android/server/scene/gwm;-><init>(Lcom/oneplus/android/server/scene/OemSceneCallBlock;Ljava/lang/String;)V
...
.method public isCallBlockedWithUid(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ResolveInfo;I)Z
    ...
    const-string v2, "isCallBlockedWithUid"
...
.method public isMutedByCallBlocker(Ljava/lang/String;Landroid/media/AudioAttributes;)Z
    ...
    invoke-direct {p0, v1}, Lcom/oneplus/android/server/scene/OemSceneCallBlock;->isForegroundCalling(Ljava/lang/String;)Z
...
.method public isNotificationMutedByCallBlocker(Ljava/lang/String;ILandroid/service/notification/StatusBarNotification;)Z
    ...
    const-string p3, "game_mode_status"
...
.method public isVibratorUsageMutedByCallBlocker(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    const-string p3, "isVibratorUsageMutedByCallBlocker: vibrator usage("

    invoke-virtual {p1, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p2, ") will be blocked here"
