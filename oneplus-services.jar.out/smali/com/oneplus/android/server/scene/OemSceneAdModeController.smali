...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;
    }
.end annotation
...
# instance fields
.field private mAdModeObserver:Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mManualAdStatus:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mDaemon:Lsis/you/you/zta/zta/you;
    ...
    new-instance v0, Lcom/oneplus/android/server/scene/dma;

    invoke-direct {v0, p0}, Lcom/oneplus/android/server/scene/dma;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mDaemon:Lsis/you/you/zta/zta/you;
    :try_end_0
...
.method static synthetic access$200(Lcom/oneplus/android/server/scene/OemSceneAdModeController;)Lsis/you/you/zta/zta/you;
    .locals 0

    iget-object p0, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mDaemon:Lsis/you/you/zta/zta/you;
...
.method private initEnv(Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;

    invoke-direct {p1, p0}, Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;)V

    iput-object p1, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mAdModeObserver:Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;

    iget-object p1, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mResolver:Landroid/content/ContentResolver;

    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->URI_GAME_MODE_AD_ENABLE:Landroid/net/Uri;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mAdModeObserver:Lcom/oneplus/android/server/scene/OemSceneAdModeController$zta;
...
.method private setMode(II)V
    ...
    invoke-interface {p0, p1, p2}, Lsis/you/you/zta/zta/you;->setMode(II)V
    :try_end_0
...
.method private setModeByDefault(ZI)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->mDaemon:Lsis/you/you/zta/zta/you;
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/wtn;

    invoke-direct {v1, p0, p1, p2}, Lcom/oneplus/android/server/scene/wtn;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;ZI)V
...
.method private setModeSmoothly(ZI)V
    ...
    :cond_0
    new-instance v0, Lcom/oneplus/android/server/scene/gck;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/oneplus/android/server/scene/gck;-><init>(Lcom/oneplus/android/server/scene/OemSceneAdModeController;JJIZ)V
...
.method public onStart([Ljava/lang/String;)I
    ...
    const-string v0, "[scene] AdModeController: start"
...
.method public onStop([Ljava/lang/String;)I
    ...
    const-string v0, "[scene] AdModeController: stop"
    ...
    invoke-direct {p0, v0, p1}, Lcom/oneplus/android/server/scene/OemSceneAdModeController;->setModeByDefault(ZI)V
