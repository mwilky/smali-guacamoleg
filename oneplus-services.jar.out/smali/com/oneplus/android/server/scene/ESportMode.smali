...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/oneplus/android/server/scene/ESportMode$zta;
    }
.end annotation
...
.field private mReceiver:Lcom/oneplus/android/server/scene/ESportMode$zta;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/ESportMode;->mESportGuider:Lcom/oneplus/android/server/scene/tsu;
...
.method private static getIExtTelephony()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/ESportMode;->sIExtTelephony:Ljava/lang/Object;
...
.method private listenForConfigChanged()V
    ...
    new-instance v2, Lcom/oneplus/android/server/scene/ssp;

    invoke-direct {v2, p0}, Lcom/oneplus/android/server/scene/ssp;-><init>(Lcom/oneplus/android/server/scene/ESportMode;)V
...
.method public setEnable(ZZ)V
    ...
    :goto_0
    iget-object v1, p0, Lcom/oneplus/android/server/scene/ESportMode;->mESportGuider:Lcom/oneplus/android/server/scene/tsu;

    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/tsu;->isAcquired()Z
    ...
    invoke-virtual {v1}, Lcom/oneplus/android/server/scene/tsu;->hide()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/ESportMode;->mESportGuider:Lcom/oneplus/android/server/scene/tsu;

    new-instance v1, Lcom/oneplus/android/server/scene/cno;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/cno;-><init>(Lcom/oneplus/android/server/scene/ESportMode;)V

    invoke-virtual {v0, v1}, Lcom/oneplus/android/server/scene/tsu;->zta(Lcom/oneplus/android/server/scene/tsu$zta;)V

    iget-object v0, p0, Lcom/oneplus/android/server/scene/ESportMode;->mESportGuider:Lcom/oneplus/android/server/scene/tsu;

    invoke-virtual {v0}, Lcom/oneplus/android/server/scene/tsu;->show()V
