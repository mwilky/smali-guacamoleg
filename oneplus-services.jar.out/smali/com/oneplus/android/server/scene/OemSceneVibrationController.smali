...
.field private static vga:Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;

.field private static final wga:I

.field private static final xga:I
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController$VibrationMode;->vla:Lcom/oneplus/android/server/scene/OemSceneVibrationController$VibrationMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->wga:I

    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController$VibrationMode;->wla:Lcom/oneplus/android/server/scene/OemSceneVibrationController$VibrationMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->xga:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->uga:I
...
.method private a(IZ)V
    ...
    :try_start_0
    iget p2, p0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->uga:I

    shl-int p1, v1, p1

    or-int/2addr p1, p2

    iput p1, p0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->uga:I
...
.method public static canVibrationGo(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p0, p1}, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->rtg(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private rtg(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget p1, p0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->uga:I

    sget v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->wga:I
    ...
    :cond_0
    sget v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->xga:I

    and-int/2addr p1, v0

    if-eqz p1, :cond_1

    invoke-direct {p0, p2}, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->Hc(Ljava/lang/String;)Z
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/OemSceneVibrationController;IZ)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->a(IZ)V
...
# virtual methods
.method public sf()Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;
    .locals 1

    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->vga:Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->vga:Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;

    :cond_0
    sget-object p0, Lcom/oneplus/android/server/scene/OemSceneVibrationController;->vga:Lcom/oneplus/android/server/scene/OemSceneVibrationController$AllowWhiteVibration;
