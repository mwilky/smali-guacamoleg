...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;,
        Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$zta;
    }
.end annotation
...
.field private static sAwinicEffect:Lcom/oneplus/android/server/scene/kth;
...
.field private mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->sAwinicEffect:Lcom/oneplus/android/server/scene/kth;
    ...
    invoke-direct {v1, v4, v0, v3, v2}, Lcom/oneplus/core/oimc/OIMCRule;-><init>(Ljava/lang/String;I[Ljava/lang/String;I)V
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/a;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/a;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/b;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/b;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/c;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/c;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/d;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/d;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    new-instance v1, Lcom/oneplus/android/server/scene/e;

    invoke-direct {v1, p0}, Lcom/oneplus/android/server/scene/e;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V

    iput-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mTestReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mContext:Landroid/content/Context;
    ...
    new-instance p1, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;

    invoke-direct {p1, p0}, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;-><init>(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V

    iput-object p1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;
    ...
    sget-object v1, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->URI_OP_GAME_MODE_VIBRATE_FEEDBACK:Landroid/net/Uri;

    iget-object v2, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mTestReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$102(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mEnable:Z
...
.method static synthetic access$500()Lcom/oneplus/android/server/scene/kth;
    .locals 1

    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->sAwinicEffect:Lcom/oneplus/android/server/scene/kth;
...
.method static synthetic access$700(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    .locals 0
...
.method static synthetic access$800(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;)V
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->dump()V

    return-void
.end method

.method static synthetic access$900(Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->setParameters(Ljava/lang/String;)V
...
.method private dump()V
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mEnable:Z
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->configs:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->configs:Ljava/util/HashMap;
    ...
    iget-object v5, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->configs:Ljava/util/HashMap;
...
.method private enableAwinicHaptic(Z)V
    ...
    :cond_0
    sget-object p1, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->sAwinicEffect:Lcom/oneplus/android/server/scene/kth;

    invoke-virtual {p1, v4}, Lcom/oneplus/android/server/scene/kth;->zta(S)I

    sget-object p1, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->sAwinicEffect:Lcom/oneplus/android/server/scene/kth;

    invoke-virtual {p1, v4}, Lcom/oneplus/android/server/scene/kth;->setEnabled(Z)I
    ...
    invoke-virtual {v5}, Lcom/android/server/OnePlusUtil$zta;->z()Ljava/lang/String;
    ...
    invoke-virtual {p1, v3}, Lcom/oneplus/android/server/scene/kth;->setEnabled(Z)I

    sget-object p1, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->sAwinicEffect:Lcom/oneplus/android/server/scene/kth;

    int-to-short v1, v6

    invoke-virtual {p1, v1}, Lcom/oneplus/android/server/scene/kth;->zta(S)I
...
.method private getParametersFromConfig(Ljava/lang/String;)I
    ...
    check-cast p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$zta;

    if-eqz p0, :cond_0

    iget p0, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$zta;->yga:I
...
.method private loadConfig()V
    ...
    new-instance v6, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$zta;
    ...
    invoke-direct {v6, v7, v8, v3}, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$zta;-><init>(Ljava/lang/String;II)V
...
.method public static setHapticEffect(Lcom/oneplus/android/server/scene/kth;)V
    .locals 0

    sput-object p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->sAwinicEffect:Lcom/oneplus/android/server/scene/kth;
...
.method private updateVolume()V
    ...
    invoke-virtual {v0, p0}, Lcom/oneplus/android/server/scene/kth;->setVolume(F)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public disableFeatureWhenException()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController;->mVibrateFeedbackModeObserver:Lcom/oneplus/android/server/scene/OemSceneXLinearVibrationMotorController$you;
