...
.field private static final Tea:I

.field private static final Uea:I

.field private static sInstance:Lcom/oneplus/android/server/scene/OemSceneLightsController;


# instance fields
.field private Rea:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;->vla:Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Tea:I
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Uea:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sea:I
...
.method private bio(III)Z
    ...
    iget v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sea:I

    sget v1, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Tea:I
    ...
    :cond_0
    sget v1, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Uea:I

    and-int/2addr v0, v1

    if-eqz v0, :cond_1

    invoke-direct {p0, p1, p2, p3}, Lcom/oneplus/android/server/scene/OemSceneLightsController;->igw(III)Z
...
.method public static canSetLights(III)Z
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/oneplus/android/server/scene/OemSceneLightsController;->bio(III)Z
...
.method private ivd(IZ)V
    ...
    :try_start_0
    iget p2, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sea:I

    shl-int p1, v1, p1

    or-int/2addr p1, p2

    iput p1, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Sea:I
...
# virtual methods
.method public if()Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    .locals 1

    iget-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Rea:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Rea:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;

    :cond_0
    iget-object p0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->Rea:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
