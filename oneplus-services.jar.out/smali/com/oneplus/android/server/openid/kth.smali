...
.field private static final Tda:Ljava/lang/String; = "OpenIdConfigList"

.field private static final Uda:Ljava/lang/String; = "op_access_whitelist.xml"

.field private static final Vda:Ljava/lang/String; = "filter-conf"

.field private static final Wda:Ljava/lang/String; = "isOpen"

.field private static final XB:Ljava/lang/String; = "openid_config_values"

.field private static final Xda:Ljava/lang/String; = "forceOverride"

.field private static final YB:Ljava/lang/String; = "/data/heytap-id"

.field private static final Yda:Ljava/lang/String; = "openid_guid"

.field private static final Zda:Ljava/lang/String; = "guid_pkg"

.field private static final _da:Ljava/lang/String; = "openid_duid"

.field private static final aea:Ljava/lang/String; = "duid_pkg"

.field private static final bea:Ljava/lang/String; = "openid_apid"

.field private static final cea:Ljava/lang/String; = "apid_pkg"


# instance fields
.field private Nda:Lcom/oneplus/config/ConfigObserver;

.field private Oda:Ljava/lang/Object;

.field private Pda:Z

.field private Qda:Ljava/util/ArrayList;
...
.field private Rda:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field private Sda:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/android/server/openid/kth;->DEBUG:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/android/server/openid/kth$zta;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Oda:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lcom/oneplus/android/server/openid/kth;->mTotalCount:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/oneplus/android/server/openid/kth;->mEnabled:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/openid/kth;->Pda:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/openid/kth;->ds()Ljava/io/File;

    iget-object p1, p0, Lcom/oneplus/android/server/openid/kth;->Oda:Ljava/lang/Object;
    ...
    iget-boolean p2, p0, Lcom/oneplus/android/server/openid/kth;->Pda:Z

    if-nez p2, :cond_0

    invoke-direct {p0}, Lcom/oneplus/android/server/openid/kth;->es()V
...
.method private dma(Lorg/json/JSONArray;)V
    ...
    :cond_5
    iget p1, p0, Lcom/oneplus/android/server/openid/kth;->mTotalCount:I
    ...
    sget-boolean v1, Lcom/oneplus/android/server/openid/kth;->DEBUG:Z
    ...
    :try_start_1
    invoke-direct {p0, v0}, Lcom/oneplus/android/server/openid/kth;->you(Landroid/util/ArrayMap;)V

    iput v4, p0, Lcom/oneplus/android/server/openid/kth;->mTotalCount:I
...
.method private ds()Ljava/io/File;
    .locals 2
...
.method private es()V
    ...
    :cond_8
    invoke-direct {p0, v5}, Lcom/oneplus/android/server/openid/kth;->you(Landroid/util/ArrayMap;)V
    :try_end_1
...
.method private fs()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    iput-boolean v3, p0, Lcom/oneplus/android/server/openid/kth;->mEnabled:Z

    iget-object v3, p0, Lcom/oneplus/android/server/openid/kth;->mCallback:Lcom/oneplus/android/server/openid/kth$zta;

    if-eqz v3, :cond_1

    iget-object v3, p0, Lcom/oneplus/android/server/openid/kth;->mCallback:Lcom/oneplus/android/server/openid/kth$zta;

    iget-boolean v4, p0, Lcom/oneplus/android/server/openid/kth;->mEnabled:Z

    invoke-interface {v3, v4}, Lcom/oneplus/android/server/openid/kth$zta;->rtg(Z)V
    ...
    iput-boolean v3, p0, Lcom/oneplus/android/server/openid/kth;->Pda:Z

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "Get state of force override: "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p0, Lcom/oneplus/android/server/openid/kth;->Pda:Z
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    const-string v1, "Error while read whitelist config file"
...
.method private you(Landroid/util/ArrayMap;)V
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-boolean v9, v0, Lcom/oneplus/android/server/openid/kth;->Pda:Z
    ...
    iget-boolean v12, v0, Lcom/oneplus/android/server/openid/kth;->Pda:Z
    ...
    iget-boolean v4, v0, Lcom/oneplus/android/server/openid/kth;->Pda:Z

    if-eqz v4, :cond_1

    iput-object v13, v0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;

    iput-object v15, v0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;

    iput-object v12, v0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    iput-boolean v2, v0, Lcom/oneplus/android/server/openid/kth;->mEnabled:Z

    iget-object v2, v0, Lcom/oneplus/android/server/openid/kth;->mCallback:Lcom/oneplus/android/server/openid/kth$zta;

    if-eqz v2, :cond_5

    iget-object v2, v0, Lcom/oneplus/android/server/openid/kth;->mCallback:Lcom/oneplus/android/server/openid/kth$zta;

    iget-boolean v5, v0, Lcom/oneplus/android/server/openid/kth;->mEnabled:Z
    ...
    :cond_6
    iget-object v1, v0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;
    :try_end_3
    ...
    :cond_8
    iget-object v1, v0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-object v1, v0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/oneplus/android/server/openid/kth;->ds()Ljava/io/File;
...
.method static synthetic zta(Lcom/oneplus/android/server/openid/kth;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/openid/kth;->dma(Lorg/json/JSONArray;)V
...
.method public Ye()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/openid/kth;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Nda:Lcom/oneplus/config/ConfigObserver;

    iget-object p0, p0, Lcom/oneplus/android/server/openid/kth;->Nda:Lcom/oneplus/config/ConfigObserver;
...
.method public sis(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/openid/kth;->mEnabled:Z
    ...
    const-string v0, "FORCE_OVERRIDE="

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v0, p0, Lcom/oneplus/android/server/openid/kth;->Pda:Z
    ...
    const-string p2, "WHITELIST INFO:"
    ...
    iget-object p2, p0, Lcom/oneplus/android/server/openid/kth;->Oda:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Qda:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Rda:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/openid/kth;->Sda:Ljava/util/ArrayList;
