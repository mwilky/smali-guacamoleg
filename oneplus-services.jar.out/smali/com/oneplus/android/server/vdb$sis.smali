...
# static fields
.field private static final Rla:Ljava/lang/String; = "MotorSocketServer"

.field private static final Sla:I = 0x400

.field private static final Tla:I = 0x3

.field private static final _v:Ljava/lang/String; = "motor_socket"


# instance fields
.field private Pla:Z

.field private Qla:Landroid/net/LocalServerSocket;
...
.method public constructor <init>(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb$sis;->Pla:Z
...
.method public Nf()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->Pla:Z
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->Qla:Landroid/net/LocalServerSocket;

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->Pla:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->Qla:Landroid/net/LocalServerSocket;
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb$sis;->Pla:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb$sis;->Qla:Landroid/net/LocalServerSocket;
    ...
    :goto_2
    :try_start_5
    iget-object v1, p0, Lcom/oneplus/android/server/vdb$sis;->Qla:Landroid/net/LocalServerSocket;
