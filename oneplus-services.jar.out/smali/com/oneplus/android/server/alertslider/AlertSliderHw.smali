...
.field private static final UY:Ljava/lang/String; = "/sys/bus/platform/devices/soc:tri_state_key/hall_data_calib"

.field private static final VY:Ljava/lang/String; = "tri-state-key"

.field private static final WY:Ljava/lang/String; = "soc:tri_state_key"

.field private static final XY:I = 0x1

.field private static final YY:I = 0x2

.field private static final ZY:I = 0x4

.field private static final sW:Ljava/lang/String; = "/mnt/vendor/persist/engineermode/tri_state_hall_data"


# instance fields
.field private QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;

.field private RY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;

.field private SY:Lcom/oneplus/android/server/alertslider/zta;

.field private TY:Landroid/os/PowerManager$WakeLock;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->DEBUG:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/android/server/alertslider/zta;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->RY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;

    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->SY:Lcom/oneplus/android/server/alertslider/zta;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->TY:Landroid/os/PowerManager$WakeLock;
...
.method private Qb(I)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->mContext:Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->SY:Lcom/oneplus/android/server/alertslider/zta;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/alertslider/sis;->z(I)V
...
.method static synthetic access$200()Z
    ...
    sget-boolean v0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->DEBUG:Z
...
.method static synthetic you(Lcom/oneplus/android/server/alertslider/AlertSliderHw;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->TY:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic zta(Lcom/oneplus/android/server/alertslider/AlertSliderHw;)Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
...
.method static synthetic zta(Lcom/oneplus/android/server/alertslider/AlertSliderHw;I)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Qb(I)V
...
.method public getState()I
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->ue()Z
    ...
    iget-object v10, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    :goto_2
    sget-boolean v2, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->DEBUG:Z
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iget-object v5, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->QY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
...
.method public init()Z
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->RY:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;

    invoke-virtual {v1}, Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;->startMonitor()V

    :try_start_0
    invoke-virtual {p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->getState()I
    ...
    :try_start_1
    iget-object v2, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->SY:Lcom/oneplus/android/server/alertslider/zta;
    ...
    iput-object v2, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->SY:Lcom/oneplus/android/server/alertslider/zta;
    ...
    :cond_0
    invoke-direct {p0, v1}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Qb(I)V

    :cond_1
    const-string p0, "/mnt/vendor/persist/engineermode/tri_state_hall_data"

    invoke-static {v0, p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->readStringFromFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
