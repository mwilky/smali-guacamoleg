...
# static fields
.field private static final Aha:Ljava/lang/String; = "oneplus_basiccolor_white"

.field private static final Bha:Ljava/lang/String; = "oneplus_shape_circle"

.field private static final Cha:I = 0x1

.field private static final DEBUG:Z

.field private static Dha:Z = false
...
.field private static final lha:Ljava/lang/String; = "android.settings.oneplus_theme_enable"

.field private static mInstance:Lcom/oneplus/server/zta/sis; = null

.field private static final mha:Ljava/lang/String; = "android.settings.oneplus_theme_disable"

.field private static final nha:Ljava/lang/String; = "android.settings.oneplus_theme_enable_single"

.field private static final oha:Ljava/lang/String; = "android.settings.oneplus_theme_disable_single"

.field private static final pha:Ljava/lang/String; = "android.settings.OEM_FONT_MODE"

.field private static final qha:Ljava/lang/String; = "android.settings.oneplus_basiccolor_ready"

.field private static final rha:Ljava/lang/String; = "com.oem.intent.action.PKG_ADDED_UPDATED"

.field private static final sha:Ljava/lang/String; = "android.settings.oneplus_theme_ready"

.field private static final tha:Ljava/lang/String; = "com.oem.intent.action.parallel_overlay_ready"

.field private static final uha:Ljava/lang/String; = "persist.sys.theme_first_launch"

.field private static final vha:Ljava/lang/String; = "persist.sys.theme_version"

.field public static final wha:I = 0x2

.field public static final xha:I = 0x1

.field public static final yha:I = 0x0

.field private static final zha:Ljava/lang/String; = "oneplus_basiccolor_black"


# instance fields
.field private hha:Landroid/content/om/IOverlayManager;

.field private iha:Landroid/app/IUiModeManager;

.field private jha:Landroid/os/IUserManager;

.field private kha:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/server/zta/sis;->Dha:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/oneplus/server/zta/sis;->jha:Landroid/os/IUserManager;
    ...
    iput-object p1, p0, Lcom/oneplus/server/zta/sis;->hha:Landroid/content/om/IOverlayManager;
    ...
    iput-object p1, p0, Lcom/oneplus/server/zta/sis;->iha:Landroid/app/IUiModeManager;
...
.method private Kc(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_start_0
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->hha:Landroid/content/om/IOverlayManager;
...
.method private Os()V
    ...
    sget-boolean v0, Lcom/oneplus/server/zta/sis;->Dha:Z
    ...
    sput-boolean v1, Lcom/oneplus/server/zta/sis;->Dha:Z
...
.method private Qs()V
    ...
    iput-object v0, p0, Lcom/oneplus/server/zta/sis;->kha:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/oneplus/server/zta/sis;->kha:Landroid/content/BroadcastReceiver;
    ...
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->kha:Landroid/content/BroadcastReceiver;
...
.method private Ss()Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/oneplus/server/zta/sis;->jha:Landroid/os/IUserManager;
    ...
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->jha:Landroid/os/IUserManager;
...
.method static synthetic sis(Lcom/oneplus/server/zta/sis;)Landroid/content/Context;
    .locals 0
...
.method static synthetic tsu(Lcom/oneplus/server/zta/sis;)Landroid/content/om/IOverlayManager;
    .locals 0
...
.method static synthetic vju(Z)Z
    ...
    sput-boolean p0, Lcom/oneplus/server/zta/sis;->Dha:Z
...
.method static synthetic you(Lcom/oneplus/server/zta/sis;)Landroid/app/IUiModeManager;
    ...
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->iha:Landroid/app/IUiModeManager;
...
.method static synthetic zta(Lcom/oneplus/server/zta/sis;)I
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->Ps()I
...
.method public Df()V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->Qs()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->Rs()Z
...
.method public bio(Ljava/lang/String;I)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/oneplus/server/zta/sis;->hha:Landroid/content/om/IOverlayManager;
...
.method public enableTheme(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/oneplus/server/zta/sis;->hha:Landroid/content/om/IOverlayManager;
...
.method public processDisableThemeCategory(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/oneplus/server/zta/sis;->kth(Ljava/lang/String;I)V

    iget-object p1, p0, Lcom/oneplus/server/zta/sis;->mContext:Landroid/content/Context;
    ...
    :cond_4
    :goto_1
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->Os()V
...
.method public processEnableThemeCategory(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/oneplus/server/zta/sis;->bio(Ljava/lang/String;I)V
