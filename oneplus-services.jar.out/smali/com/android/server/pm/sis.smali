...
# static fields
.field public static final AC:I = 0x1bd

.field public static final CC:I = 0x6f

.field public static final DC:I = 0x55

.field private static final DEBUG:Z

.field public static final EC:I = 0x68

.field public static final FC:I = 0x4e

.field public static final GC:I = 0xd3

.field public static final GPU_OUT_OF_MEMORY:I = 0xa8

.field public static final HC:I = 0x47

.field public static final IC:I = 0x46

.field public static final JC:I = 0xf

.field public static final KC:I = 0x1e8

.field public static final LC:I = 0xe6

.field public static final MC:I = 0x50

.field public static final OC:I = 0x2

.field public static final PC:I = 0x1d7

.field public static final QC:I = 0x1e6

.field public static final RC:I = 0x14c

.field public static final SC:I = 0x166

.field private static final TAG:Ljava/lang/String; = "OpCompatibilityHelper"

.field public static final TC:I = 0x186

.field private static final UC:Ljava/util/Map;
...
.field private static final VC:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Integer;",
...
.field private static final XB:Ljava/lang/String; = "compatibility_config_values"

.field private static final YB:Ljava/lang/String; = "/data/system/oneplus_cpt_list.xml"

.field private static final ZB:Ljava/lang/String; = "/system/etc/oneplus_cpt_list.xml"

.field private static mContext:Landroid/content/Context; = null

.field private static mTotalCount:I = 0x0

.field private static final pC:Ljava/lang/String; = "/data/system/install_warning_list.xml"

.field private static final qC:Ljava/lang/String; = "/system/etc/install_warning_list.xml"

.field private static final rC:Ljava/lang/String; = "CompatConfigList"

.field private static final sC:Ljava/lang/String; = "disable.install.warning"

.field private static sConfigLock:Ljava/lang/Object; = null

.field public static final tC:I = 0x0

.field public static final uC:I = 0x1

.field public static final vC:I = 0x14b

.field public static final wC:I = 0x6b

.field public static final xC:I = 0x5f

.field public static final yC:I = 0x1bb

.field public static final zC:I = 0x1bc
...
.field private oC:Lcom/oneplus/config/ConfigObserver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/sis;->DEBUG:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/pm/sis;->sConfigLock:Ljava/lang/Object;

    sput v1, Lcom/android/server/pm/sis;->mTotalCount:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/android/server/pm/sis;->UC:Ljava/util/Map;

    sget-object v0, Lcom/android/server/pm/sis;->UC:Ljava/util/Map;
    ...
    sput-object v0, Lcom/android/server/pm/sis;->VC:Ljava/util/Map;

    sget-object v0, Lcom/android/server/pm/sis;->VC:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
...
.method private Fn()V
    ...
    :goto_0
    invoke-direct {p0, v0}, Lcom/android/server/pm/sis;->readFromFile(Ljava/io/File;)Ljava/lang/String;
    ...
    :cond_2
    sget-object v3, Lcom/android/server/pm/sis;->sConfigLock:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;
    ...
    :cond_4
    invoke-direct {p0, v0}, Lcom/android/server/pm/sis;->cno([C)I
    ...
    :cond_5
    iget-object v4, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;
    ...
    :goto_2
    sget v0, Lcom/android/server/pm/sis;->mTotalCount:I

    add-int/2addr v0, v2

    sput v0, Lcom/android/server/pm/sis;->mTotalCount:I
    ...
    sget-object v0, Lcom/android/server/pm/sis;->sConfigLock:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;
...
.method private Gn()V
    ...
    iget-object v0, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
    ...
    invoke-direct {p0}, Lcom/android/server/pm/sis;->Hn()V
...
.method private Hn()V
    ...
    iget-object v3, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
    ...
    :try_start_1
    iget-object p0, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
...
.method private Sb(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
...
.method private Tb(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
...
.method private sis(Landroid/content/pm/PackageParser$Package;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/pm/sis;->isInConfigList(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/pm/sis;->zta(Ljava/util/ArrayList;Z)V
...
.method private you(Landroid/content/pm/PackageParser$Package;)V
    ...
    :goto_0
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/pm/sis;->zta(Ljava/util/ArrayList;Ljava/lang/String;Z)V
...
.method static synthetic zta(Lcom/android/server/pm/sis;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/sis;->kth(Lorg/json/JSONArray;)V
...
.method private zta(Ljava/util/ArrayList;Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-virtual {p0, v2, v1}, Lcom/android/server/pm/sis;->isInConfigList(ILjava/lang/String;)Z
...
.method public L(Ljava/lang/String;)I
    ...
    sget-object p0, Lcom/android/server/pm/sis;->UC:Ljava/util/Map;
...
.method public abiOverride(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p2}, Lcom/android/server/pm/sis;->isInConfigList(ILjava/lang/String;)Z
...
.method public customizePackageIfNeeded(Landroid/content/pm/PackageParser$Package;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/pm/sis;->abiOverride(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p1, Landroid/content/pm/PackageParser$Package;->cpuAbiOverride:Ljava/lang/String;

    invoke-direct {p0, p1}, Lcom/android/server/pm/sis;->sis(Landroid/content/pm/PackageParser$Package;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/sis;->you(Landroid/content/pm/PackageParser$Package;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/sis;->rtg(Landroid/content/pm/PackageParser$Package;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/sis;->tsu(Landroid/content/pm/PackageParser$Package;)V
    :try_end_0
...
.method public dumpToString()Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/pm/sis;->sConfigLock:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/pm/sis;->nC:Ljava/util/Map;
...
.method public getCompatConfigString(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;
...
.method public initCompatOnlineConfig()V
    ...
    sget-object v1, Lcom/android/server/pm/sis;->mContext:Landroid/content/Context;

    new-instance v2, Lcom/android/server/pm/sis$zta;

    invoke-direct {v2, p0}, Lcom/android/server/pm/sis$zta;-><init>(Lcom/android/server/pm/sis;)V
    ...
    iput-object v0, p0, Lcom/android/server/pm/sis;->oC:Lcom/oneplus/config/ConfigObserver;

    iget-object p0, p0, Lcom/android/server/pm/sis;->oC:Lcom/oneplus/config/ConfigObserver;
...
.method public initInstance(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/pm/sis;->dumpToString()Ljava/lang/String;
...
.method public isInConfigList(ILjava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/pm/sis;->mC:Landroid/util/SparseArray;
...
.method public p(I)Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/server/pm/sis;->VC:Ljava/util/Map;
