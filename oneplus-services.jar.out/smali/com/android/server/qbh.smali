...
# static fields
.field static Bc:Ljava/util/ArrayList; = null
...
.field static Cc:Landroid/util/ArrayMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field static Dc:Landroid/util/ArrayMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/Integer;",
...
.field private static final Ec:I = 0xdac0

.field private static final Fc:J = 0x1f4L

.field private static final Gc:J = 0x320L
...
.field static rc:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/Integer;",
...
# instance fields
.field Ac:Landroid/content/Intent;
...
.field private mHandler:Lcom/android/server/qbh$zta;
...
.field public wc:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/qbh;->Bc:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/qbh;->Cc:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/qbh;->Dc:Landroid/util/ArrayMap;
    ...
    sput-object v0, Lcom/android/server/qbh;->TAG:Ljava/lang/String;

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/qbh;->DEBUG:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/qbh;->rc:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/qbh;->wc:Ljava/util/ArrayList;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/android/server/qbh;->xc:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/qbh;->yc:Z

    iput v0, p0, Lcom/android/server/qbh;->zc:I

    const-string v0, "android.intent.oneplus.gpsforcestop"

    iput-object v0, p0, Lcom/android/server/qbh;->mAction:Ljava/lang/String;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/qbh;->mLock:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/qbh;->Ac:Landroid/content/Intent;
    ...
    invoke-direct {v0, p0}, Lcom/android/server/ywr;-><init>(Lcom/android/server/qbh;)V

    iput-object v0, p0, Lcom/android/server/qbh;->mReceiver:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, Lcom/android/server/qbh;->mContext:Landroid/content/Context;
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, Lcom/android/server/qbh;->DEBUG:Z
...
.method static synthetic sis(Lcom/android/server/qbh;)Lcom/android/server/qbh$zta;
    ...
    iget-object p0, p0, Lcom/android/server/qbh;->mHandler:Lcom/android/server/qbh$zta;

    return-object p0
.end method

.method static synthetic tsu(Lcom/android/server/qbh;)Landroid/app/NotificationManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/qbh;->mNotificationManager:Landroid/app/NotificationManager;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/qbh;)Landroid/app/ActivityManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/qbh;->mActivityManager:Landroid/app/ActivityManager;
...
.method static synthetic zta(Lcom/android/server/qbh;J)J
    ...
    iput-wide p1, p0, Lcom/android/server/qbh;->xc:J

    return-wide p1
.end method

.method static synthetic zta(Lcom/android/server/qbh;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lcom/android/server/qbh;->mAction:Ljava/lang/String;
...
.method static synthetic zta(Lcom/android/server/qbh;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/qbh;->yc:Z
...
.method public getCurrentProviderPackageList(Ljava/lang/String;ZLjava/util/HashMap;)Ljava/util/List;
    ...
    sget-object v2, Lcom/android/server/qbh;->rc:Ljava/util/ArrayList;
...
.method public systemReady()V
    ...
    iput-object v0, p0, Lcom/android/server/qbh;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lcom/android/server/qbh;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    iput-object v0, p0, Lcom/android/server/qbh;->mActivityManager:Landroid/app/ActivityManager;
    ...
    iput-object v0, p0, Lcom/android/server/qbh;->mUserManager:Landroid/os/UserManager;
    ...
    iput-object v0, p0, Lcom/android/server/qbh;->mLocationManagerService:Lcom/android/server/LocationManagerService;

    new-instance v0, Landroid/content/IntentFilter;

    invoke-direct {v0}, Landroid/content/IntentFilter;-><init>()V

    iget-object v1, p0, Lcom/android/server/qbh;->mAction:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/server/qbh;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/qbh;->mReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v1, v2, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    new-instance v0, Lcom/android/server/qbh$zta;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/qbh$zta;-><init>(Lcom/android/server/qbh;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/qbh;->mHandler:Lcom/android/server/qbh$zta;
    ...
    iget-object v0, p0, Lcom/android/server/qbh;->Ac:Landroid/content/Intent;

    const/high16 v1, 0x4000000

    invoke-virtual {v0, v1}, Landroid/content/Intent;->addFlags(I)Landroid/content/Intent;

    iget-object p0, p0, Lcom/android/server/qbh;->Ac:Landroid/content/Intent;
...
.method public u()V
    ...
    iget-object v0, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/qbh;->wc:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/android/server/qbh;->wc:Ljava/util/ArrayList;

    iget-object v2, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v1, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v7, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lcom/android/server/qbh;->mContext:Landroid/content/Context;
    ...
    :try_start_3
    sget-object v8, Lcom/android/server/qbh;->TAG:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/server/qbh;->mContext:Landroid/content/Context;
    ...
    :try_start_4
    sget-object v4, Lcom/android/server/qbh;->TAG:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/server/qbh;->vc:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Lcom/android/server/qbh;->mContext:Landroid/content/Context;

    const/4 v8, 0x0

    iget-object v9, p0, Lcom/android/server/qbh;->Ac:Landroid/content/Intent;
    ...
    iput-object v4, p0, Lcom/android/server/qbh;->mPendingIntent:Landroid/app/PendingIntent;
    ...
    iget-object v7, p0, Lcom/android/server/qbh;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iget-object v4, p0, Lcom/android/server/qbh;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/server/qbh;->mPendingIntent:Landroid/app/PendingIntent;
