...
.field public static final enum _ha:Lcom/android/server/am/AppRecordManager$ListenerType;

.field public static final enum aia:Lcom/android/server/am/AppRecordManager$ListenerType;

.field public static final enum bia:Lcom/android/server/am/AppRecordManager$ListenerType;

.field public static final enum cia:Lcom/android/server/am/AppRecordManager$ListenerType;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/AppRecordManager$ListenerType;->_ha:Lcom/android/server/am/AppRecordManager$ListenerType;
    ...
    sput-object v0, Lcom/android/server/am/AppRecordManager$ListenerType;->aia:Lcom/android/server/am/AppRecordManager$ListenerType;
    ...
    sput-object v0, Lcom/android/server/am/AppRecordManager$ListenerType;->bia:Lcom/android/server/am/AppRecordManager$ListenerType;

    new-instance v0, Lcom/android/server/am/AppRecordManager$ListenerType;

    const/16 v12, 0xb

    const-string v13, "PROCESSSTATE"

    invoke-direct {v0, v13, v12, v12}, Lcom/android/server/am/AppRecordManager$ListenerType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/android/server/am/AppRecordManager$ListenerType;->cia:Lcom/android/server/am/AppRecordManager$ListenerType;

    const/16 v0, 0xc

    new-array v0, v0, [Lcom/android/server/am/AppRecordManager$ListenerType;

    sget-object v13, Lcom/android/server/am/AppRecordManager$ListenerType;->_ha:Lcom/android/server/am/AppRecordManager$ListenerType;
...
.method public static valueOf(I)Lcom/android/server/am/AppRecordManager$ListenerType;
    ...
    sget-object p0, Lcom/android/server/am/AppRecordManager$ListenerType;->_ha:Lcom/android/server/am/AppRecordManager$ListenerType;

    return-object p0

    :pswitch_0
    sget-object p0, Lcom/android/server/am/AppRecordManager$ListenerType;->bia:Lcom/android/server/am/AppRecordManager$ListenerType;

    return-object p0

    :pswitch_1
    sget-object p0, Lcom/android/server/am/AppRecordManager$ListenerType;->aia:Lcom/android/server/am/AppRecordManager$ListenerType;
