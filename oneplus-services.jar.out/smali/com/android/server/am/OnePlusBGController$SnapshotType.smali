...
.field public static final enum mia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

.field public static final enum nia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

.field public static final enum oia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

.field public static final enum pia:Lcom/android/server/am/OnePlusBGController$SnapshotType;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/OnePlusBGController$SnapshotType;->mia:Lcom/android/server/am/OnePlusBGController$SnapshotType;
    ...
    sput-object v0, Lcom/android/server/am/OnePlusBGController$SnapshotType;->nia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

    new-instance v0, Lcom/android/server/am/OnePlusBGController$SnapshotType;

    const/4 v3, 0x2

    const-string v4, "BUDGET_RESET"

    invoke-direct {v0, v4, v3}, Lcom/android/server/am/OnePlusBGController$SnapshotType;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/android/server/am/OnePlusBGController$SnapshotType;->oia:Lcom/android/server/am/OnePlusBGController$SnapshotType;
    ...
    sput-object v0, Lcom/android/server/am/OnePlusBGController$SnapshotType;->pia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

    const/4 v0, 0x4

    new-array v0, v0, [Lcom/android/server/am/OnePlusBGController$SnapshotType;

    sget-object v5, Lcom/android/server/am/OnePlusBGController$SnapshotType;->mia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

    aput-object v5, v0, v1

    sget-object v1, Lcom/android/server/am/OnePlusBGController$SnapshotType;->nia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

    aput-object v1, v0, v2

    sget-object v1, Lcom/android/server/am/OnePlusBGController$SnapshotType;->oia:Lcom/android/server/am/OnePlusBGController$SnapshotType;

    aput-object v1, v0, v3

    sget-object v1, Lcom/android/server/am/OnePlusBGController$SnapshotType;->pia:Lcom/android/server/am/OnePlusBGController$SnapshotType;
