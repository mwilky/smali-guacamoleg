...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/j$sis;,
        Lcom/android/server/am/j$zta;,
        Lcom/android/server/am/j$tsu;
    }
.end annotation


# static fields
.field private static final Av:Ljava/lang/String; = "persist.sys.ramboost.olmemplus"

.field private static final Bv:Ljava/lang/String; = "persist.vendor.memplus.enable"

.field private static final CONFIG_NAME:Ljava/lang/String; = "RamBoost"

.field private static final Cv:I = 0x0

.field private static final Dv:I = 0x1
...
.field private static final Gv:Ljava/lang/String; = "/system/etc/ramboost.xml"

.field private static final Hv:J = 0x2710L

.field public static final IN_USING:Z

.field private static final Iv:I = 0x384

.field private static final Jv:Ljava/lang/String; = "0"

.field private static Kv:Ljava/io/File; = null

.field private static Lv:Ljava/lang/String; = null
...
.field private static final Ov:I = 0x4
...
.field private static final Pv:I = 0x5

.field private static final Qv:I = 0x6

.field private static final Rv:I = 0x7

.field private static final Sv:I = 0x8

.field public static final TAG:Ljava/lang/String; = "OnePlusSmartBoostManager"

.field private static final Tv:I = 0x9

.field private static final Uv:I = 0xa

.field private static final Vv:I = 0xb

.field private static final Wv:I = 0xc
...
.field private static final Xv:I = 0xd

.field private static final Yv:I = 0xe

.field private static final Zv:I = 0x10

.field private static final _v:Ljava/lang/String; = "ramboost"

.field private static final aw:Ljava/lang/String; = "ramboost"

.field private static final bw:Ljava/lang/String; = "hotcount"

.field private static final cw:Ljava/lang/String; = "ioppreload"

.field private static final dw:Ljava/lang/String; = "iop"

.field private static mInstance:Lcom/android/server/am/j; = null

.field private static final pk:J = 0x5265c00L
...
.field private static final vv:Ljava/lang/String; = "persist.sys.ramboost.ioppreload"

.field private static final wv:Ljava/lang/String; = "/sys/module/smartboost_core/parameters/page_cache_reside_switch"

.field private static final xv:Ljava/lang/String; = "persist.sys.ramboost.olhotcount"

.field private static final yv:Ljava/lang/String; = "persist.sys.ramboost.oliop"

.field private static final zv:Ljava/lang/String; = "/sys/module/fsc/parameters/enable"


# instance fields
.field private cv:Landroid/os/HandlerThread;

.field private dv:Lcom/android/server/am/j$sis;

.field private ev:Lcom/android/server/am/j$tsu;

.field private fv:Landroid/net/Uri;

.field private gv:Ljava/util/HashMap;
...
.field private jv:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field private nv:Lcom/android/server/am/r;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/j;->IN_USING:Z

    sget-boolean v1, Lcom/android/server/am/j;->IN_USING:Z

    sput-boolean v1, Lcom/android/server/am/j;->Fp:Z

    sput-boolean v1, Lcom/android/server/am/j;->rv:Z

    sput-boolean v1, Lcom/android/server/am/j;->sv:Z

    sput-boolean v0, Lcom/android/server/am/j;->tv:Z
    ...
    sput-object v0, Lcom/android/server/am/j;->mInstance:Lcom/android/server/am/j;

    const-string v0, "sys/module/memplus_core/parameters/memory_plus_wake_gcd"

    sput-object v0, Lcom/android/server/am/j;->Lv:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/j;->cv:Landroid/os/HandlerThread;

    iput-object v0, p0, Lcom/android/server/am/j;->dv:Lcom/android/server/am/j$sis;

    iput-object v0, p0, Lcom/android/server/am/j;->mMyConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iput-object v0, p0, Lcom/android/server/am/j;->mContext:Landroid/content/Context;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/j;->hv:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/server/am/j;->nv:Lcom/android/server/am/r;

    const/4 v0, 0x1

    iput v0, p0, Lcom/android/server/am/j;->ov:I
    ...
    iput-object v0, p0, Lcom/android/server/am/j;->pv:Ljava/util/List;

    const-string v0, ""

    iput-object v0, p0, Lcom/android/server/am/j;->qv:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->cv:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/android/server/am/j$sis;

    iget-object v1, p0, Lcom/android/server/am/j;->cv:Landroid/os/HandlerThread;
    ...
    sget-boolean p0, Lcom/android/server/am/j;->Fp:Z
    ...
    sput-boolean p0, Lcom/android/server/am/j;->Fp:Z

    sget-boolean p0, Lcom/android/server/am/j;->rv:Z
    ...
    sput-boolean p0, Lcom/android/server/am/j;->rv:Z
    ...
    sput-boolean p0, Lcom/android/server/am/j;->sDebug:Z
...
.method private Lb(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->hv:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-object p0, p0, Lcom/android/server/am/j;->hv:Ljava/util/ArrayList;
...
.method private Mb(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->hv:Ljava/util/ArrayList;
...
.method private Nb(Ljava/lang/String;)I
    ...
    invoke-direct {p0}, Lcom/android/server/am/j;->in()Landroid/net/LocalSocket;
    ...
    sget-boolean v3, Lcom/android/server/am/j;->sDebug:Z
    ...
    invoke-static {p1}, Lcom/android/server/am/j;->sis(S)[B
...
.method private _l()V
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;
...
.method private cno(III)Z
    ...
    invoke-direct {p0, p2, v1}, Lcom/android/server/am/j;->echo(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private filterSuffix(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/am/j;->pv:Ljava/util/List;
...
.method public static final getInstance()Lcom/android/server/am/j;
    .locals 2

    sget-object v0, Lcom/android/server/am/j;->mInstance:Lcom/android/server/am/j;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/j;

    invoke-direct {v0}, Lcom/android/server/am/j;-><init>()V

    sput-object v0, Lcom/android/server/am/j;->mInstance:Lcom/android/server/am/j;

    new-instance v0, Ljava/io/File;

    sget-object v1, Lcom/android/server/am/j;->Lv:Ljava/lang/String;

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/android/server/am/j;->Kv:Ljava/io/File;
...
.method private in()Landroid/net/LocalSocket;
    .locals 2
...
.method public static isIopPreloadEnabled()Z
    ...
    sget-boolean v0, Lcom/android/server/am/j;->rv:Z
...
.method private jn()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v2}, Lcom/android/server/am/j;->lb(I)Ljava/lang/String;
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;
...
.method private kn()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/j;->mv:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/j;->mv:Ljava/util/ArrayList;
...
.method private les(J)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/j;->nv:Lcom/android/server/am/r;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/android/server/am/r;->qeg(Z)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/j;->dv:Lcom/android/server/am/j$sis;
...
.method private mn()I
    ...
    iget-object v7, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v8, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;
    ...
    :cond_7
    iget-object v5, p0, Lcom/android/server/am/j;->mv:Ljava/util/ArrayList;
...
.method private nn()I
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/am/j;->kn()Ljava/lang/String;
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iget-object v3, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;
    ...
    sget-boolean v8, Lcom/android/server/am/j;->sDebug:Z
    ...
    iget-object v3, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;
    ...
    :try_start_d
    iget-object v4, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;
    ...
    :try_start_f
    iget-object v7, p0, Lcom/android/server/am/j;->jv:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;
    ...
    :try_start_13
    iget-object v4, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;
    ...
    :try_start_15
    iget-object v7, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, v3}, Lcom/android/server/am/j;->vdb(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-boolean v2, Lcom/android/server/am/j;->tv:Z
    ...
    sget-boolean v4, Lcom/android/server/am/j;->tv:Z
...
.method static synthetic rtg(Lcom/android/server/am/j;)I
    ...
    invoke-direct {p0}, Lcom/android/server/am/j;->mn()I
...
.method static synthetic sis(Lcom/android/server/am/j;)I
    ...
    invoke-direct {p0}, Lcom/android/server/am/j;->nn()I
...
.method static synthetic tsu(Lcom/android/server/am/j;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/j;->jn()V
...
.method private tsu(IILjava/lang/String;)Z
    ...
    invoke-direct {p0, p3, p1, v0}, Lcom/android/server/am/j;->you(Ljava/lang/String;IZ)I

    move-result v0

    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/am/j;->cno(III)Z
...
.method private updateOnlineConfig()V
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/j;->resolveConfigFromJSON(Lorg/json/JSONArray;)V
...
.method private xa(Z)V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/am/j;->ln()Z

    move-result v0

    sput-boolean v0, Lcom/android/server/am/j;->uv:Z
    ...
    sget-boolean v2, Lcom/android/server/am/j;->uv:Z

    :cond_4
    sput-boolean v2, Lcom/android/server/am/j;->sv:Z

    sget-boolean v0, Lcom/android/server/am/j;->Fp:Z
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/server/am/j;->vdb(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/j;->sv:Z
    ...
    sget-boolean p1, Lcom/android/server/am/j;->Fp:Z
    ...
    invoke-direct {p0, v3, p1}, Lcom/android/server/am/j;->echo(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v3, Lcom/android/server/am/j;->Fp:Z
    ...
    :goto_3
    sget-boolean p1, Lcom/android/server/am/j;->uv:Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/am/j;->echo(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_5
    sget-boolean p1, Lcom/android/server/am/j;->sv:Z
...
.method static synthetic you(Lcom/android/server/am/j;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/j;->updateOnlineConfig()V
...
.method private you(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p3}, Lcom/android/server/am/j;->lb(I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0, p2}, Lcom/android/server/am/j;->echo(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v2, Lcom/android/server/am/j;->sDebug:Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;
    ...
    invoke-direct {v4, p0, p1, p2, p3}, Lcom/android/server/am/j$zta;-><init>(Lcom/android/server/am/j;Ljava/lang/String;Ljava/lang/String;I)V
...
.method private zta(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v3}, Lcom/android/server/am/j;->sis(S)[B
    ...
    iput-object p1, p0, Lcom/android/server/am/j;->qv:Ljava/lang/String;

    iget-object p1, p0, Lcom/android/server/am/j;->dv:Lcom/android/server/am/j$sis;
...
.method static synthetic zta(Lcom/android/server/am/j;ILjava/lang/String;Ljava/lang/String;)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/j;->zta(ILjava/lang/String;Ljava/lang/String;)I
...
.method static synthetic zta(Lcom/android/server/am/j;Ljava/lang/String;IZ)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/j;->you(Ljava/lang/String;IZ)I
...
.method static synthetic zta(Lcom/android/server/am/j;J)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/j;->les(J)V
...
.method static synthetic zta(Lcom/android/server/am/j;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/j;->resolveConfigFromJSON(Lorg/json/JSONArray;)V
...
.method static synthetic zta(Lcom/android/server/am/j;I)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/j;->mb(I)Z
...
.method static synthetic zta(Lcom/android/server/am/j;III)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/j;->cno(III)Z
...
.method static synthetic zta(Lcom/android/server/am/j;Ljava/lang/String;Ljava/lang/String;I)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/j;->you(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method public hc()V
    ...
    sget-boolean v0, Lcom/android/server/am/j;->tv:Z
    ...
    iput v1, p0, Lcom/android/server/am/j;->ov:I
    ...
    sget-boolean v2, Lcom/android/server/am/j;->tv:Z
    ...
    iget v2, p0, Lcom/android/server/am/j;->ov:I
    ...
    iget v0, p0, Lcom/android/server/am/j;->ov:I
    ...
    :try_start_0
    sget-object p0, Lcom/android/server/am/j;->Kv:Ljava/io/File;
    ...
    sget-object v0, Lcom/android/server/am/j;->Kv:Ljava/io/File;
...
.method public initEnv(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/j;->mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/j;->mResolver:Landroid/content/ContentResolver;

    new-instance v0, Lcom/android/server/am/j$tsu;

    iget-object v1, p0, Lcom/android/server/am/j;->dv:Lcom/android/server/am/j$sis;
    ...
    iput-object v0, p0, Lcom/android/server/am/j;->ev:Lcom/android/server/am/j$tsu;
    ...
    iput-object p1, p0, Lcom/android/server/am/j;->fv:Landroid/net/Uri;

    invoke-static {}, Lcom/android/server/am/r;->getInstance()Lcom/android/server/am/r;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/am/j;->nv:Lcom/android/server/am/r;
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->fv:Landroid/net/Uri;

    const/4 v1, 0x0

    iget-object p0, p0, Lcom/android/server/am/j;->ev:Lcom/android/server/am/j$tsu;
...
.method public initOnlineConfig(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/am/j$you;-><init>(Lcom/android/server/am/j;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/j;->mMyConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, Lcom/android/server/am/j;->mMyConfigObserver:Lcom/oneplus/config/ConfigObserver;
...
.method public notifyIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/server/am/j;->qv:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/android/server/am/j;->qv:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/j;->kv:Ljava/util/ArrayList;
...
.method public notifyRamBoost(Ljava/lang/String;IZ)V
    ...
    iget-object p3, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;

    monitor-enter p3

    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/j;->gv:Ljava/util/HashMap;
    ...
    :cond_4
    iget-object p1, p0, Lcom/android/server/am/j;->lv:Ljava/util/HashMap;
...
.method public zta(IILjava/lang/String;II)V
    ...
    sget-boolean p4, Lcom/android/server/am/j;->sDebug:Z
