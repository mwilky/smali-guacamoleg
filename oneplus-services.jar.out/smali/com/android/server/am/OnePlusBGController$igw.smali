...
.field private Hm:Lcom/android/server/am/OnePlusBGController$cno;
...
.method constructor <init>(Lcom/android/server/am/OnePlusBGController;IZI)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Im:Z

    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z

    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->um:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->um:Z

    :cond_0
    iput-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Im:Z
    ...
    iput-object p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Hm:Lcom/android/server/am/OnePlusBGController$cno;

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide p2

    iput-wide p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Gm:J
    ...
    :goto_1
    iget-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Im:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
    ...
    iget-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
    ...
    iget-boolean p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
...
.method Ab()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
...
.method dump()V
    ...
    iget-boolean v1, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
...
.method igw(IZ)V
    ...
    iput-boolean v3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
    ...
    :cond_0
    iget-wide v6, p0, Lcom/android/server/am/OnePlusBGController$igw;->Gm:J
    ...
    iput-boolean p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
    ...
    iget-object p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Hm:Lcom/android/server/am/OnePlusBGController$cno;
    ...
    iput-wide v4, p2, Lcom/android/server/am/OnePlusBGController$cno;->nm:J
    ...
    iput-wide v4, p2, Lcom/android/server/am/OnePlusBGController$cno;->om:J
    ...
    sget-object p2, Lcom/android/server/am/OnePlusBGController$ProcType;->lia:Lcom/android/server/am/OnePlusBGController$ProcType;
    ...
    sget-object v2, Lcom/android/server/am/OnePlusBGController$ProcType;->lia:Lcom/android/server/am/OnePlusBGController$ProcType;
    ...
    iget-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z
    ...
    iput-wide v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Gm:J
...
.method lqr(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/OnePlusBGController$igw;->Im:Z
...
.method vdw(I)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Jm:Z

    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController$igw;->this$0:Lcom/android/server/am/OnePlusBGController;

    iget-boolean p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Im:Z
...
.method yb()J
    ...
    iget-boolean v5, p0, Lcom/android/server/am/OnePlusBGController$igw;->Im:Z
...
.method zb()Lcom/android/server/am/OnePlusBGController$cno;
    ...
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Hm:Lcom/android/server/am/OnePlusBGController$cno;
