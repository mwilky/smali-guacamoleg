...
.field private static final Ar:Ljava/lang/String; = "Duallte"

.field private static Br:I = 0x0

.field private static Cr:I = 0x0
...
.field public static Fp:Z = false

.field public static Fr:Z = false
...
.field private static final Yo:Ljava/lang/String; = "com.Duallte.action.debug"

.field private static pr:Lcom/android/server/am/ivd; = null

.field private static qr:Ljava/lang/Object; = null

.field private static final rr:Ljava/lang/String; = "persist.radio.duallte.enable"

.field private static final tr:Ljava/lang/String; = "persist.radio.duallte.operated"

.field private static final ur:I = 0x1

.field private static final vr:I = 0x2

.field private static final wr:I = 0x0

.field private static final xr:I = 0x1

.field private static final yr:I = 0x2
...
.field private hr:Landroid/os/Handler;
...
.field private jr:Lcom/oneplus/config/ConfigObserver;

.field private kr:Ljava/lang/Object;

.field private lr:Landroid/telephony/TelephonyManager;
...
.field private mr:Landroid/net/ConnectivityManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ivd;->pr:Lcom/android/server/am/ivd;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/am/ivd;->qr:Ljava/lang/Object;

    const-wide/32 v0, 0xea60

    sput-wide v0, Lcom/android/server/am/ivd;->zr:J

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/am/ivd;->Fp:Z

    sput v0, Lcom/android/server/am/ivd;->Br:I

    sput v0, Lcom/android/server/am/ivd;->Cr:I

    sput-boolean v0, Lcom/android/server/am/ivd;->Dr:Z

    sput-boolean v0, Lcom/android/server/am/ivd;->Er:Z

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/am/ivd;->Fr:Z
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/am/ivd;->er:I

    const-string v1, ""

    iput-object v1, p0, Lcom/android/server/am/ivd;->offScreenPkgName:Ljava/lang/String;

    iput-object v1, p0, Lcom/android/server/am/ivd;->fr:Ljava/lang/String;

    iput-boolean v0, p0, Lcom/android/server/am/ivd;->screenOn:Z

    iput-boolean v0, p0, Lcom/android/server/am/ivd;->gr:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/am/ivd;->mContext:Landroid/content/Context;

    iput-object v1, p0, Lcom/android/server/am/ivd;->hr:Landroid/os/Handler;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;

    iput-object v1, p0, Lcom/android/server/am/ivd;->method:Ljava/lang/reflect/Method;

    iput-object v1, p0, Lcom/android/server/am/ivd;->kr:Ljava/lang/Object;

    iput-object v1, p0, Lcom/android/server/am/ivd;->lr:Landroid/telephony/TelephonyManager;

    iput-object v1, p0, Lcom/android/server/am/ivd;->mr:Landroid/net/ConnectivityManager;

    iput-boolean v0, p0, Lcom/android/server/am/ivd;->or:Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/ivd;->bio(Landroid/content/Context;)Z

    move-result v1

    sput-boolean v1, Lcom/android/server/am/ivd;->Fr:Z

    sget-boolean v1, Lcom/android/server/am/ivd;->Fr:Z

    sput-boolean v1, Lcom/android/server/am/ivd;->Fp:Z
    ...
    sget-boolean v2, Lcom/android/server/am/ivd;->Fp:Z
    ...
    iget-object v1, p0, Lcom/android/server/am/ivd;->lr:Landroid/telephony/TelephonyManager;
    ...
    iget-object v0, p0, Lcom/android/server/am/ivd;->lr:Landroid/telephony/TelephonyManager;
    ...
    sget v0, Lcom/android/server/am/ivd;->Br:I

    const/4 v1, 0x5

    if-ne v0, v1, :cond_0

    sget v0, Lcom/android/server/am/ivd;->Cr:I

    if-ne v0, v1, :cond_0

    sput-boolean p1, Lcom/android/server/am/ivd;->Dr:Z
    ...
    iput-object v0, p0, Lcom/android/server/am/ivd;->mr:Landroid/net/ConnectivityManager;

    iget-object v0, p0, Lcom/android/server/am/ivd;->mr:Landroid/net/ConnectivityManager;
    ...
    sput-boolean p1, Lcom/android/server/am/ivd;->Er:Z
    ...
    sput-object p0, Lcom/android/server/am/ivd;->pr:Lcom/android/server/am/ivd;
...
.method private Gb(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;
    ...
    iput v1, p0, Lcom/android/server/am/ivd;->er:I

    iget-object p1, p0, Lcom/android/server/am/ivd;->hr:Landroid/os/Handler;
    ...
    iput-boolean v1, p0, Lcom/android/server/am/ivd;->gr:Z
    ...
    iget-object p0, p0, Lcom/android/server/am/ivd;->hr:Landroid/os/Handler;
    ...
    :cond_2
    iget p1, p0, Lcom/android/server/am/ivd;->er:I
    ...
    :cond_3
    iput v2, p0, Lcom/android/server/am/ivd;->er:I

    goto :goto_0

    :cond_4
    iput v3, p0, Lcom/android/server/am/ivd;->er:I

    iget-boolean p1, p0, Lcom/android/server/am/ivd;->gr:Z

    if-eqz p1, :cond_7

    iput-boolean v2, p0, Lcom/android/server/am/ivd;->gr:Z
    ...
    sget-wide v1, Lcom/android/server/am/ivd;->zr:J
...
.method private Mc()V
    ...
    sget-boolean v1, Lcom/android/server/am/ivd;->Fp:Z
...
.method private Um()V
    ...
    sget-object v0, Lcom/android/server/am/ivd;->qr:Ljava/lang/Object;
    ...
    iget-object p0, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;
...
.method private Vm()V
    ...
    sget-boolean v0, Lcom/android/server/am/ivd;->Dr:Z
...
.method private Xm()V
    ...
    iget-object v0, p0, Lcom/android/server/am/ivd;->hr:Landroid/os/Handler;
...
.method private Ym()Z
    ...
    sget-boolean p0, Lcom/android/server/am/ivd;->Dr:Z

    if-eqz p0, :cond_0

    sget-boolean p0, Lcom/android/server/am/ivd;->Er:Z
...
.method private Zm()V
    ...
    iget-boolean v1, p0, Lcom/android/server/am/ivd;->gr:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/am/ivd;->gr:Z
...
.method static synthetic access$802(I)I
    ...
    sput p0, Lcom/android/server/am/ivd;->Br:I
...
.method static synthetic f(I)I
    ...
    sput p0, Lcom/android/server/am/ivd;->Cr:I
...
.method private getIExtTelephony()Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/android/server/am/ivd;->kr:Ljava/lang/Object;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0

    iget-object p0, p0, Lcom/android/server/am/ivd;->kr:Ljava/lang/Object;
...
.method public static final getInstance()Lcom/android/server/am/ivd;
    ...
    sget-object v0, Lcom/android/server/am/ivd;->pr:Lcom/android/server/am/ivd;
...
.method public static final init(Landroid/content/Context;)Lcom/android/server/am/ivd;
    ...
    :cond_0
    sget-object p0, Lcom/android/server/am/ivd;->pr:Lcom/android/server/am/ivd;
...
.method private init()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ivd;->Wm()V

    invoke-virtual {p0}, Lcom/android/server/am/ivd;->initOnlineConfig()V

    invoke-direct {p0}, Lcom/android/server/am/ivd;->Xm()V
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    sput-boolean v2, Lcom/android/server/am/ivd;->Fp:Z
    ...
    sput-wide v2, Lcom/android/server/am/ivd;->zr:J
    ...
    iget-object v3, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/ivd;->ir:Ljava/util/List;
    ...
    sget-boolean v0, Lcom/android/server/am/ivd;->Fp:Z
    ...
    sget-wide v0, Lcom/android/server/am/ivd;->zr:J
...
.method static synthetic rtg(Lcom/android/server/am/ivd;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ivd;->_m()V
...
.method static synthetic sis(Lcom/android/server/am/ivd;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ivd;->Mc()V
...
.method static synthetic ssp(Lcom/android/server/am/ivd;)Landroid/telephony/TelephonyManager;
    ...
    iget-object p0, p0, Lcom/android/server/am/ivd;->lr:Landroid/telephony/TelephonyManager;
...
.method static synthetic tsu(Lcom/android/server/am/ivd;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ivd;->Um()V

    return-void
.end method

.method private ua(Z)Z
    .locals 7
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/server/am/ivd;->kr:Ljava/lang/Object;
    ...
    iget-boolean v2, p0, Lcom/android/server/am/ivd;->or:Z

    if-nez v2, :cond_4

    iget-object v2, p0, Lcom/android/server/am/ivd;->method:Ljava/lang/reflect/Method;

    iget-object v4, p0, Lcom/android/server/am/ivd;->kr:Ljava/lang/Object;
...
.method private you(Ljava/lang/Boolean;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/ivd;->fr:Ljava/lang/String;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/am/ivd;->Er:Z
    ...
    sget-boolean p1, Lcom/android/server/am/ivd;->Er:Z

    if-eqz p1, :cond_1

    sget-boolean p1, Lcom/android/server/am/ivd;->Dr:Z
    ...
    :cond_1
    invoke-direct {p0}, Lcom/android/server/am/ivd;->Zm()V
...
.method static synthetic zta(Lcom/android/server/am/ivd;Landroid/telephony/TelephonyManager;)Landroid/telephony/TelephonyManager;
    ...
    iput-object p1, p0, Lcom/android/server/am/ivd;->lr:Landroid/telephony/TelephonyManager;
...
.method static synthetic zta(Lcom/android/server/am/ivd;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ivd;->Vm()V
...
.method static synthetic zta(Lcom/android/server/am/ivd;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/ivd;->Gb(Ljava/lang/String;)V
...
.method static synthetic zta(Lcom/android/server/am/ivd;Z)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/ivd;->ua(Z)Z
...
.method public cgv(Z)V
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/am/ivd;->or:Z
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/am/ivd;->or:Z

    iget-boolean p1, p0, Lcom/android/server/am/ivd;->or:Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/ivd;->n(Ljava/lang/String;)V
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    sget-boolean p3, Lcom/android/server/am/ivd;->Fp:Z
...
.method public initOnlineConfig()V
    ...
    iget-object v2, p0, Lcom/android/server/am/ivd;->hr:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/android/server/am/ivd;->jr:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, Lcom/android/server/am/ivd;->jr:Lcom/oneplus/config/ConfigObserver;
...
.method public n(Ljava/lang/String;)V
    ...
    :cond_1
    iput-object p1, p0, Lcom/android/server/am/ivd;->fr:Ljava/lang/String;
    ...
    :cond_3
    invoke-direct {p0}, Lcom/android/server/am/ivd;->Ym()Z
...
.method public screenStateChangedEvent(Z)V
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/am/ivd;->fr:Ljava/lang/String;
