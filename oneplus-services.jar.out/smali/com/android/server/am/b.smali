...
# static fields
.field private static final Hr:Ljava/lang/String; = "GameShakeConfig"

.field private static Ir:Ljava/util/HashMap; = null
...
.field private static final Jr:Ljava/lang/String; = "GameMultiTouchConfig"

.field private static final MSG_GET_ONLINECONFIG:I = 0x1

.field private static final TAG:Ljava/lang/String; = "OnePlusGameShakeController"

.field private static sInstance:Lcom/android/server/am/b;
...
# instance fields
.field private Gr:Lcom/oneplus/config/ConfigObserver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/b;->Ir:Ljava/util/HashMap;
    ...
    sput-object v0, Lcom/android/server/am/b;->sMultiTouchGameList:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/b;->mHandler:Landroid/os/Handler;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/am/b$you;-><init>(Lcom/android/server/am/b;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/am/b;->mHandler:Landroid/os/Handler;

    iput-object p1, p0, Lcom/android/server/am/b;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/android/server/am/b;->initOnlineConfig()V

    return-void
.end method

.method public static getInstance(Landroid/content/Context;)Lcom/android/server/am/b;
    .locals 1
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    sget-object v2, Lcom/android/server/am/b;->Ir:Ljava/util/HashMap;
    ...
    :try_start_1
    sget-object v3, Lcom/android/server/am/b;->Ir:Ljava/util/HashMap;
    ...
    sget-object v6, Lcom/android/server/am/b;->Ir:Ljava/util/HashMap;
    ...
    sget-object v2, Lcom/android/server/am/b;->sMultiTouchGameList:Ljava/util/List;
    ...
    sput-object v3, Lcom/android/server/am/b;->sMultiTouchGameList:Ljava/util/List;
    ...
    sget-object v5, Lcom/android/server/am/b;->sMultiTouchGameList:Ljava/util/List;
...
.method public getGameMultiTouchList()Ljava/util/List;
    ...
    sget-object p0, Lcom/android/server/am/b;->sMultiTouchGameList:Ljava/util/List;
...
.method public getGameShakeConfig(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/server/am/b;->Ir:Ljava/util/HashMap;
...
.method public initOnlineConfig()V
    ...
    iget-object v2, p0, Lcom/android/server/am/b;->mHandler:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/am/b$zta;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lcom/android/server/am/b$zta;-><init>(Lcom/android/server/am/b;Lcom/android/server/am/a;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/b;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, Lcom/android/server/am/b;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object v0, p0, Lcom/android/server/am/b;->Gr:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, Lcom/android/server/am/b;->Gr:Lcom/oneplus/config/ConfigObserver;

    invoke-virtual {v0}, Lcom/oneplus/config/ConfigObserver;->register()V

    iget-object p0, p0, Lcom/android/server/am/b;->mHandler:Landroid/os/Handler;
