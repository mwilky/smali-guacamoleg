...
.method private final oemStartActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;ZI)I
    ...
    invoke-virtual {p0, p12}, Lcom/android/server/wm/ActivityStarter;->setMayWait(I)Lcom/android/server/wm/ActivityStarter;
...
.method public isAppLocked(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {v1, p0, v3}, Landroid/content/pm/PackageManager;->queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
    ...
    sput-object p0, Lcom/android/server/wm/OpAppLocker;->mConfirmResolveInfo:Landroid/content/pm/ResolveInfo;
    ...
    :cond_2
    :goto_1
    sget-boolean p0, Lcom/android/server/wm/OpAppLocker;->mHintConfirmed:Z
    ...
    sget-boolean v1, Lcom/android/server/wm/OpAppLocker;->mKeyguardDone:Z
    ...
    invoke-virtual {v1, v3, v4, v5}, Lcom/android/server/appop/AppOpsService;->checkOperation(IILjava/lang/String;)I
    ...
    sget-object v1, Lcom/android/server/wm/OpAppLocker;->mAppLockerWhiteList:Ljava/util/ArrayList;
...
.method public isAppLocked(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v1, v2, p2, p1}, Lcom/android/server/appop/AppOpsService;->checkOperation(IILjava/lang/String;)I
...
.method public isTopAppLocked(Landroid/app/ActivityManager$RecentTaskInfo;I)Z
    ...
    invoke-virtual {v4, v5, p2, v0}, Lcom/android/server/appop/AppOpsService;->checkOperation(IILjava/lang/String;)I
...
.method public lockAppIfNeed(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    iget-object v3, v1, Lcom/android/server/wm/ActivityRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v6, v1, Lcom/android/server/wm/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;
...
.method public setKeyguardDone(Z)V
    ...
    invoke-static {p1}, Lcom/oneplus/android/server/OpMotorInjector;->notifyKeyguardState(Z)V
