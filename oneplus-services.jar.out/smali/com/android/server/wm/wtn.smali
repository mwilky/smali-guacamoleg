.class public final Lcom/android/server/wm/wtn;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/wtn$zta;
    }
.end annotation
...
.field private static final vP:Z

.field private static wP:Lcom/oneplus/os/IOnePlusExService;
...
.field static zP:Lcom/android/server/wm/wtn$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wm/wtn;->DBG:Z
    ...
    sput-boolean v0, Lcom/android/server/wm/wtn;->vP:Z

    new-instance v0, Lcom/android/server/wm/wtn$zta;

    invoke-direct {v0}, Lcom/android/server/wm/wtn$zta;-><init>()V

    sput-object v0, Lcom/android/server/wm/wtn;->zP:Lcom/android/server/wm/wtn$zta;
...
.method public static Td()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/wtn$zta;->Td()V

    return-void
.end method

.method public static Ud()Lcom/android/server/wm/wtn$zta;
    .locals 1

    sget-object v0, Lcom/android/server/wm/wtn;->zP:Lcom/android/server/wm/wtn$zta;
...
.method public static Vd()V
    ...
    invoke-static {v0}, Lcom/android/server/wm/wtn$zta;->rtg(Lcom/android/server/wm/wtn$zta;)Lcom/android/server/wm/ActivityStack;
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/ivd;->tga:Ljava/lang/String;
...
.method static synthetic access$000()Z
    ...
    sget-boolean v0, Lcom/android/server/wm/wtn;->vP:Z
...
.method public static endUserSwitching(Lcom/android/server/am/ActivityManagerService;)V
    ...
    sget-boolean p0, Lcom/android/server/wm/wtn;->vP:Z
    ...
    :try_start_0
    sget-object v0, Lcom/android/server/wm/wtn;->wP:Lcom/oneplus/os/IOnePlusExService;
    ...
    sput-object v0, Lcom/android/server/wm/wtn;->wP:Lcom/oneplus/os/IOnePlusExService;
...
.method public static handleShowOrOccludedChanged(Lcom/android/server/wm/KeyguardController;ZZLcom/android/server/wm/ActivityStackSupervisor;)V
    ...
    sget-boolean p3, Lcom/android/server/wm/wtn;->vP:Z
    ...
    :goto_1
    sget-boolean v3, Lcom/android/server/wm/wtn;->yP:Z

    if-eq v2, v3, :cond_5

    :try_start_0
    sget-object v3, Lcom/android/server/wm/wtn;->wP:Lcom/oneplus/os/IOnePlusExService;
    ...
    sput-object v3, Lcom/android/server/wm/wtn;->wP:Lcom/oneplus/os/IOnePlusExService;
    ...
    :cond_5
    :goto_3
    sput-boolean v2, Lcom/android/server/wm/wtn;->yP:Z
...
.method public static shouldIgnoreSceneEvaluation(Lcom/android/server/wm/ActivityTaskManagerService;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    sget-object v0, Lcom/android/server/wm/wtn;->xP:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/wm/wtn;->xP:Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/android/server/wm/wtn;->xP:Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-virtual {p1}, Lcom/android/server/wm/ActivityRecord;->isResolverActivity()Z
...
.method public static startUserSwitching()V
    ...
    :try_start_0
    sget-object v1, Lcom/android/server/wm/wtn;->wP:Lcom/oneplus/os/IOnePlusExService;
    ...
    sput-object v1, Lcom/android/server/wm/wtn;->wP:Lcom/oneplus/os/IOnePlusExService;
