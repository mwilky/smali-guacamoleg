...
.method public checkParallelAppControl(Landroid/app/IApplicationThread;ILjava/lang/String;ILjava/lang/String;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Lcom/android/server/wm/SafeActivityOptions;)Z
    ...
    iget-object p0, p0, Lcom/android/server/wm/OpActivityStarter;->mAppOpsService:Lcom/android/server/appop/AppOpsService;

    const/16 p5, 0x3ed

    iget-object p6, p7, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    invoke-virtual {p0, p5, p4, p6}, Lcom/android/server/appop/AppOpsService;->checkOperation(IILjava/lang/String;)I
...
.method resolveOtaWizardActivity(Landroid/content/Context;ILandroid/content/Intent;)Landroid/content/pm/ActivityInfo;
    .locals 3
    ...
    invoke-interface {p1, v0, v1, p2}, Landroid/content/pm/IPackageManager;->getActivityInfo(Landroid/content/ComponentName;II)Landroid/content/pm/ActivityInfo;
    ...
    invoke-interface {v0, p3, p1, v1, p2}, Landroid/content/pm/IPackageManager;->resolveIntent(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    ...
    :cond_2
    new-instance p3, Landroid/content/pm/ActivityInfo;

    invoke-direct {p3, p1}, Landroid/content/pm/ActivityInfo;-><init>(Landroid/content/pm/ActivityInfo;)V

    iget-object p1, p3, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/OpActivityStarter;->getAppInfoForUser(Landroid/content/pm/ApplicationInfo;I)Landroid/content/pm/ApplicationInfo;
...
.method public updateOtaWizardHomeIntent(Landroid/content/Intent;Landroid/content/Context;I)Landroid/content/pm/ActivityInfo;
    .locals 4
    ...
    const-string v1, "com.oneplus.opbackup"

    const-string v3, "com.oneplus.opbackup.OTAUpdateWizardActivity"
    ...
    const-string v0, "com.oneplus.opbackup.CATEGORY_HOME"

    invoke-virtual {p1, v0}, Landroid/content/Intent;->addCategory(Ljava/lang/String;)Landroid/content/Intent;

    invoke-virtual {p0, p2, p3, p1}, Lcom/android/server/wm/OpActivityStarter;->resolveOtaWizardActivity(Landroid/content/Context;ILandroid/content/Intent;)Landroid/content/pm/ActivityInfo;
