...
# static fields
.field public static final AU:I = 0x3c

.field public static final BU:I = 0x30

.field public static CU:I = 0x0

.field public static DU:I = 0x0

.field public static EU:I = 0x0

.field public static FU:I = 0x0

.field public static GU:I = 0x0

.field public static HU:I = 0x0

.field public static final IU:I = 0x28

.field public static final JU:I = 0x28

.field public static final KU:I = 0x28

.field public static LU:I = 0x0

.field public static MU:I = 0x0

.field public static NU:I = 0x0

.field public static final PU:I = 0x12c

.field public static final QU:I = 0x64

.field public static RU:I = 0x0

.field public static SU:I = 0x0

.field private static final TAG:Ljava/lang/String; = "OpQuickReply"

.field private static final TU:Ljava/util/List;
...
.field private static final UU:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static VU:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static WU:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static nU:Ljava/lang/Object; = null

.field private static final oU:Ljava/lang/String; = "Quick_Reply_Config"

.field private static final pU:Ljava/lang/String; = "com.oneplus.action.QUICK_REPLY_SETTINGS"

.field private static final qU:Ljava/lang/String; = "com.android.settings"

.field public static final rU:F = 0.4f

.field public static sIMELimitWidth:I = 0x0

.field private static sInstance:Lcom/android/server/wm/veq; = null

.field public static sU:I = 0x0

.field public static final tU:I = 0x0

.field public static final uU:I = 0x1

.field public static final vU:I = 0x2

.field public static final wU:I = 0x30a

.field public static final xU:I = 0x60

.field public static final yU:I = 0x54

.field public static final zU:I = 0x2a
...
.field private OT:Lcom/android/server/wm/WindowManagerService;

.field private PT:Lcom/android/server/am/ActivityManagerService;

.field private QT:Landroid/view/WindowManager$LayoutParams;

.field private RT:Landroid/view/WindowManager$LayoutParams;

.field private TT:Landroid/view/WindowManager$LayoutParams;

.field private UT:Landroid/view/WindowManager$LayoutParams;

.field private VT:Lcom/android/server/wm/veq$zta;

.field private WT:Lcom/android/server/wm/ActivityRecord;
...
.field private ZT:Lcom/android/internal/view/IInputMethodManager;

.field private _T:Lcom/oneplus/config/ConfigObserver;
...
.field private final eU:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field hU:Landroid/view/View;

.field iU:Landroid/view/View;

.field jU:Landroid/view/View;

.field kU:Landroid/view/View;

.field lU:Landroid/widget/FrameLayout;
...
.field mU:Landroid/widget/FrameLayout;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/veq;->nU:Ljava/lang/Object;
    ...
    sput v0, Lcom/android/server/wm/veq;->CU:I

    const/16 v0, 0x60

    sput v0, Lcom/android/server/wm/veq;->DU:I

    const/16 v0, 0x54

    sput v0, Lcom/android/server/wm/veq;->EU:I

    const/16 v0, 0x2a

    sput v0, Lcom/android/server/wm/veq;->FU:I

    const/16 v0, 0x3c

    sput v0, Lcom/android/server/wm/veq;->GU:I

    const/16 v0, 0x30

    sput v0, Lcom/android/server/wm/veq;->HU:I
    ...
    sput v0, Lcom/android/server/wm/veq;->LU:I

    sput v0, Lcom/android/server/wm/veq;->MU:I

    sput v0, Lcom/android/server/wm/veq;->NU:I

    const/16 v0, 0x12c

    sput v0, Lcom/android/server/wm/veq;->RU:I
    ...
    sput-object v0, Lcom/android/server/wm/veq;->TU:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/veq;->UU:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/veq;->VU:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/veq;->WU:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/veq;->MT:Z

    iput-boolean v0, p0, Lcom/android/server/wm/veq;->NT:Z
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->XT:Ljava/util/ArrayList;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/wm/veq;->YT:Z

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/veq;->eU:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/veq;->fU:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->gU:Ljava/util/List;
...
.method private Ia(Z)V
    ...
    sput p1, Lcom/android/server/wm/veq;->NU:I
    ...
    iget-object p1, p0, Lcom/android/server/wm/veq;->OT:Lcom/android/server/wm/WindowManagerService;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/wm/veq;->OT:Lcom/android/server/wm/WindowManagerService;
    ...
    iput p1, p0, Lcom/android/server/wm/veq;->aU:I
    ...
    iget p0, p0, Lcom/android/server/wm/veq;->aU:I
    ...
    sget p1, Lcom/android/server/wm/veq;->NU:I
...
.method private Ib(I)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;

    iput p1, v0, Landroid/view/WindowManager$LayoutParams;->height:I

    iget-object p1, p0, Lcom/android/server/wm/veq;->iU:Landroid/view/View;

    invoke-direct {p0}, Lcom/android/server/wm/veq;->gq()V

    if-nez p1, :cond_1

    iget-object p1, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object p1, p0, Lcom/android/server/wm/veq;->iU:Landroid/view/View;
    ...
    iput-object p1, p0, Lcom/android/server/wm/veq;->lU:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, Lcom/android/server/wm/veq;->mU:Landroid/widget/FrameLayout;

    iget-object p1, p0, Lcom/android/server/wm/veq;->mU:Landroid/widget/FrameLayout;
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->iU:Landroid/view/View;

    iget-object v1, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;

    invoke-interface {p1, v0, v1}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p1, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;

    const/4 v0, 0x5

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;
...
.method private Jb(I)V
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->fU:Ljava/util/ArrayList;
...
.method private Kb(I)V
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->iU:Landroid/view/View;
...
.method private Wp()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->hU:Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->QT:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->hU:Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->hU:Landroid/view/View;

    iget-object v4, p0, Lcom/android/server/wm/veq;->QT:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->RT:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->RT:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->TT:Landroid/view/WindowManager$LayoutParams;
...
.method private Zp()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->OT:Lcom/android/server/wm/WindowManagerService;
...
.method private _p()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->ZT:Lcom/android/internal/view/IInputMethodManager;
    ...
    :goto_1
    iget-object v3, p0, Lcom/android/server/wm/veq;->OT:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->Vp()V
    ...
    :cond_3
    invoke-direct {p0}, Lcom/android/server/wm/veq;->Xp()V

    invoke-direct {p0, v2}, Lcom/android/server/wm/veq;->rc(Ljava/lang/String;)Z
    ...
    iget-object v4, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/wm/veq;->rc(Ljava/lang/String;)Z
    ...
    iget-object v6, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;
...
.method private aq()V
    ...
    iget-object v5, p0, Lcom/android/server/wm/veq;->eU:Landroid/util/ArrayMap;
...
.method private bq()V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->cq()V
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->hU:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_0
    iput-object v1, p0, Lcom/android/server/wm/veq;->hU:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->kU:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_4
    iput-object v1, p0, Lcom/android/server/wm/veq;->kU:Landroid/view/View;
...
.method static synthetic cno(Lcom/android/server/wm/veq;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->bq()V
...
.method private cq()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;
    ...
    iget-object v1, p0, Lcom/android/server/wm/veq;->iU:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->iU:Landroid/view/View;
...
.method private dq()V
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;
...
.method private eq()V
    ...
    sput v1, Lcom/android/server/wm/veq;->CU:I
    ...
    sput v1, Lcom/android/server/wm/veq;->DU:I
    ...
    sput v1, Lcom/android/server/wm/veq;->EU:I
    ...
    sput v1, Lcom/android/server/wm/veq;->FU:I
    ...
    sput v1, Lcom/android/server/wm/veq;->GU:I
    ...
    sput v1, Lcom/android/server/wm/veq;->HU:I
    ...
    sput v2, Lcom/android/server/wm/veq;->LU:I

    invoke-static {v1}, Ljava/lang/Math;->round(F)I

    move-result v2

    sput v2, Lcom/android/server/wm/veq;->MU:I

    invoke-static {v1}, Ljava/lang/Math;->round(F)I

    move-result v1

    sput v1, Lcom/android/server/wm/veq;->NU:I
    ...
    sput v1, Lcom/android/server/wm/veq;->RU:I
    ...
    sput v2, Lcom/android/server/wm/veq;->NU:I
    ...
    sget v1, Lcom/android/server/wm/veq;->CU:I
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->QT:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v1, Lcom/android/server/wm/veq;->FU:I
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->RT:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Lcom/android/server/wm/veq;->RT:Landroid/view/WindowManager$LayoutParams;

    iget-object v1, p0, Lcom/android/server/wm/veq;->QT:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->TT:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Lcom/android/server/wm/veq;->TT:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;
...
.method private fq()V
    ...
    sget v1, Lcom/android/server/wm/veq;->sU:I

    const/4 v2, 0x2

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/veq;->RT:Landroid/view/WindowManager$LayoutParams;

    sget v2, Lcom/android/server/wm/veq;->GU:I
    ...
    sget v2, Lcom/android/server/wm/veq;->DU:I

    add-int/2addr v1, v2

    sget v3, Lcom/android/server/wm/veq;->HU:I

    add-int/2addr v1, v3

    iput v1, v0, Landroid/view/WindowManager$LayoutParams;->x:I

    iget-object v1, p0, Lcom/android/server/wm/veq;->TT:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v3, Lcom/android/server/wm/veq;->DU:I
    ...
    sget v2, Lcom/android/server/wm/veq;->HU:I
    ...
    sget v4, Lcom/android/server/wm/veq;->HU:I
    ...
    iget-object v1, p0, Lcom/android/server/wm/veq;->hU:Landroid/view/View;

    iget-object v2, p0, Lcom/android/server/wm/veq;->QT:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->RT:Landroid/view/WindowManager$LayoutParams;
...
.method private gck(Lorg/json/JSONArray;)V
    ...
    :cond_5
    sget-object p1, Lcom/android/server/wm/veq;->nU:Ljava/lang/Object;
    ...
    sput-object p0, Lcom/android/server/wm/veq;->VU:Ljava/util/List;
...
.method private getAppBounds()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;
...
.method private gq()V
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v4, Lcom/android/server/wm/veq;->LU:I
    ...
    sget v5, Lcom/android/server/wm/veq;->EU:I
    ...
    iput v1, p0, Lcom/android/server/wm/veq;->dU:I

    iput v2, p0, Lcom/android/server/wm/veq;->cU:I
    ...
    iget v2, p0, Lcom/android/server/wm/veq;->cU:I
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->UT:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v3, Lcom/android/server/wm/veq;->MU:I
    ...
    sget v2, Lcom/android/server/wm/veq;->EU:I
    ...
    iput v3, p0, Lcom/android/server/wm/veq;->dU:I
    ...
    sget v3, Lcom/android/server/wm/veq;->EU:I
    ...
    iput v2, p0, Lcom/android/server/wm/veq;->dU:I

    :cond_8
    :goto_0
    iget v1, p0, Lcom/android/server/wm/veq;->bU:I
    ...
    sget v3, Lcom/android/server/wm/veq;->NU:I
...
.method private hq()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/wm/veq;->WT:Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object v1, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;
...
.method static synthetic ibl(Lcom/android/server/wm/veq;)I
    ...
    iget p0, p0, Lcom/android/server/wm/veq;->bU:I
...
.method static synthetic igw(Lcom/android/server/wm/veq;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->hq()V
...
.method private init()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->ZT:Lcom/android/internal/view/IInputMethodManager;
    ...
    iput-object v1, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;

    new-instance v0, Lcom/android/server/wm/veq$sis;

    iget-object v1, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;
...
.method static synthetic oif(Lcom/android/server/wm/veq;)Lcom/android/server/wm/ActivityRecord;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->WT:Lcom/android/server/wm/ActivityRecord;
...
.method static synthetic qbh(Lcom/android/server/wm/veq;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->_p()V
...
.method private rc(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/wm/veq;->VU:Ljava/util/List;
...
.method static synthetic sis(Lcom/android/server/wm/veq;I)I
    ...
    iput p1, p0, Lcom/android/server/wm/veq;->bU:I
...
.method static synthetic ssp(Lcom/android/server/wm/veq;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->Wp()V
...
.method static synthetic tsu(Lcom/android/server/wm/veq;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/veq;->MT:Z
...
.method private updateSettings()V
    ...
    :goto_0
    iget-boolean v2, p0, Lcom/android/server/wm/veq;->YT:Z

    const-string v3, "OpQuickReply"

    if-eq v2, v1, :cond_1

    iput-boolean v1, p0, Lcom/android/server/wm/veq;->YT:Z
...
.method static synthetic wtn(Lcom/android/server/wm/veq;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->Yp()V
...
.method static synthetic you(Lcom/android/server/wm/veq;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->eU:Landroid/util/ArrayMap;
...
.method static synthetic you(Lcom/android/server/wm/veq;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/veq;->Kb(I)V
...
.method private zta(Landroid/os/IBinder;)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/veq;->OT:Lcom/android/server/wm/WindowManagerService;
...
.method private zta(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/veq;->MT:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/veq;->NT:Z

    iget-object p1, p0, Lcom/android/server/wm/veq;->XT:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v3, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->WT:Lcom/android/server/wm/ActivityRecord;
...
.method static synthetic zta(Lcom/android/server/wm/veq;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/veq;->Ib(I)V
...
.method static synthetic zta(Lcom/android/server/wm/veq;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/veq;->gck(Lorg/json/JSONArray;)V
...
.method private zta(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    ...
    sget v2, Lcom/android/server/wm/veq;->RU:I
...
.method public bootComplete()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->_T:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->_T:Lcom/oneplus/config/ConfigObserver;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/veq;->gck(Lorg/json/JSONArray;)V
...
.method public exitQuickReply()V
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->WT:Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/server/wm/veq;->VT:Lcom/android/server/wm/veq$zta;
...
.method public focusChangedLw(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->Zp()Ljava/lang/String;
    ...
    :cond_0
    iget-boolean p1, p0, Lcom/android/server/wm/veq;->MT:Z
...
.method public getImBound()Landroid/graphics/Rect;
    ...
    sget v3, Lcom/android/server/wm/veq;->CU:I
    ...
    sget v1, Lcom/android/server/wm/veq;->NU:I
...
.method public getQuickReplyList(I)Ljava/util/List;
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/android/server/wm/veq;->YT:Z

    if-eqz p0, :cond_1

    sget-object v1, Lcom/android/server/wm/veq;->VU:Ljava/util/List;

    :cond_1
    return-object v1

    :cond_2
    sget-object p0, Lcom/android/server/wm/veq;->UU:Ljava/util/List;
...
.method public isInCameraActivityList(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/wm/veq;->WU:Ljava/util/List;
...
.method public isQuickReplyExiting()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/veq;->NT:Z
...
.method public isQuickReplyIM(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/wm/veq;->TU:Ljava/util/List;
    ...
    sget-object v0, Lcom/android/server/wm/veq;->UU:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->gU:Ljava/util/List;
...
.method public isQuickReplyIMWin(Lcom/android/server/wm/WindowState;)Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/veq;->MT:Z
...
.method public notifyImeShow(Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/veq;->YT:Z
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->eU:Landroid/util/ArrayMap;
...
.method public setAMandWM(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;

    iput-object p2, p0, Lcom/android/server/wm/veq;->OT:Lcom/android/server/wm/WindowManagerService;
...
.method public setKeyguardDone(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/veq;->WT:Lcom/android/server/wm/ActivityRecord;

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/android/server/wm/veq;->PT:Lcom/android/server/am/ActivityManagerService;
...
.method public setQuickReplyRunning(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/veq;->MT:Z
...
.method public setResumedApp(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/veq;->MT:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/veq;->XT:Ljava/util/ArrayList;
    ...
    :cond_2
    :goto_0
    iput-object p1, p0, Lcom/android/server/wm/veq;->WT:Lcom/android/server/wm/ActivityRecord;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public systemReady()V
    ...
    iput v0, p0, Lcom/android/server/wm/veq;->bU:I
    ...
    invoke-direct {p0}, Lcom/android/server/wm/veq;->aq()V
...
.method public updateIMEFrameIfNeeded(Ljava/lang/String;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    sget p2, Lcom/android/server/wm/veq;->EU:I
