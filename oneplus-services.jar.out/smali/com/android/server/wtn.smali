...
.method constructor <init>(Lcom/android/server/OnePlusExService;Landroid/app/Notification$Builder;Landroid/content/Context;III)V
    ...
    iput-object p1, p0, Lcom/android/server/wtn;->this$0:Lcom/android/server/OnePlusExService;

    iput-object p2, p0, Lcom/android/server/wtn;->val$n:Landroid/app/Notification$Builder;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/wtn;->val$context:Landroid/content/Context;
    ...
    invoke-static {v2}, Lcom/android/server/OnePlusExService;->access$1000(Lcom/android/server/OnePlusExService;)[I
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/OnePlusExService;->access$1100(Lcom/android/server/OnePlusExService;Landroid/content/Context;Landroid/app/Notification$Builder;)V
    ...
    invoke-static {v1}, Lcom/android/server/OnePlusExService;->access$1200(Lcom/android/server/OnePlusExService;)Landroid/app/NotificationManager;
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/server/OnePlusExService;->access$1400(Lcom/android/server/OnePlusExService;ILandroid/content/Context;IILandroid/app/Notification$Builder;)V
    ...
    invoke-static {v0}, Lcom/android/server/OnePlusExService;->access$1500(Lcom/android/server/OnePlusExService;)I
    ...
    invoke-static {v0}, Lcom/android/server/OnePlusExService;->access$1600(Lcom/android/server/OnePlusExService;)Landroid/os/Handler;
