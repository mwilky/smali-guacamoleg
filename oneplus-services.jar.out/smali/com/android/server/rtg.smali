.class public final Lcom/android/server/rtg;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/rtg;->DEBUG_ONEPLUS:Z
...
.method public constructor <init>()V
    ...
    invoke-direct {v1, p0}, Lcom/android/server/sis;-><init>(Lcom/android/server/rtg;)V
...
.method private Za(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/android/server/rtg;->mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/rtg;->mPackageManager:Landroid/content/pm/PackageManager;

    iget-object p1, p0, Lcom/android/server/rtg;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iget-object v0, p0, Lcom/android/server/rtg;->mContext:Landroid/content/Context;
    ...
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/server/rtg;->zta(Ljava/io/File;)V
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, Lcom/android/server/rtg;->DEBUG_ONEPLUS:Z
...
.method private gl()V
    ...
    iget-object v2, p0, Lcom/android/server/rtg;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/rtg;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method private hl()V
    ...
    iget-object v2, p0, Lcom/android/server/rtg;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/rtg;->mSession:Landroid/content/pm/PackageInstaller$Session;
...
.method private il()V
    ...
    sget-boolean v1, Lcom/android/server/rtg;->DEBUG_ONEPLUS:Z
    ...
    :goto_2
    sget-boolean v4, Lcom/android/server/rtg;->DEBUG_ONEPLUS:Z
...
.method static synthetic zta(Lcom/android/server/rtg;)Landroid/content/Context;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/rtg;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private zta(Ljava/io/File;)V
    ...
    iget-object v1, p0, Lcom/android/server/rtg;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/server/rtg;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/rtg;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    :cond_2
    invoke-direct {p0, v2}, Lcom/android/server/rtg;->zta(Landroid/content/pm/PackageInfo;)Z
    ...
    sget-boolean p0, Lcom/android/server/rtg;->DEBUG_ONEPLUS:Z
    ...
    :cond_5
    sget-boolean v2, Lcom/android/server/rtg;->DEBUG_ONEPLUS:Z
    ...
    iput-object v4, p0, Lcom/android/server/rtg;->mSession:Landroid/content/pm/PackageInstaller$Session;
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/rtg;->mSession:Landroid/content/pm/PackageInstaller$Session;
    ...
    iget-object p0, p0, Lcom/android/server/rtg;->mSession:Landroid/content/pm/PackageInstaller$Session;
...
.method private zta(Landroid/content/pm/PackageInfo;)Z
    ...
    iget-object v3, p0, Lcom/android/server/rtg;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iget-object p0, p0, Lcom/android/server/rtg;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method public zta(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, p2}, Lcom/android/server/tsu;-><init>(Lcom/android/server/rtg;Ljava/lang/String;)V
