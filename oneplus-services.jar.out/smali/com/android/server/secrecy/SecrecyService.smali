...
.field private Bh:Lcom/android/server/secrecy/you/you;

.field private Ch:Lcom/android/server/secrecy/you/sis;
...
.field private final zh:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->zh:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->uh:Lcom/android/server/ServiceThread;

    iget-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->uh:Lcom/android/server/ServiceThread;

    invoke-virtual {p1}, Lcom/android/server/ServiceThread;->start()V

    invoke-direct {p0}, Lcom/android/server/secrecy/SecrecyService;->Ml()V
...
.method private Ml()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Bh:Lcom/android/server/secrecy/you/you;
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Ch:Lcom/android/server/secrecy/you/sis;
...
.method private dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p3}, Lcom/android/server/secrecy/zta/sis;->td()Lcom/android/server/secrecy/zta/zta;
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/sis;->td()Lcom/android/server/secrecy/zta/zta;
    ...
    sget-boolean p1, Lcom/android/server/secrecy/SecrecyService;->DEBUG:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/secrecy/SecrecyService;->mSystemReady:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/secrecy/SecrecyService;->Ah:Z
    ...
    invoke-virtual {p3, v1}, Lcom/android/server/secrecy/zta/sis;->q(I)Z

    move-result p3

    if-nez p3, :cond_12

    iget-object p3, p0, Lcom/android/server/secrecy/SecrecyService;->Bh:Lcom/android/server/secrecy/you/you;
    ...
    :cond_12
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->Ch:Lcom/android/server/secrecy/you/sis;
...
.method private initPolicy()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    iget-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    iget-object v1, p0, Lcom/android/server/secrecy/SecrecyService;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/secrecy/SecrecyService;->uh:Lcom/android/server/ServiceThread;
...
.method static synthetic sis(Lcom/android/server/secrecy/SecrecyService;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->mContext:Landroid/content/Context;
...
.method static synthetic zta(Lcom/android/server/secrecy/SecrecyService;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->zh:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private zta(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/secrecy/zta/sis;->q(I)Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Bh:Lcom/android/server/secrecy/you/you;
    ...
    :cond_2
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->Bh:Lcom/android/server/secrecy/you/you;
...
.method static synthetic zta(Lcom/android/server/secrecy/SecrecyService;Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/secrecy/SecrecyService;->zta(Landroid/content/pm/ActivityInfo;)Z
...
.method protected dynamicallyConfigLogTag(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/secrecy/SecrecyService;->tsu(Ljava/io/PrintWriter;)V
    ...
    sput-boolean p2, Lcom/android/server/secrecy/SecrecyService;->DEBUG:Z

    invoke-static {p2}, Lcom/android/server/secrecy/zta/zta/zta;->r(Z)V
...
.method public ma()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/secrecy/SecrecyService;->Ah:Z
...
.method public systemReady()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/secrecy/SecrecyService;->vdb(Z)V
...
.method public vdb(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/SecrecyService;->Ah:Z
