...
.field public static final kL:Z = false

.field public static final lL:Z = true
...
# instance fields
.field private final cL:Lcom/android/server/secrecy/sis;

.field private dL:Lcom/android/server/secrecy/SecrecyService;
...
.field private hL:Lcom/android/server/secrecy/zta/you;

.field private iL:Lcom/android/server/secrecy/zta/zta;

.field private jL:Lcom/android/server/secrecy/zta/rtg;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/zta/sis;->cL:Lcom/android/server/secrecy/sis;
...
.method private po()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->hL:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->pd()J

    move-result-wide v0

    iget-object v2, p0, Lcom/android/server/secrecy/zta/sis;->hL:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/you;->qd()J

    move-result-wide v2

    iget-object v4, p0, Lcom/android/server/secrecy/zta/sis;->hL:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/you;->rd()Z
...
.method private qo()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->cL:Lcom/android/server/secrecy/sis;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->cL:Lcom/android/server/secrecy/sis;
...
.method private tsu(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/secrecy/zta/tsu;->aa(Ljava/lang/String;)V
...
.method private you(Ljava/util/Map;Ljava/lang/String;Z)V
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z
    ...
    iget-boolean v7, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p1

    iget-boolean v2, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z
    ...
    iget-boolean p1, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z
    ...
    :cond_3
    invoke-direct {p0, p2, v2}, Lcom/android/server/secrecy/zta/sis;->tsu(Ljava/lang/String;Z)V
...
.method public X(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/secrecy/zta/you;->X(Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/android/server/secrecy/zta/sis;->po()V
...
.method public Y(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/secrecy/sis;->V(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->cL:Lcom/android/server/secrecy/sis;

    invoke-virtual {v0, p1}, Lcom/android/server/secrecy/sis;->W(Ljava/lang/String;)V
...
.method public ear()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->Dd()Z

    move-result v0

    iget-object v1, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v1}, Lcom/android/server/secrecy/zta/rtg;->yd()Z

    move-result v1

    iget-object v2, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v2}, Lcom/android/server/secrecy/zta/rtg;->Bd()Z

    move-result v2

    iget-object v3, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v3}, Lcom/android/server/secrecy/zta/rtg;->zd()Z
    ...
    iget-object v4, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v4}, Lcom/android/server/secrecy/zta/rtg;->Cd()J

    move-result-wide v4

    iget-object v6, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/rtg;->Ad()J
...
.method public pd()Ljava/lang/Long;
    .locals 2

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->hL:Lcom/android/server/secrecy/zta/you;

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->pd()J
...
.method public q(I)Z
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z
    ...
    :cond_1
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z
    ...
    :cond_2
    iget-boolean p0, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z
...
.method public systemReady(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->sd()V

    invoke-direct {p0}, Lcom/android/server/secrecy/zta/sis;->qo()V

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/sis;->Gc()V
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/rtg;->Cd()J

    move-result-wide v0

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;
...
.method public td()Lcom/android/server/secrecy/zta/zta;
    .locals 0

    iget-object p0, p0, Lcom/android/server/secrecy/zta/sis;->iL:Lcom/android/server/secrecy/zta/zta;
...
.method public tsu(Ljava/util/Map;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/secrecy/zta/sis;->dL:Lcom/android/server/secrecy/SecrecyService;
...
.method public ud()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/secrecy/zta/you;->rd()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/you;->qd()J
...
.method public zta(Landroid/content/Context;Lcom/android/server/secrecy/SecrecyService;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->dL:Lcom/android/server/secrecy/SecrecyService;

    new-instance p2, Lcom/android/server/secrecy/zta/you;

    invoke-direct {p2}, Lcom/android/server/secrecy/zta/you;-><init>()V

    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->hL:Lcom/android/server/secrecy/zta/you;
    ...
    iput-object p2, p0, Lcom/android/server/secrecy/zta/sis;->iL:Lcom/android/server/secrecy/zta/zta;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/zta/sis;->jL:Lcom/android/server/secrecy/zta/rtg;
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, Lcom/android/server/secrecy/zta/sis;->dL:Lcom/android/server/secrecy/SecrecyService;
    ...
    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->eL:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->fL:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/server/secrecy/zta/sis;->gL:Z
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/secrecy/zta/sis;->q(I)Z
