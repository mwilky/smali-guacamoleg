...
.field private static final FK:Ljava/lang/String; = "imei"

.field private static final GK:Ljava/lang/String; = "rc4_key"

.field private static final HK:Ljava/lang/String; = "last_download_time"

.field private static final JK:Ljava/lang/String; = "encrypt_app"

.field private static final KK:Ljava/lang/String; = "encrypt_log"

.field private static final LK:Ljava/lang/String; = "encrypt_adb"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/sis;->xK:Ljava/lang/String;

    const/16 v0, 0x100

    new-array v0, v0, [B

    iput-object v0, p0, Lcom/android/server/secrecy/sis;->yK:[B
...
.method private mo()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/secrecy/sis;->no()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/sis;->ud()Z
    ...
    iput-object v1, p0, Lcom/android/server/secrecy/sis;->zK:[B

    iget-object v1, p0, Lcom/android/server/secrecy/sis;->yK:[B

    iget-object v9, p0, Lcom/android/server/secrecy/sis;->zK:[B
    ...
    iput-object v1, p0, Lcom/android/server/secrecy/sis;->AK:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/secrecy/zta/sis;->X(Ljava/lang/String;)V
    :try_end_5
...
.method private oo()V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/sis;->zK:[B
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/secrecy/zta/sis;->q(I)Z
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/secrecy/zta/sis;->q(I)Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/secrecy/zta/sis;->q(I)Z

    move-result v5

    iget-object v6, p0, Lcom/android/server/secrecy/sis;->mPolicyManager:Lcom/android/server/secrecy/zta/sis;

    invoke-virtual {v6}, Lcom/android/server/secrecy/zta/sis;->pd()Ljava/lang/Long;
    ...
    iget-object v7, p0, Lcom/android/server/secrecy/sis;->AK:Ljava/lang/String;

    if-eqz v7, :cond_1

    const-string v7, "imei"

    iget-object v8, p0, Lcom/android/server/secrecy/sis;->AK:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/server/secrecy/sis;->zK:[B
    ...
    invoke-direct {p0, v0}, Lcom/android/server/secrecy/sis;->ec(Ljava/lang/String;)V
    :try_end_2
...
.method static synthetic sis(Lcom/android/server/secrecy/sis;)V
    ...
    invoke-direct {p0}, Lcom/android/server/secrecy/sis;->oo()V
...
.method static synthetic zta(Lcom/android/server/secrecy/sis;)V
    ...
    invoke-direct {p0}, Lcom/android/server/secrecy/sis;->mo()V
...
.method public V(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/sis;->AK:Ljava/lang/String;
...
.method public W(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/sis;->zK:[B
...
.method public getSecrecyKey([B)Z
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/sis;->yK:[B
...
.method public zta(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/secrecy/sis;->yK:[B
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/sis;->AK:Ljava/lang/String;
