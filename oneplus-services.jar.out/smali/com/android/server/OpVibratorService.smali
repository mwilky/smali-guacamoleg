...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/OpVibratorService$zta;,
...
.field private static final INPUTMETHOD_DURATION_MAP_PATH:Ljava/lang/String; = "/system/etc/inputmethod_duration_map.xml"
...
.field private static final TAG:Ljava/lang/String; = "OpVibratorService"
...
.field private static final VIBRATOR_EFFECT_MAP_PATH:Ljava/lang/String; = "/system/etc/vibrator_effect_map.xml"
...
.field private mConfigUpdater:Lcom/android/server/OpVibratorService$zta;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "persist.debug.vibrator.debugall"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Lcom/android/server/OpVibratorService;->DEBUG:Z
    ...
    sput-boolean v1, Lcom/android/server/OpVibratorService;->DEBUG_ONEPLUS:Z

    const-string v1, "persist.debug.vibrator.dump"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Lcom/android/server/OpVibratorService;->DEBUG_DUMP:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lcom/android/server/OpVibratorService;->effectMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lcom/android/server/OpVibratorService;->durationMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lcom/android/server/OpVibratorService;->minDurationMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lcom/android/server/OpVibratorService;->maxDurationMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lcom/android/server/OpVibratorService;->enhanceDefaultMap:Ljava/util/Map;

    sput-boolean v0, Lcom/android/server/OpVibratorService;->sShortVibrationOnlineConfigEnabled:Z
...
.method private getVibrationRules(Ljava/lang/String;)V
    ...
    new-instance v4, Lcom/android/server/OpVibratorService$you;
    ...
    invoke-direct {v4, p0, v5, v6, v7}, Lcom/android/server/OpVibratorService$you;-><init>(Lcom/android/server/OpVibratorService;III)V
...
.method private grabOnlineConfig()V
    ...
    iget-object p0, p0, Lcom/android/server/OpVibratorService;->mConfigUpdater:Lcom/android/server/OpVibratorService$zta;

    invoke-virtual {v0}, Lcom/oneplus/config/ConfigGrabber;->grabConfig()Lorg/json/JSONArray;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/server/OpVibratorService$zta;->resolveConfigFromJSON(Lorg/json/JSONArray;)V
...
.method public doVibratorPerformEffect(II)J
    .locals 2
    ...
    invoke-static {p1, p2, v0, v1}, Lcom/android/server/VibratorService;->vibratorPerformEffect(JJ)J
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/android/server/VibratorService;->vibratorPerformEffect(JJ)J
...
.method public initVibratorEffectMap(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_1
    const-string p1, "/system/etc/vibrator_effect_map.xml"

    invoke-virtual {p0, p1}, Lcom/android/server/OpVibratorService;->getVibratorEffectMap(Ljava/lang/String;)V

    const-string p1, "/system/etc/inputmethod_duration_map.xml"
    ...
    new-instance p1, Lcom/android/server/OpVibratorService$zta;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lcom/android/server/OpVibratorService$zta;-><init>(Lcom/android/server/OpVibratorService;Lcom/android/server/j;)V
...
.method public motorF0Calibration()V
    ...
    const-string v8, "motorF0Calibration buff"
    ...
    :goto_2
    const-string v6, "/sys/class/leds/vibrator/rf_hz"
    ...
    invoke-static {p0, v6, v4}, Lcom/android/server/OpVibratorService;->writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v6}, Lcom/android/server/OpVibratorService;->readStringFromFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v6, p0}, Lcom/android/server/OpVibratorService;->writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v1}, Lcom/android/server/OpVibratorService;->writeStringToFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public vibrate(ILandroid/os/VibrationEffect;Ljava/lang/String;)Landroid/os/VibrationEffect;
    .locals 20
    ...
    iget-object v3, v1, Landroid/os/VibrationEffect$Waveform;->mTimings:[J
    ...
    :goto_0
    invoke-static {v3, v8, v9}, Lcom/android/internal/util/ArrayUtils;->removeLong([JJ)[J
    ...
    :cond_2
    iget-boolean v8, v0, Lcom/android/server/OpVibratorService;->isEffectChanged:Z
    ...
    :goto_1
    :try_start_0
    invoke-static {v3, v1}, Landroid/os/VibrationEffect;->createWaveform([JI)Landroid/os/VibrationEffect;
    ...
    sget-object v8, Lcom/android/server/OpVibratorService;->maxDurationMap:Ljava/util/Map;
    ...
    :cond_6
    iget-object v11, v0, Lcom/android/server/OpVibratorService;->imPkg:Ljava/lang/String;
    ...
    :cond_8
    instance-of v11, v1, Landroid/os/VibrationEffect$Waveform;

    if-eqz v11, :cond_9

    move-object v11, v1

    check-cast v11, Landroid/os/VibrationEffect$Waveform;
    ...
    :cond_9
    instance-of v11, v1, Landroid/os/VibrationEffect$OneShot;
    ...
    :cond_a
    instance-of v11, v1, Landroid/os/VibrationEffect$Prebaked;
    ...
    :goto_4
    sget-object v9, Lcom/android/server/OpVibratorService;->TAG:Ljava/lang/String;
    ...
    iput v9, v0, Lcom/android/server/OpVibratorService;->intensityEffectType:I

    sget-object v9, Lcom/android/server/OpVibratorService;->enhanceDefaultMap:Ljava/util/Map;
    ...
    iget-object v7, v0, Lcom/android/server/OpVibratorService;->mEffectConfigs:Ljava/util/HashMap;
    ...
    sget-boolean v10, Lcom/android/server/OpVibratorService;->DEBUG_ONEPLUS:Z

    if-eqz v10, :cond_15

    sget-object v10, Lcom/android/server/OpVibratorService;->TAG:Ljava/lang/String;

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "short vibration parameters, key = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v11, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v12, ", minDuration = "
    ...
    :cond_15
    const-string v10, "unspecified_package"
