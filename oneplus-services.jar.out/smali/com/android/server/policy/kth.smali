...
.field private static final GD:Ljava/lang/String; = "1"

.field private static final HD:Ljava/lang/String; = "7"

.field private static final JD:Ljava/lang/String; = "5"

.field private static final KD:Ljava/lang/String; = "4"

.field private static final LD:I = 0xbb8

.field private static final MD:Ljava/lang/String; = "15"

.field private static final ND:Ljava/lang/String; = "6"

.field private static final OD:Ljava/lang/String; = "2"

.field private static final PD:Ljava/lang/String; = "14"

.field private static final QD:Ljava/lang/String; = "12"

.field private static final RD:Ljava/lang/String; = "13"

.field private static final SD:Ljava/lang/String; = "OpenCamera"

.field private static final TAG:Ljava/lang/String; = "DeviceKeyHandler"

.field private static final TD:Ljava/lang/String; = "OpenTorch"

.field private static final UD:Ljava/lang/String; = "FrontCamera"

.field private static final VD:Ljava/lang/String; = "TakeVideo"

.field private static final VIBRATION_ATTRIBUTES:Landroid/media/AudioAttributes;

.field private static final WD:Ljava/lang/String; = "OpenShelf"

.field private static final XD:Ljava/lang/String; = "OpenApp"

.field private static final YD:Ljava/lang/String; = "OpenShortcut"

.field private static final ZD:Ljava/lang/String; = "/proc/touchpanel/gesture_enable"

.field private static final _D:Ljava/lang/String; = "/proc/touchpanel/coordinate"

.field private static final aE:Ljava/lang/String; = "/proc/touchpanel/gesture_switch"

.field private static final bE:J = 0x4bL

.field private static final cE:J = 0x96L

.field private static final dE:Ljava/lang/String; = "0"

.field private static final eE:F = 0.1f

.field private static final fE:I = 0x3e8
...
.field DD:Landroid/hardware/SensorEventListener;

.field ED:Landroid/hardware/SensorEventListener;

.field private final FD:Landroid/hardware/camera2/CameraManager$TorchCallback;

.field final eD:Ljava/util/HashMap;
...
.field fD:Landroid/os/PowerManager$WakeLock;

.field gD:Landroid/os/PowerManager$WakeLock;

.field hD:Landroid/os/PowerManager$WakeLock;
...
.field sD:Landroid/content/pm/LauncherApps;

.field private tD:Z

.field private uD:Landroid/hardware/camera2/CameraManager;

.field private vD:Z

.field private wD:Z

.field private xD:Lcom/android/server/policy/kth$zta;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/policy/kth;->eD:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/policy/kth;->iD:I

    iput-boolean v0, p0, Lcom/android/server/policy/kth;->jD:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->kD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->lD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->mD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->nD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->oD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->pD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->qD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->rD:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/kth;->vD:Z

    iput-boolean v0, p0, Lcom/android/server/policy/kth;->wD:Z

    iput-boolean v0, p0, Lcom/android/server/policy/kth;->mSensorEnabled:Z

    iput-boolean v0, p0, Lcom/android/server/policy/kth;->yD:Z

    iput-boolean v1, p0, Lcom/android/server/policy/kth;->zD:Z

    iput-boolean v0, p0, Lcom/android/server/policy/kth;->mSleeping:Z

    iput-boolean v0, p0, Lcom/android/server/policy/kth;->CD:Z
    ...
    iput-object v2, p0, Lcom/android/server/policy/kth;->DD:Landroid/hardware/SensorEventListener;
    ...
    iput-object v2, p0, Lcom/android/server/policy/kth;->ED:Landroid/hardware/SensorEventListener;
    ...
    iput-object v2, p0, Lcom/android/server/policy/kth;->FD:Landroid/hardware/camera2/CameraManager$TorchCallback;
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/kth;->CD:Z
    ...
    iput-object v0, p0, Lcom/android/server/policy/kth;->fD:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, p0, Lcom/android/server/policy/kth;->gD:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, p0, Lcom/android/server/policy/kth;->hD:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object p1, p0, Lcom/android/server/policy/kth;->uD:Landroid/hardware/camera2/CameraManager;
    ...
    iput-boolean p1, p0, Lcom/android/server/policy/kth;->wD:Z
...
.method private Kn()V
    ...
    iget-object v3, p0, Lcom/android/server/policy/kth;->ED:Landroid/hardware/SensorEventListener;
...
.method private Mn()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/policy/kth;->za(Z)V
...
.method private Nn()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/policy/kth;->Aa(Z)V
...
.method private On()V
    ...
    invoke-static {v0}, Lcom/android/server/policy/bio;->O(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/policy/kth;->Yb(Ljava/lang/String;)V
    ...
    iget-boolean v2, p0, Lcom/android/server/policy/kth;->pD:Z
    ...
    invoke-direct {p0}, Lcom/android/server/policy/kth;->Mn()V
    ...
    :goto_2
    invoke-direct {p0, v2}, Lcom/android/server/policy/kth;->rb(I)V

    :cond_10
    :goto_3
    iget-object v2, p0, Lcom/android/server/policy/kth;->eD:Ljava/util/HashMap;
    ...
    :pswitch_0
    invoke-direct {p0, v1}, Lcom/android/server/policy/kth;->Yb(Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lcom/android/server/policy/kth;->BD:Z
    ...
    iput-object v0, p0, Lcom/android/server/policy/kth;->xD:Lcom/android/server/policy/kth$zta;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/policy/kth;->Zb(Ljava/lang/String;)I
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/kth;->tD:Z

    xor-int/2addr v0, v9

    invoke-virtual {p0, v0}, Lcom/android/server/policy/kth;->e(Z)Z
...
.method private Pn()V
    ...
    iget-object v0, p0, Lcom/android/server/policy/kth;->fD:Landroid/os/PowerManager$WakeLock;
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/policy/kth;->wD:Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/policy/kth;->Ln()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :catch_0
    :try_start_2
    iget-boolean v1, p0, Lcom/android/server/policy/kth;->vD:Z
    ...
    :cond_2
    invoke-direct {p0}, Lcom/android/server/policy/kth;->Kn()V
    ...
    iget-object p0, p0, Lcom/android/server/policy/kth;->fD:Landroid/os/PowerManager$WakeLock;
...
.method private Qn()V
    ...
    iput v3, p0, Lcom/android/server/policy/kth;->iD:I
    ...
    iget v4, p0, Lcom/android/server/policy/kth;->iD:I
    ...
    :cond_0
    iget v3, p0, Lcom/android/server/policy/kth;->iD:I

    const/4 v4, 0x7

    invoke-static {v3, v4}, Lcom/android/server/policy/kth;->bvj(II)I
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->pD:Z

    iget v3, p0, Lcom/android/server/policy/kth;->iD:I

    const/4 v5, 0x5

    invoke-static {v3, v5}, Lcom/android/server/policy/kth;->bvj(II)I
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->kD:Z
    ...
    :goto_2
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->lD:Z
    ...
    :goto_3
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->mD:Z
    ...
    :goto_4
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->nD:Z
    ...
    :goto_5
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->oD:Z

    iget v3, p0, Lcom/android/server/policy/kth;->iD:I

    const/4 v6, 0x6

    invoke-static {v3, v6}, Lcom/android/server/policy/kth;->bvj(II)I
    ...
    :goto_6
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->qD:Z

    iget v3, p0, Lcom/android/server/policy/kth;->iD:I

    invoke-static {v3, v2}, Lcom/android/server/policy/kth;->bvj(II)I
    ...
    :goto_7
    iput-boolean v3, p0, Lcom/android/server/policy/kth;->rD:Z

    iget-boolean v3, p0, Lcom/android/server/policy/kth;->oD:Z

    if-ne v3, v4, :cond_9

    iput-boolean v4, p0, Lcom/android/server/policy/kth;->nD:Z
    ...
    iget v5, p0, Lcom/android/server/policy/kth;->iD:I
    ...
    :cond_a
    iput-boolean v2, p0, Lcom/android/server/policy/kth;->zD:Z
...
.method private Yb(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/kth;->_b(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/policy/kth;->hD:Landroid/os/PowerManager$WakeLock;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/policy/kth;->gD:Landroid/os/PowerManager$WakeLock;
...
.method private _b(Ljava/lang/String;)Z
    .locals 2
...
.method static synthetic bio(Lcom/android/server/policy/kth;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/policy/kth;->vD:Z

    return p0
.end method

.method public static bvj(II)I
    .locals 1
...
.method private getCameraId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/policy/kth;->uD:Landroid/hardware/camera2/CameraManager;
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/server/policy/kth;->uD:Landroid/hardware/camera2/CameraManager;
...
.method static synthetic rtg(Lcom/android/server/policy/kth;)Lcom/android/server/policy/kth$zta;
    ...
    iget-object p0, p0, Lcom/android/server/policy/kth;->xD:Lcom/android/server/policy/kth$zta;
...
.method static synthetic sis(Lcom/android/server/policy/kth;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/policy/kth;->tD:Z
...
.method static synthetic tsu(Lcom/android/server/policy/kth;)V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/kth;->Qn()V
...
.method static synthetic you(Lcom/android/server/policy/kth;)V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/kth;->On()V
...
.method static synthetic you(Lcom/android/server/policy/kth;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/policy/kth;->vD:Z
...
.method private za(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/kth;->Aa(Z)V
...
.method static synthetic zta(Lcom/android/server/policy/kth;Lcom/android/server/policy/kth$zta;)Lcom/android/server/policy/kth$zta;
    ...
    iput-object p1, p0, Lcom/android/server/policy/kth;->xD:Lcom/android/server/policy/kth$zta;
...
.method static synthetic zta(Lcom/android/server/policy/kth;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/policy/kth;->tD:Z
...
.method private zta(Ljava/lang/String;Ljava/lang/String;IZ)Z
    ...
    iput-object v0, p0, Lcom/android/server/policy/kth;->sD:Landroid/content/pm/LauncherApps;

    iget-object v0, p0, Lcom/android/server/policy/kth;->sD:Landroid/content/pm/LauncherApps;
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/policy/kth;->sD:Landroid/content/pm/LauncherApps;
    ...
    iget-object v3, p0, Lcom/android/server/policy/kth;->sD:Landroid/content/pm/LauncherApps;
...
.method Hc()V
    ...
    iget-boolean v1, p0, Lcom/android/server/policy/kth;->CD:Z
    ...
    iget-object v1, p0, Lcom/android/server/policy/kth;->DD:Landroid/hardware/SensorEventListener;
...
.method public Ic()V
    ...
    iget-object v1, p0, Lcom/android/server/policy/kth;->FD:Landroid/hardware/camera2/CameraManager$TorchCallback;
...
.method public e(Z)Z
    ...
    iget-object v2, p0, Lcom/android/server/policy/kth;->uD:Landroid/hardware/camera2/CameraManager;
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/kth;->tD:Z
...
.method kth(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/policy/kth$zta;->M(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {v0, p2}, Lcom/android/server/policy/kth$zta;->N(Ljava/lang/String;)V
    ...
    :cond_3
    :goto_1
    iget-object p0, p0, Lcom/android/server/policy/kth;->eD:Ljava/util/HashMap;
...
.method public onKeyguardOccludedChangedLw(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/policy/kth;->BD:Z
...
.method onScreenTurnedOff()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/kth;->wD:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_1

    iget v0, p0, Lcom/android/server/policy/kth;->iD:I
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/kth;->CD:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lcom/android/server/policy/kth;->zD:Z
    ...
    iget-object v2, p0, Lcom/android/server/policy/kth;->DD:Landroid/hardware/SensorEventListener;
...
.method onStartedWakingUp()V
    ...
    iget-object p0, p0, Lcom/android/server/policy/kth;->DD:Landroid/hardware/SensorEventListener;
...
.method zta(Landroid/content/ContentResolver;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/kth;->rD:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/kth;->qD:Z
...
.method public zta(Landroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/policy/kth;->Pn()V
...
.method zta(Lcom/android/server/policy/kth$zta;Z)Z
    ...
    invoke-direct {p0, p2}, Lcom/android/server/policy/kth;->Ba(Z)Z
