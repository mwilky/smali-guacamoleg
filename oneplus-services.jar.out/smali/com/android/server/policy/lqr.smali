...
.method constructor <init>(Lcom/android/server/policy/OpQuickPay;I)V
    ...
    iput p2, p0, Lcom/android/server/policy/lqr;->VE:I
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v0, v8, Lcom/android/server/policy/lqr;->this$0:Lcom/android/server/policy/OpQuickPay;

    iget-object v0, v0, Lcom/android/server/policy/OpQuickPay;->mWindowParams:Landroid/view/WindowManager$LayoutParams;

    iget v1, v8, Lcom/android/server/policy/lqr;->RE:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawX()F

    move-result v2

    iget v3, v8, Lcom/android/server/policy/lqr;->TE:F
    ...
    iget v1, v8, Lcom/android/server/policy/lqr;->SE:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawY()F

    move-result v2

    iget v3, v8, Lcom/android/server/policy/lqr;->UE:F
    ...
    iget-object v1, v8, Lcom/android/server/policy/lqr;->this$0:Lcom/android/server/policy/OpQuickPay;
    ...
    iget v2, v8, Lcom/android/server/policy/lqr;->SE:I
    ...
    iget-object v2, v8, Lcom/android/server/policy/lqr;->this$0:Lcom/android/server/policy/OpQuickPay;
    ...
    iget v3, v2, Lcom/android/server/policy/OpQuickPay$zta;->index:I

    iget-object v4, v8, Lcom/android/server/policy/lqr;->this$0:Lcom/android/server/policy/OpQuickPay;
    ...
    :cond_5
    iget-object v2, v2, Lcom/android/server/policy/OpQuickPay$zta;->ZE:Ljava/lang/String;
    ...
    new-instance v6, Lcom/android/server/policy/ear;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/policy/ear;-><init>(Lcom/android/server/policy/lqr;Landroid/content/Context;II[Ljava/lang/String;ILjava/util/ArrayList;)V

    new-instance v0, Lcom/android/server/policy/ire;

    invoke-direct {v0, v8, v15}, Lcom/android/server/policy/ire;-><init>(Lcom/android/server/policy/lqr;Ljava/util/ArrayList;)V
    ...
    new-instance v1, Lcom/android/server/policy/hmo;

    invoke-direct {v1, v8}, Lcom/android/server/policy/hmo;-><init>(Lcom/android/server/policy/lqr;)V
    ...
    iget v0, v8, Lcom/android/server/policy/lqr;->VE:I
    ...
    iget v1, v8, Lcom/android/server/policy/lqr;->VE:I
    ...
    new-instance v2, Lcom/android/server/policy/fto;

    invoke-direct {v2, v8}, Lcom/android/server/policy/fto;-><init>(Lcom/android/server/policy/lqr;)V
    ...
    iput v1, v8, Lcom/android/server/policy/lqr;->RE:I

    iget v0, v0, Landroid/view/WindowManager$LayoutParams;->y:I

    iput v0, v8, Lcom/android/server/policy/lqr;->SE:I

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawX()F

    move-result v0

    iput v0, v8, Lcom/android/server/policy/lqr;->TE:F

    invoke-virtual/range {p2 .. p2}, Landroid/view/MotionEvent;->getRawY()F

    move-result v0

    iput v0, v8, Lcom/android/server/policy/lqr;->UE:F
