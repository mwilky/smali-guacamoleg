...
# static fields
.field static final AE:J = 0xbb8L

.field static final CAMERA_POWER_DOUBLE_TAP_MAX_TIME_MS:J = 0x12cL

.field private static final DE:J = 0x78L

.field private static final DEBUG_ONEPLUS:Z

.field private static final EE:I = 0x3

.field private static final GE:I = 0x5

.field static final JE:I = 0x0

.field static final KE:I = 0x1

.field static final LE:I = 0x2

.field static final ME:I = 0x3

.field private static final NE:Landroid/net/Uri;

.field private static final OE:I = 0x0
...
.field private static final vE:I = 0x9c4

.field static final wE:F = 2.5f

.field static final xE:I = 0xc9

.field static final yE:I = 0xca

.field static final zE:I = 0xcb


# instance fields
.field kE:Lcom/android/server/policy/PhoneWindowManager;
...
.field rE:Lcom/android/server/GestureLauncherService;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/policy/obl;->NE:Landroid/net/Uri;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/obl;->lE:Z

    iput-boolean v0, p0, Lcom/android/server/policy/obl;->mE:Z

    iput v0, p0, Lcom/android/server/policy/obl;->nE:I

    iput-boolean v0, p0, Lcom/android/server/policy/obl;->pE:Z

    iput v0, p0, Lcom/android/server/policy/obl;->tE:I

    iput v0, p0, Lcom/android/server/policy/obl;->uE:I

    return-void
.end method

.method private Rn()Landroid/content/ComponentName;
    .locals 5
    ...
    iget-object v2, p0, Lcom/android/server/policy/obl;->kE:Lcom/android/server/policy/PhoneWindowManager;
...
.method private Sn()Z
    ...
    sget-object v2, Lcom/android/server/policy/obl;->NE:Landroid/net/Uri;
...
.method private Tn()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/obl;->lE:Z
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/policy/obl;->nE:I
    ...
    :cond_2
    iput v3, p0, Lcom/android/server/policy/obl;->nE:I

    iget-object v0, p0, Lcom/android/server/policy/obl;->kE:Lcom/android/server/policy/PhoneWindowManager;

    iput-boolean v3, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyHandled:Z

    iget-boolean v4, p0, Lcom/android/server/policy/obl;->mE:Z
    ...
    :cond_3
    invoke-direct {p0}, Lcom/android/server/policy/obl;->Rn()Landroid/content/ComponentName;
    ...
    :goto_0
    iget v2, p0, Lcom/android/server/policy/obl;->oE:I
    ...
    :cond_7
    iput-boolean v3, p0, Lcom/android/server/policy/obl;->pE:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/policy/obl;->mE:Z
    ...
    :cond_c
    iget-boolean v0, p0, Lcom/android/server/policy/obl;->mE:Z
    ...
    sget-boolean v4, Lcom/android/server/policy/obl;->DEBUG_ONEPLUS:Z
    ...
    :cond_f
    :goto_4
    iput-boolean v1, p0, Lcom/android/server/policy/obl;->pE:Z

    iget-object p0, p0, Lcom/android/server/policy/obl;->kE:Lcom/android/server/policy/PhoneWindowManager;
...
.method static synthetic zta(Lcom/android/server/policy/obl;)V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/obl;->Tn()V
...
.method public synthetic Jc()V
    ...
    iget p0, p0, Lcom/android/server/policy/obl;->oE:I
...
.method public handleEmergency(Landroid/util/MutableBoolean;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/obl;->qE:Z
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/policy/obl;->tE:I
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/obl;->qE:Z
    ...
    :cond_5
    :goto_1
    iget p0, p0, Lcom/android/server/policy/obl;->tE:I
...
.method public init(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    iput-object p3, p0, Lcom/android/server/policy/obl;->kE:Lcom/android/server/policy/PhoneWindowManager;

    iget-object p1, p0, Lcom/android/server/policy/obl;->kE:Lcom/android/server/policy/PhoneWindowManager;
...
.method public initGestureLauncherService(Lcom/android/server/GestureLauncherService;)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/obl;->rE:Lcom/android/server/GestureLauncherService;
...
.method public interceptPowerKeyDown(Landroid/view/KeyEvent;)Z
    ...
    iput v2, p0, Lcom/android/server/policy/obl;->nE:I
    ...
    iput p1, p0, Lcom/android/server/policy/obl;->oE:I
...
.method public isDoubleTapPowerWalletHasNoActiveCard()Z
    ...
    iget v0, p0, Lcom/android/server/policy/obl;->uE:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    invoke-direct {p0}, Lcom/android/server/policy/obl;->Sn()Z
...
.method public onKeyguardDone()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/obl;->pE:Z
...
.method public processEmergencyTap(Landroid/view/KeyEvent;ZZ)Z
    ...
    iput-boolean v2, p0, Lcom/android/server/policy/obl;->qE:Z
    ...
    iget p3, p0, Lcom/android/server/policy/obl;->sE:I
    ...
    iput v5, p0, Lcom/android/server/policy/obl;->sE:I

    goto :goto_0

    :cond_2
    iput v2, p0, Lcom/android/server/policy/obl;->sE:I
    ...
    iget v0, p0, Lcom/android/server/policy/obl;->sE:I
    ...
    iput v2, p0, Lcom/android/server/policy/obl;->tE:I
    ...
    iput v9, p0, Lcom/android/server/policy/obl;->tE:I
    ...
    iput v5, p0, Lcom/android/server/policy/obl;->tE:I
    ...
    iget p1, p0, Lcom/android/server/policy/obl;->sE:I
...
.method public updateSettings(Landroid/content/ContentResolver;)V
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/policy/obl;->lE:Z

    invoke-direct {p0, p1}, Lcom/android/server/policy/obl;->you(Landroid/content/ContentResolver;)I

    move-result v1

    iput v1, p0, Lcom/android/server/policy/obl;->sE:I
    ...
    iput p1, p0, Lcom/android/server/policy/obl;->uE:I
