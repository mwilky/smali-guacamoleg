...
# static fields
.field private static final TAG:Ljava/lang/String; = "OnePlusExServiceRingtone"
...
.method private constructor <init>(Lcom/android/server/OnePlusExService;)V
    ...
    iput-object p1, p0, Lcom/android/server/OnePlusExService$zta;->this$0:Lcom/android/server/OnePlusExService;
...
.method synthetic constructor <init>(Lcom/android/server/OnePlusExService;Lcom/android/server/ssp;)V
    .locals 0
...
.method private cno(Landroid/content/Context;)V
    ...
    :try_start_1
    const-string v4, "updateVibratorSceneIds error: ContentProviderClient is invalid."
    ...
    invoke-direct {p0, v3}, Lcom/android/server/OnePlusExService$zta;->zta(Landroid/database/Cursor;)I
    ...
    :cond_2
    sget-boolean v6, Lcom/android/server/OnePlusExService;->debugOnePlus:Z
    ...
    const-string v7, "updateVibratorSceneIds("
    ...
    :cond_3
    const-string v4, "updateVibratorSceneIds: cursor is null"
    ...
    :goto_1
    :try_start_3
    const-string v5, "updateVibratorSceneIds failed: "
    ...
    sget-boolean p1, Lcom/android/server/OnePlusExService;->debugOnePlus:Z
    ...
    const-string v1, "updateVibratorSceneIds: Updated "
    ...
    const-string p0, " vibrator scene ids."
...
.method private zta(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, v0}, Lcom/android/server/OnePlusExService$zta;->zta(Landroid/database/Cursor;)I
...
.method private zta(Landroid/database/Cursor;)I
    .locals 9
...
.method static synthetic zta(Lcom/android/server/OnePlusExService$zta;Landroid/content/Context;Landroid/net/Uri;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/OnePlusExService$zta;->getVibratorSceneId(Landroid/content/Context;Landroid/net/Uri;)I
