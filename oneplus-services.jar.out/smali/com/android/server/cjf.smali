...
.field private final mConfigHandler:Lcom/android/server/cjf$you;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/cjf;->DEBUG_ONEPLUS:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/cjf$you;-><init>(Lcom/android/server/cjf;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/cjf;->mConfigHandler:Lcom/android/server/cjf$you;
...
.method static synthetic you(Lcom/android/server/cjf;)Lcom/android/server/cjf$zta;
    .locals 0

    iget-object p0, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;
...
.method static synthetic zta(Lcom/android/server/cjf;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/cjf;->mContext:Landroid/content/Context;
...
.method private zta(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/cjf;->gwm(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-virtual {p0, p2, p3}, Lcom/android/server/cjf;->rtg(J)J
    ...
    invoke-direct {p0}, Lcom/android/server/cjf;->getTimeDelta()J
    ...
    sget-boolean p2, Lcom/android/server/cjf;->DEBUG_ONEPLUS:Z
...
.method public gck(Z)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/cjf$zta;->bio(Z)Z
...
.method public gwm(Ljava/lang/String;)Z
    ...
    :cond_0
    sget-boolean p0, Lcom/android/server/cjf;->DEBUG_ONEPLUS:Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/cjf;->ugm(Ljava/lang/String;)Z
...
.method public initAlarmAlignment(II)V
    ...
    iget-object p1, p0, Lcom/android/server/cjf;->mContext:Landroid/content/Context;
    ...
    :goto_0
    iget-object p1, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;

    invoke-virtual {p1, v0}, Lcom/android/server/cjf$zta;->bio(Z)Z

    iget-object p1, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;

    invoke-virtual {p1}, Lcom/android/server/cjf$zta;->G()V

    iget-object p1, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;

    invoke-virtual {p1}, Lcom/android/server/cjf$zta;->registerOnlineConfig()V

    iget-object p0, p0, Lcom/android/server/cjf;->mConfigHandler:Lcom/android/server/cjf$you;
...
.method public initInstance(Lcom/android/server/AlarmManagerService$AmsInner;Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/android/server/cjf$zta;
    ...
    iget-object v1, p0, Lcom/android/server/cjf;->mConfigHandler:Lcom/android/server/cjf$you;

    invoke-direct {p1, p0, p2, v0, v1}, Lcom/android/server/cjf$zta;-><init>(Lcom/android/server/cjf;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;
...
.method public setAlarmAlignment(Lcom/android/server/AlarmManagerService$Alarm;Lcom/android/server/AlarmManagerService$AlarmAlignmentReason;JJ)Z
    ...
    iget-object v0, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/cjf;->zta(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    :cond_7
    iget-object p2, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;

    invoke-virtual {p2, p1, v1}, Lcom/android/server/cjf$zta;->zta(Lcom/android/server/AlarmManagerService$Alarm;Z)J
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/cjf$zta;->zta(Lcom/android/server/AlarmManagerService$Alarm;Z)J
...
.method public setBlockAlarmUid(Ljava/lang/String;ZI)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/cjf;->you(Ljava/lang/String;ZI)V
...
.method public shellCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v2, Lcom/android/server/cjf;->DEBUG_ONEPLUS:Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/cjf$zta;->sis(J)V
    :try_end_0
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/cjf$zta;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/cjf$zta;->wtn(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/cjf$zta;->wtn(Z)V
...
.method public ywr(Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/cjf$zta;->igw(Z)Z

    iget-object p1, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;

    invoke-virtual {p1, v0}, Lcom/android/server/cjf$zta;->kth(Z)Z
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/cjf$zta;->igw(Z)Z

    iget-object p1, p0, Lcom/android/server/cjf;->mAlignment:Lcom/android/server/cjf$zta;

    invoke-virtual {p1, v2}, Lcom/android/server/cjf$zta;->kth(Z)Z
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Lcom/android/server/cjf$zta;->tsu(J)J
...
.method public zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/cjf$zta;->zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
