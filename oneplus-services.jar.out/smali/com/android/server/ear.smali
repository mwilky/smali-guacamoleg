...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/ear$sis;,
        Lcom/android/server/ear$you;
    }
.end annotation
...
.field private static final TAG:Ljava/lang/String; = "OpAlarmManager"

.field private static final fe:I = 0x0
...
.field static je:Ljava/util/List;
...
.field private static mAms:Lcom/android/server/AlarmManagerService;
...
.field private _d:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private ee:Lcom/oneplus/config/ConfigObserver;

.field final mConfigHandler:Lcom/android/server/ear$zta;

.field private mContext:Landroid/content/Context;

.field private mEnableLogDump:Z

.field mOpAlarmAlignment:Lcom/android/server/cjf;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/ear;->mIsDeepSleep:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/ear;->je:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/ear;->mEnableLogDump:Z

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/ear;->Wd:[I

    new-instance v1, Lcom/android/server/ear$zta;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/ear$zta;-><init>(Lcom/android/server/ear;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/ear;->mConfigHandler:Lcom/android/server/ear$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/ear;->Zd:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/ear;->_d:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/ear;->ae:Ljava/util/List;

    iput-boolean v0, p0, Lcom/android/server/ear;->be:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->ce:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->de:Ljava/util/List;
...
.method private kth(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/android/server/ear;->Zd:Ljava/util/HashMap;
    ...
    new-instance v3, Lcom/android/server/ear$you;

    invoke-direct {v3, v2, v1, v0}, Lcom/android/server/ear$you;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/ear;->Zd:Ljava/util/HashMap;
...
.method private zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    .locals 1

    if-eqz p2, :cond_2

    iget-object p0, p0, Lcom/android/server/ear;->Zd:Ljava/util/HashMap;
    ...
    check-cast p3, Lcom/android/server/ear$you;

    if-eqz p3, :cond_1

    iget-object v0, p3, Lcom/android/server/ear$you;->Vd:Ljava/lang/String;
    ...
    sget-boolean p0, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/ear$you;->Ud:J
...
.method static synthetic zta(Lcom/android/server/ear;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/ear;->mContext:Landroid/content/Context;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/ear;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/ear;->zta(Lorg/json/JSONArray;)V

    return-void
.end method

.method private zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-boolean v3, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z
...
.method private zta(Lorg/json/JSONArray;)V
    .locals 11
    ...
    iget-object p0, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/ear;->je:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/ear;->je:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/ear;->je:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/ear;->ae:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/ear;->ae:Ljava/util/List;
    ...
    sget-boolean v8, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/ear;->ae:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/ear;->_d:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/ear;->ae:Ljava/util/List;

    invoke-direct {p0, v4, v7, v0}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, Lcom/android/server/ear;->de:Ljava/util/List;
    ...
    :try_start_7
    iget-object v6, p0, Lcom/android/server/ear;->de:Ljava/util/List;
    ...
    sget-boolean v7, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z

    if-eqz v7, :cond_8

    const-string v7, "OpAlarmManager"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "DropPkgNetworkAlarm: "
    ...
    :cond_8
    iget-object v7, p0, Lcom/android/server/ear;->de:Ljava/util/List;
    ...
    :cond_9
    iget-object v3, p0, Lcom/android/server/ear;->ce:Ljava/util/HashMap;

    iget-object v6, p0, Lcom/android/server/ear;->de:Ljava/util/List;

    invoke-direct {p0, v3, v6, v5}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/ear;->je:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/android/server/ear;->kth(Ljava/util/List;)V
    :try_end_8
...
.method private zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/ear;->Gd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/ear;->Gd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, Lcom/android/server/ear;->mOpAlarmAlignment:Lcom/android/server/cjf;
    ...
    check-cast v4, Lcom/android/server/cjf;

    iput-object v4, v0, Lcom/android/server/ear;->mOpAlarmAlignment:Lcom/android/server/cjf;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/cjf;->gwm(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/ear;->clampPositive(J)J
    ...
    iget-object v5, v0, Lcom/android/server/ear;->Gd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :goto_9
    sget-boolean v5, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z
    ...
    const-string v14, "reAddAlarmLocked a.when  = "
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z
    ...
    sget-object v5, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    iget-object v0, p0, Lcom/android/server/ear;->_d:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {p0, v0, p1, v1, p2}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/ear;->be:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/ear;->ce:Ljava/util/HashMap;

    invoke-direct {p0, v0, p1, v2, p2}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public ifEnableLogDump()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/ear;->mEnableLogDump:Z
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean p2, Lcom/android/server/ear;->DEBUG_ONEPLUS:Z

    if-ne p2, v2, :cond_2

    iget-object p2, p0, Lcom/android/server/ear;->_d:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v1}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/ear;->ce:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v2}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    ...
    const-string p2, "Unknown argument: "

    invoke-virtual {p0, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p0, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p2, "; use -h for help"
    ...
    invoke-virtual {p0, p1, p2, v2}, Lcom/android/server/ear;->zta(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, Lcom/android/server/ear;->mIsDeepSleep:Z
    ...
    iget-object v0, p0, Lcom/android/server/ear;->mOpAlarmAlignment:Lcom/android/server/cjf;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->mOpAlarmAlignment:Lcom/android/server/cjf;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/cjf;->zta(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ear;->vdb(Ljava/lang/String;)Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, Lcom/android/server/ear;->mAms:Lcom/android/server/AlarmManagerService;

    iput-object p2, p0, Lcom/android/server/ear;->mContext:Landroid/content/Context;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, Lcom/android/server/ear;->zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/ear;->Gd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/ear;->be:Z
    ...
    iget-object v2, p0, Lcom/android/server/ear;->ce:Ljava/util/HashMap;

    invoke-direct {p0, v2, v0, p1}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Ljava/util/List;Z)V

    :cond_3
    new-instance p1, Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/android/server/ear;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/ear;->Yd:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/ear;->mConfigHandler:Lcom/android/server/ear$zta;

    new-instance v2, Lcom/android/server/ear$sis;

    invoke-direct {v2, p0}, Lcom/android/server/ear$sis;-><init>(Lcom/android/server/ear;)V
    ...
    iput-object p1, p0, Lcom/android/server/ear;->ee:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, Lcom/android/server/ear;->ee:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;

    sget-object p1, Lcom/android/server/ear;->je:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->mConfigHandler:Lcom/android/server/ear$zta;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/ear;->mIsDeepSleep:Z
...
.method public setDeepSleepWhitelist([I)V
    ...
    iput-object p1, p0, Lcom/android/server/ear;->Wd:[I
...
.method public setPkgNetworkAlarmRestriction(Z)V
    ...
    const-string v3, "Update mIsDropPkgNetAlarmEnabled to "
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/ear;->be:Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;)I
    .locals 0
    ...
    iget-object p0, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
...
.method public vdb(Ljava/lang/String;)Z
    .locals 3

    sget-object p0, Lcom/android/server/ear;->je:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/ear;->je:Ljava/util/List;
...
.method protected zta(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    .locals 4
    ...
    iput-boolean p1, p0, Lcom/android/server/ear;->mEnableLogDump:Z

    if-eqz v0, :cond_3

    :goto_0
    invoke-virtual {v0, p1}, Lcom/android/server/cjf;->dma(Z)Z
