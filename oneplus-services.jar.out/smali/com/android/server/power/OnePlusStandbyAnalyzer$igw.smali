...
.method public constructor <init>(Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;I)V
    ...
    iput-wide v1, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->iG:J

    iput-boolean v0, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->jG:Z

    iput-object p1, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->mType:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;

    iput p2, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->mStart:I

    sget-object p2, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;->Qka:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;

    if-eq p1, p2, :cond_0

    sget-object p2, Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;->Rka:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;
    ...
    iput-boolean p1, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->jG:Z
...
.method public constructor <init>(Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide p2, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->iG:J
...
.method public Pc()Z
    ...
    sget-object v0, Lcom/android/server/power/kth;->NF:[I

    iget-object v1, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->mType:Lcom/android/server/power/OnePlusStandbyAnalyzer$RPM_MODE_TYPE;
    ...
    :cond_0
    iget-wide v0, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->iG:J

    invoke-static {}, Lcom/android/server/power/OnePlusStandbyAnalyzer;->Jb()J
...
.method public Rc()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->jG:Z
...
.method public igw(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide p1, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->iG:J
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v2, p0, Lcom/android/server/power/OnePlusStandbyAnalyzer$igw;->iG:J
