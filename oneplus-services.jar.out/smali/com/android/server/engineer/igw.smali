.class Lcom/android/server/engineer/igw;
...
.method constructor <init>(Lcom/android/server/engineer/OneplusEngineerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/engineer/igw;->this$0:Lcom/android/server/engineer/OneplusEngineerService;
...
.method public run()V
    ...
    const-string v3, "getSerialNoFromNvram serialFromNv="
    ...
    invoke-static {v0, p0, v2}, Lcom/android/server/engineer/rtg;->zta(I[BI)Z
    ...
    const-string v2, "update serial to nvram "
    ...
    :try_start_0
    const-string p0, "oem.eng.factory.no"
    ...
    const-string v2, "set factory number caught exception : "
    ...
    :cond_5
    const-string p0, "OEM_PRODUCT_INFO empty"
