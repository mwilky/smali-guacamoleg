.class Lcom/android/server/OpVibratorService$zta;
...
.method private constructor <init>(Lcom/android/server/OpVibratorService;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;
...
.method synthetic constructor <init>(Lcom/android/server/OpVibratorService;Lcom/android/server/j;)V
    .locals 0
...
.method public resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    iget-object v9, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;
    ...
    iget-object v13, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;
    ...
    iget-object v11, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;
    ...
    iget-object v12, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;
    ...
    new-instance v13, Lcom/android/server/OpVibratorService$you;

    iget-object v14, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;

    iget-object v15, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;

    invoke-static {v15}, Lcom/android/server/OpVibratorService;->access$500(Lcom/android/server/OpVibratorService;)I

    move-result v15

    iget-object v6, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;

    invoke-static {v6}, Lcom/android/server/OpVibratorService;->access$600(Lcom/android/server/OpVibratorService;)I

    move-result v6

    iget-object v1, v0, Lcom/android/server/OpVibratorService$zta;->this$0:Lcom/android/server/OpVibratorService;

    invoke-static {v1}, Lcom/android/server/OpVibratorService;->access$700(Lcom/android/server/OpVibratorService;)I

    move-result v1

    invoke-direct {v13, v14, v15, v6, v1}, Lcom/android/server/OpVibratorService$you;-><init>(Lcom/android/server/OpVibratorService;III)V
...
.method public updateConfig(Lorg/json/JSONArray;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/OpVibratorService$zta;->resolveConfigFromJSON(Lorg/json/JSONArray;)V
