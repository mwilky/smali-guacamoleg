.class public Lcom/android/server/OpPowerControllerService$rtg;
...
# static fields
.field private static final vf:Ljava/lang/String; = "idle-records.xml"
...
.field private sf:Ljava/time/LocalTime;

.field private tf:Ljava/time/Duration;

.field final synthetic this$0:Lcom/android/server/OpPowerControllerService;

.field private uf:Ljava/time/LocalDateTime;
...
.method public constructor <init>(Lcom/android/server/OpPowerControllerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->mFile:Landroid/util/AtomicFile;

    return-void
.end method

.method private you(Lorg/xmlpull/v1/XmlPullParser;)V
    .locals 18
    ...
    invoke-virtual {v12, v11}, Lcom/android/server/OpPowerControllerService$rtg;->sis(Ljava/time/LocalDateTime;)V
    :try_end_2
    ...
    invoke-virtual {v5, v11}, Lcom/android/server/OpPowerControllerService$rtg;->sis(Ljava/time/LocalDateTime;)V
    ...
    new-instance v8, Lcom/android/server/OpPowerControllerService$tsu;

    iget-object v9, v1, Lcom/android/server/OpPowerControllerService$rtg;->this$0:Lcom/android/server/OpPowerControllerService;

    invoke-direct {v8, v9}, Lcom/android/server/OpPowerControllerService$tsu;-><init>(Lcom/android/server/OpPowerControllerService;)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/OpPowerControllerService$tsu;->you(Ljava/time/LocalDateTime;)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/OpPowerControllerService$tsu;->zta(Ljava/time/LocalDateTime;)V
    ...
    :cond_9
    invoke-virtual {v8}, Lcom/android/server/OpPowerControllerService$tsu;->J()Ljava/time/LocalDateTime;

    move-result-object v9

    if-eqz v9, :cond_a

    invoke-virtual {v8}, Lcom/android/server/OpPowerControllerService$tsu;->I()Ljava/time/LocalDateTime;

    move-result-object v9

    if-eqz v9, :cond_a

    invoke-virtual {v8}, Lcom/android/server/OpPowerControllerService$tsu;->getDuration()Ljava/time/Duration;

    move-result-object v9

    if-eqz v9, :cond_a

    iget-object v9, v1, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11, v9}, Lcom/android/server/OpPowerControllerService$rtg;->zta(Ljava/time/LocalTime;)V
    :try_end_5
    ...
    invoke-virtual {v11, v8}, Lcom/android/server/OpPowerControllerService$rtg;->zta(Ljava/time/LocalTime;)V
    ...
    invoke-virtual {v11, v8}, Lcom/android/server/OpPowerControllerService$rtg;->you(Ljava/time/Duration;)V
    ...
    invoke-virtual {v9, v8}, Lcom/android/server/OpPowerControllerService$rtg;->you(Ljava/time/Duration;)V
    :try_end_7
    ...
    invoke-virtual {v8, v10}, Lcom/android/server/OpPowerControllerService$rtg;->you(Ljava/time/Duration;)V
...
.method private zta(Lorg/xmlpull/v1/XmlSerializer;)V
    .locals 7
    ...
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    check-cast v3, Lcom/android/server/OpPowerControllerService$tsu;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$tsu;->J()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$tsu;->I()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v3}, Lcom/android/server/OpPowerControllerService$tsu;->getDuration()Ljava/time/Duration;
    ...
    invoke-virtual {p0}, Lcom/android/server/OpPowerControllerService$rtg;->L()Ljava/time/Duration;
...
.method public K()[[D
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lcom/android/server/OpPowerControllerService$tsu;->J()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v5}, Lcom/android/server/OpPowerControllerService$tsu;->getDuration()Ljava/time/Duration;
...
.method public L()Ljava/time/Duration;
    ...
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->tf:Ljava/time/Duration;

    return-object p0
.end method

.method public M()Ljava/time/LocalTime;
    .locals 0

    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->sf:Ljava/time/LocalTime;

    return-object p0
.end method

.method public N()Ljava/time/LocalDateTime;
    .locals 0

    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->uf:Ljava/time/LocalDateTime;

    return-object p0
.end method

.method public O()Ljava/time/LocalDateTime;
    .locals 2
...
.method public P()Ljava/time/LocalDateTime;
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->sf:Ljava/time/LocalTime;
...
.method public Q()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/OpPowerControllerService$rtg;->sis(Ljava/time/LocalDateTime;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/OpPowerControllerService$rtg;->zta(Lorg/xmlpull/v1/XmlSerializer;)V
...
.method public R()V
    ...
    iput-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->sf:Ljava/time/LocalTime;

    iput-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->tf:Ljava/time/Duration;

    iput-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->uf:Ljava/time/LocalDateTime;
...
.method public S()V
    ...
    :try_start_1
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->mFile:Landroid/util/AtomicFile;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/OpPowerControllerService$rtg;->you(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_2
    ...
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService$rtg;->mFile:Landroid/util/AtomicFile;
    ...
    :try_start_6
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/android/server/OpPowerControllerService$tsu;
    ...
    invoke-virtual {v1}, Lcom/android/server/OpPowerControllerService$tsu;->toString()Ljava/lang/String;
...
.method public sis(Ljava/time/LocalDateTime;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->uf:Ljava/time/LocalDateTime;
...
.method public you(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/OpPowerControllerService$tsu;->dump(Ljava/io/PrintWriter;)V
...
.method you(Ljava/time/Duration;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->tf:Ljava/time/Duration;
...
.method public zta(Ljava/time/LocalDateTime;Ljava/time/LocalDateTime;)V
    ...
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService$rtg;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lcom/android/server/OpPowerControllerService$rtg;->rf:Ljava/util/ArrayList;
...
.method zta(Ljava/time/LocalTime;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->sf:Ljava/time/LocalTime;
