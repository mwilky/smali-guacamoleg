...
.method public refreshStats(ILandroid/util/SparseArray;JJ)V
    ...
    iput-wide v12, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mMaxPower:D

    iput-wide v12, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mMaxRealPower:D

    iput-wide v12, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mComputedPower:D

    iput-wide v12, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mTotalPower:D
    ...
    new-instance v14, Lcom/android/internal/os/SensorPowerCalculator;
    ...
    iput-object v14, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mSensorPowerCalculator:Lcom/android/internal/os/PowerCalculator;

    iget-object v1, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mSensorPowerCalculator:Lcom/android/internal/os/PowerCalculator;
    ...
    iput v1, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mStatsType:I

    iput-wide v10, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mRawUptimeUs:J

    iput-wide v8, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mRawRealtimeUs:J

    iget-object v1, v0, Lcom/android/internal/os/MyBatteryStatsHelper;->mStats:Landroid/os/BatteryStats;

    invoke-virtual {v1, v10, v11}, Landroid/os/BatteryStats;->getBatteryUptime(J)J
    ...
    invoke-virtual {v1, v8, v9}, Landroid/os/BatteryStats;->getBatteryRealtime(J)J
    ...
    invoke-virtual {v1, v10, v11, v2}, Landroid/os/BatteryStats;->computeBatteryUptime(JI)J
    ...
    invoke-virtual {v1, v8, v9, v2}, Landroid/os/BatteryStats;->computeBatteryRealtime(JI)J
    ...
    invoke-virtual {v1, v8, v9}, Landroid/os/BatteryStats;->computeBatteryTimeRemaining(J)J
    ...
    invoke-virtual {v1, v8, v9}, Landroid/os/BatteryStats;->computeChargeTimeRemaining(J)J
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/os/MyBatteryStatsHelper;->processAppUsage(Landroid/util/SparseArray;)V
    ...
    new-instance v3, Lcom/android/internal/os/zta;

    invoke-direct {v3, p0}, Lcom/android/internal/os/zta;-><init>(Lcom/android/internal/os/MyBatteryStatsHelper;)V

    invoke-static {v2, v3}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    invoke-direct {p0}, Lcom/android/internal/os/MyBatteryStatsHelper;->processMiscUsage()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/os/MyBatteryStatsHelper;->removeHiddenBatterySippers(Ljava/util/List;)D
