...
.field mBluetoothServiceTrack:Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    :cond_2
    new-instance v6, Lcom/android/server/BluetoothAirplaneModeListener;

    invoke-static {}, Lcom/android/server/IoThread;->get()Lcom/android/server/IoThread;

    move-result-object v7

    invoke-virtual {v7}, Lcom/android/server/IoThread;->getLooper()Landroid/os/Looper;

    move-result-object v7

    invoke-direct {v6, p0, v7, p1}, Lcom/android/server/BluetoothAirplaneModeListener;-><init>(Lcom/android/server/BluetoothManagerService;Landroid/os/Looper;Landroid/content/Context;)V

    iput-object v6, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothAirplaneModeListener:Lcom/android/server/BluetoothAirplaneModeListener;
    ...
    new-instance v0, Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;

    invoke-direct {v0}, Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;-><init>()V

    iput-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothServiceTrack:Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;

    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothServiceTrack:Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;

    if-eqz v0, :cond_5

    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;->setContext(Landroid/content/Context;)V
...
.method static synthetic access$2600(Lcom/android/server/BluetoothManagerService;)Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;
    .locals 1
...
.method static synthetic access$2800(Lcom/android/server/BluetoothManagerService;Z)V
    .locals 0
...
.method static synthetic access$3400(Lcom/android/server/BluetoothManagerService;)Ljava/util/Map;
    .locals 1
...
.method static synthetic access$3602(Lcom/android/server/BluetoothManagerService;Landroid/bluetooth/IBluetoothGatt;)Landroid/bluetooth/IBluetoothGatt;
    .locals 0
...
.method static synthetic access$3802(Lcom/android/server/BluetoothManagerService;Landroid/os/IBinder;)Landroid/os/IBinder;
    .locals 0
...
.method static synthetic access$3900(Lcom/android/server/BluetoothManagerService;)Z
    .locals 1
...
.method static synthetic access$4200(Lcom/android/server/BluetoothManagerService;)I
    .locals 1
...
.method static synthetic access$4202(Lcom/android/server/BluetoothManagerService;I)I
    .locals 0
...
.method static synthetic access$4300(Lcom/android/server/BluetoothManagerService;II)V
    .locals 0
...
.method static synthetic access$4802(Lcom/android/server/BluetoothManagerService;Z)Z
    .locals 0
...
.method private addActiveLog(ILjava/lang/String;Z)V
    ...
    const-string v1, "[CW] addActiveLog, reason: "
    ...
    invoke-direct {p0, p3, p1, p2}, Lcom/android/server/BluetoothManagerService;->sendChangeBluetoothServiceInfo(ZILjava/lang/String;)V
...
.method private sendChangeBluetoothServiceInfo(ZILjava/lang/String;)V
    .locals 3
    ...
    const-string v1, "[CW] Bluetooth Manager Service, enable: "
    ...
    invoke-static {p1, p2, p3}, Lcom/oneplus/android/server/OpBluetoothServiceTrackInjector;->sendChangeBluetoothServiceInfo(ZILjava/lang/String;)Z

    goto :goto_0

    :cond_0
    const-string/jumbo v0, "sendChangeBluetoothServiceInfo mBluetoothServiceTrack object is null"
    ...
    const-string/jumbo v2, "sendChangeBluetoothServiceInfo: NPE"
...
.method private unbindAllBluetoothProfileServices()V
    ...
    :goto_1
    invoke-static {v3}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2300(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;)V
...
.method public handleOnBootPhase()V
    ...
    new-instance v3, Lcom/android/server/BluetoothAirplaneModeListener$AirplaneModeHelper;

    iget-object v4, p0, Lcom/android/server/BluetoothManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/android/server/BluetoothAirplaneModeListener$AirplaneModeHelper;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, v3}, Lcom/android/server/BluetoothAirplaneModeListener;->start(Lcom/android/server/BluetoothAirplaneModeListener$AirplaneModeHelper;)V
...
.method public unbindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)V
    ...
    invoke-static {v2, p2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2100(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;Landroid/bluetooth/IBluetoothProfileServiceConnection;)V
