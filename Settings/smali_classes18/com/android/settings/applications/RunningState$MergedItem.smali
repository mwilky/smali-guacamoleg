...
.method updateSize(Landroid/content/Context;)Z
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$MergedItem;->mChildren:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p1}, Lcom/android/settings/applications/RunningState$MergedItem;->updateSize(Landroid/content/Context;)Z

    iget-wide v2, p0, Lcom/android/settings/applications/RunningState$MergedItem;->mSize:J

    iget-wide v4, v1, Lcom/android/settings/applications/RunningState$MergedItem;->mSize:J
    ...
    :goto_1
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$MergedItem;->mOtherProcesses:Ljava/util/ArrayList;
    ...
    iget-wide v1, p0, Lcom/android/settings/applications/RunningState$MergedItem;->mSize:J
    ...
    iput-wide v1, p0, Lcom/android/settings/applications/RunningState$MergedItem;->mSize:J
    ...
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$MergedItem;->mSizeStr:Ljava/lang/String;
