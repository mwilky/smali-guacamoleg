...
.method public doCreate()V
    ...
    invoke-static {v2}, Lcom/android/settings/Utils;->getColorAccent(Landroid/content/Context;)Landroid/content/res/ColorStateList;
...
.method refreshUi(Z)V
    ...
    iget-object v3, v1, Lcom/android/settings/applications/RunningProcessesView;->mAdapter:Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;
    ...
    const v4, 0x7f12126f    # 1.94163E38f
    ...
    iget-wide v7, v0, Lcom/android/settings/applications/RunningState;->mBackgroundProcessMemory:J
    ...
    iget-wide v7, v0, Lcom/android/settings/applications/RunningState;->mServiceProcessMemory:J
    ...
    iget-wide v11, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurTotalRam:J

    cmp-long v0, v11, v3

    if-nez v0, :cond_5

    iget-wide v11, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurHighRam:J

    cmp-long v0, v11, v9

    if-nez v0, :cond_5

    iget-wide v11, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurMedRam:J

    cmp-long v0, v11, v7

    if-nez v0, :cond_5

    iget-wide v11, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurLowRam:J
    ...
    :cond_5
    iput-wide v3, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurTotalRam:J

    iput-wide v9, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurHighRam:J

    iput-wide v7, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurMedRam:J

    iput-wide v5, v1, Lcom/android/settings/applications/RunningProcessesView;->mCurLowRam:J
    ...
    invoke-static {v11, v5, v6}, Landroid/text/format/Formatter;->formatShortFileSize(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v0, v11}, Landroid/text/BidiFormatter;->unicodeWrap(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    iget-object v12, v1, Lcom/android/settings/applications/RunningProcessesView;->mBackgroundProcessText:Landroid/widget/TextView;
    ...
    invoke-static {v12, v7, v8}, Landroid/text/format/Formatter;->formatShortFileSize(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {v12, v9, v10}, Landroid/text/format/Formatter;->formatShortFileSize(Landroid/content/Context;J)Ljava/lang/String;
