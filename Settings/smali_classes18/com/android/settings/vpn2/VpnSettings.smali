...
.method static varargs loadVpnProfiles(Landroid/security/KeyStore;[I)Ljava/util/List;
    ...
    iget v7, v6, Lcom/android/internal/net/VpnProfile;->type:I
...
.method public findOrCreatePreference(Lcom/android/settings/vpn2/AppVpnInfo;)Lcom/android/settings/vpn2/AppPreference;
    ...
    invoke-virtual {v0, p0}, Lcom/android/settings/vpn2/AppPreference;->setOnPreferenceClickListener(Landroidx/preference/Preference$OnPreferenceClickListener;)V
...
.method public onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    iget-object v7, p0, Lcom/android/settings/vpn2/VpnSettings;->mConnectedLegacyVpn:Lcom/android/internal/net/LegacyVpnInfo;

    iget-object v7, v7, Lcom/android/internal/net/LegacyVpnInfo;->key:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, v5, v3, v4}, Lcom/android/settings/vpn2/ConfigDialogFragment;->show(Lcom/android/settings/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;ZZ)V
    ...
    invoke-virtual {v6, v7, v3, v5}, Landroidx/fragment/app/FragmentActivity;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-virtual {v6, v8, v5}, Landroid/content/Context;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_1
    ...
    invoke-static {p0, v1, v5, v3, v2}, Lcom/android/settings/vpn2/AppDialogFragment;->show(Landroidx/fragment/app/Fragment;Landroid/content/pm/PackageInfo;Ljava/lang/String;ZZ)V
