...
.method private onRegionZonePreferenceClicked()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->use(Ljava/lang/Class;)Lcom/android/settingslib/core/AbstractPreferenceController;
...
.method private onTimeZoneDataReady(Lcom/android/settings/datetime/timezone/model/TimeZoneData;)V
    ...
    iput-object v0, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mPendingZonePickerRequestResult:Landroid/content/Intent;
...
.method private onZonePickerRequestResult(Lcom/android/settings/datetime/timezone/model/TimeZoneData;Landroid/content/Intent;)V
    ...
    :cond_1
    iput-object v1, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mSelectedTimeZoneId:Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setDisplayedTimeZoneInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mSelectedTimeZoneId:Ljava/lang/String;

    invoke-direct {p0, v0, v3}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->saveTimeZone(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v3, 0x1

    invoke-direct {p0, v3}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setSelectByRegion(Z)V
    ...
    const-string v4, "Unknown time zone id is selected: "
    ...
    const-string v4, "TimeZoneSettings"
...
.method private setSelectByRegion(Z)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setPreferenceCategoryVisible(Landroidx/preference/PreferenceCategory;Z)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    :cond_3
    invoke-direct {p0, v0, p3}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->onZonePickerRequestResult(Lcom/android/settings/datetime/timezone/model/TimeZoneData;Landroid/content/Intent;)V
