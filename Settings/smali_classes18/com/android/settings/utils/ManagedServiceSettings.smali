...
.method private updateList(Ljava/util/List;)V
    ...
    invoke-virtual {v4, v9}, Landroid/content/pm/ServiceInfo;->loadLabel(Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;
    ...
    new-instance v10, Lcom/android/settings/widget/AppSwitchPreference;

    invoke-virtual {p0}, Lcom/android/settings/utils/ManagedServiceSettings;->getPrefContext()Landroid/content/Context;

    move-result-object v11

    invoke-direct {v10, v11}, Lcom/android/settings/widget/AppSwitchPreference;-><init>(Landroid/content/Context;)V

    invoke-virtual {v10, v7}, Landroidx/preference/SwitchPreference;->setPersistent(Z)V
    ...
    invoke-virtual {v7, v4, v11, v12}, Landroid/util/IconDrawableFactory;->getBadgedIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    invoke-virtual {v10, v7}, Landroidx/preference/SwitchPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v10, v6}, Landroidx/preference/SwitchPreference;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {v10, v9}, Landroidx/preference/SwitchPreference;->setSummary(Ljava/lang/CharSequence;)V

    goto :goto_2

    :cond_0
    invoke-virtual {v10, v9}, Landroidx/preference/SwitchPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v10, v7}, Landroidx/preference/SwitchPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v11, v1}, Landroid/app/admin/DevicePolicyManager;->isNotificationListenerServicePermitted(Ljava/lang/String;I)Z
    ...
    :cond_1
    new-instance v7, Lcom/android/settings/utils/-$$Lambda$ManagedServiceSettings$htEfLAWO5EB6B7OCF1boY-AK3Vk;

    invoke-direct {v7, p0, v8, v5}, Lcom/android/settings/utils/-$$Lambda$ManagedServiceSettings$htEfLAWO5EB6B7OCF1boY-AK3Vk;-><init>(Lcom/android/settings/utils/ManagedServiceSettings;Ljava/lang/CharSequence;Landroid/content/ComponentName;)V

    invoke-virtual {v10, v7}, Landroidx/preference/SwitchPreference;->setOnPreferenceChangeListener(Landroidx/preference/Preference$OnPreferenceChangeListener;)V
...
.method public synthetic lambda$updateList$0$ManagedServiceSettings(Ljava/lang/CharSequence;Landroid/content/ComponentName;Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p2, v1, v0}, Lcom/android/settings/utils/ManagedServiceSettings;->setEnabled(Landroid/content/ComponentName;Ljava/lang/String;Z)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/utils/ManagedServiceSettings;->setPreferenceScreen(Landroidx/preference/PreferenceScreen;)V
