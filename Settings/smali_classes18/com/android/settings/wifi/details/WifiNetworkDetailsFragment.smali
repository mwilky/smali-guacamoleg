...
.method protected createPreferenceControllers(Landroid/content/Context;)Ljava/util/List;
    ...
    new-instance v2, Lcom/android/settings/wifi/details/AddDevicePreferenceController;

    invoke-direct {v2, p1}, Lcom/android/settings/wifi/details/AddDevicePreferenceController;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings/wifi/details/AddDevicePreferenceController;->init(Lcom/android/settingslib/wifi/AccessPoint;)Lcom/android/settings/wifi/details/AddDevicePreferenceController;
    ...
    new-instance v3, Lcom/android/settings/wifi/details/WifiPrivacyPreferenceController;

    invoke-direct {v3, p1}, Lcom/android/settings/wifi/details/WifiPrivacyPreferenceController;-><init>(Landroid/content/Context;)V

    iget-object v4, p0, Lcom/android/settings/wifi/details/WifiNetworkDetailsFragment;->mAccessPoint:Lcom/android/settingslib/wifi/AccessPoint;

    invoke-virtual {v4}, Lcom/android/settingslib/wifi/AccessPoint;->getConfig()Landroid/net/wifi/WifiConfiguration;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/android/settings/wifi/details/WifiPrivacyPreferenceController;->setWifiConfiguration(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/settings/wifi/details/WifiPrivacyPreferenceController;->setIsEphemeral(Z)V
    ...
    :goto_1
    invoke-virtual {v3, v4}, Lcom/android/settings/wifi/details/WifiPrivacyPreferenceController;->setIsPasspoint(Z)V

    invoke-interface {v0, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v4, p0, Lcom/android/settings/wifi/details/WifiNetworkDetailsFragment;->mWifiDialogListeners:Ljava/util/List;

    iget-object v5, p0, Lcom/android/settings/wifi/details/WifiNetworkDetailsFragment;->mWifiDetailPreferenceController:Lcom/android/settings/wifi/details/WifiDetailPreferenceController;
...
.method public onScan(Lcom/android/settings/wifi/WifiDialog;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/wifi/details/WifiNetworkDetailsFragment;->startActivityForResult(Landroid/content/Intent;I)V
