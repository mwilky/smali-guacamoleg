...
.method static synthetic access$200(Lcom/android/settings/widget/EntityHeaderController;)Landroidx/fragment/app/Fragment;
    ...
    iget-object v0, p0, Lcom/android/settings/widget/EntityHeaderController;->mFragment:Landroidx/fragment/app/Fragment;
...
.method private bindButton(Landroid/widget/ImageButton;I)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/settings/widget/EntityHeaderController;->mEditOnClickListener:Landroid/view/View$OnClickListener;
    ...
    iget-object v0, p0, Lcom/android/settings/widget/EntityHeaderController;->mEditOnClickListener:Landroid/view/View$OnClickListener;
    ...
    :cond_4
    new-instance v0, Lcom/android/settings/widget/-$$Lambda$EntityHeaderController$Brnf7eM6QIyUvT-lfd4xVnC8TCw;

    invoke-direct {v0, p0}, Lcom/android/settings/widget/-$$Lambda$EntityHeaderController$Brnf7eM6QIyUvT-lfd4xVnC8TCw;-><init>(Lcom/android/settings/widget/EntityHeaderController;)V
...
.method public done(Landroid/app/Activity;Landroid/content/Context;)Lcom/android/settingslib/widget/LayoutPreference;
    ...
    invoke-direct {v0, p2, v1}, Lcom/android/settingslib/widget/LayoutPreference;-><init>(Landroid/content/Context;Landroid/view/View;)V

    const/16 v1, -0x3e8

    invoke-virtual {v0, v1}, Lcom/android/settingslib/widget/LayoutPreference;->setOrder(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settingslib/widget/LayoutPreference;->setKey(Ljava/lang/String;)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/settingslib/widget/LayoutPreference;->setAllowDividerBelow(Z)V
...
.method public synthetic lambda$bindButton$0$EntityHeaderController(Landroid/view/View;)V
    ...
    iget v4, p0, Lcom/android/settings/widget/EntityHeaderController;->mMetricsCategory:I
...
.method public setEditListener(Landroid/view/View$OnClickListener;)Lcom/android/settings/widget/EntityHeaderController;
    .locals 0

    iput-object p1, p0, Lcom/android/settings/widget/EntityHeaderController;->mEditOnClickListener:Landroid/view/View$OnClickListener;
...
.method public styleActionBar(Landroid/app/Activity;)Lcom/android/settings/widget/EntityHeaderController;
    ...
    iget-object v0, p0, Lcom/android/settings/widget/EntityHeaderController;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v3, p0, Lcom/android/settings/widget/EntityHeaderController;->mActivity:Landroid/app/Activity;

    invoke-static {v3, v2, v0}, Lcom/android/settingslib/widget/ActionBarShadowController;->attachToView(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle;Landroid/view/View;)Lcom/android/settingslib/widget/ActionBarShadowController;
