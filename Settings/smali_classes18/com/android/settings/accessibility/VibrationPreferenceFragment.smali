...
.method private loadCandidates(Landroid/content/Context;)V
    ...
    const-string v2, "intensity_off"

    if-eqz v0, :cond_0

    iget-object v3, p0, Lcom/android/settings/accessibility/VibrationPreferenceFragment;->mCandidates:Ljava/util/Map;
    ...
    const-string v5, "intensity_low"

    invoke-direct {v2, p0, v5, v3, v4}, Lcom/android/settings/accessibility/VibrationPreferenceFragment$VibrationIntensityCandidateInfo;-><init>(Lcom/android/settings/accessibility/VibrationPreferenceFragment;Ljava/lang/String;II)V
    ...
    const-string v5, "intensity_medium"
    ...
    const-string v5, "intensity_high"
...
.method protected getDefaultKey()Ljava/lang/String;
    ...
    :cond_2
    iget-object v5, p0, Lcom/android/settings/accessibility/VibrationPreferenceFragment;->mCandidates:Ljava/util/Map;
    ...
    check-cast v6, Lcom/android/settings/accessibility/VibrationPreferenceFragment$VibrationIntensityCandidateInfo;

    invoke-virtual {v6}, Lcom/android/settings/accessibility/VibrationPreferenceFragment$VibrationIntensityCandidateInfo;->getIntensity()I
    ...
    :goto_2
    invoke-virtual {v6}, Lcom/android/settings/accessibility/VibrationPreferenceFragment$VibrationIntensityCandidateInfo;->getKey()Ljava/lang/String;

    move-result-object v8

    const-string v9, "intensity_on"
...
.method protected setDefaultKey(Ljava/lang/String;)Z
    ...
    const-string v2, "VibrationPreferenceFragment"
