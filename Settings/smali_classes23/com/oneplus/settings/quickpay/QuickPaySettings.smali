...
.field private quickpay_select_default_way_category:Landroidx/preference/PreferenceCategory;

.field private quickpay_uninstall_app_category:Landroidx/preference/PreferenceCategory;

.field private quickpay_way_alipay_qrcode:Lcom/android/settings/widget/RadioButtonPreference;

.field private quickpay_way_alipay_scanning:Lcom/android/settings/widget/RadioButtonPreference;

.field private quickpay_way_paytm:Lcom/android/settings/widget/RadioButtonPreference;

.field private quickpay_way_wecaht_qrcode:Lcom/android/settings/widget/RadioButtonPreference;

.field private quickpay_way_wecaht_scanning:Lcom/android/settings/widget/RadioButtonPreference;

.field private switch_lockscreen:Landroidx/preference/SwitchPreference;

.field private switch_unlockscreen:Landroidx/preference/SwitchPreference;
...
.method static synthetic access$100(Lcom/oneplus/settings/quickpay/QuickPaySettings;)Landroidx/preference/SwitchPreference;
    ...
    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;
...
.method public static canShowQuickPay(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v6}, Lcom/oneplus/settings/utils/OPUtils;->isAppExist(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static gotoQuickPaySettingsPage(Landroid/content/Context;)V
    ...
    const-string v3, "QuickPaySettings"
...
.method private initPayWayData()V
    ...
    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_wecaht_qrcode:Lcom/android/settings/widget/RadioButtonPreference;

    invoke-virtual {v0, v1}, Lcom/android/settings/widget/RadioButtonPreference;->setVisible(Z)V

    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_wecaht_scanning:Lcom/android/settings/widget/RadioButtonPreference;
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/widget/RadioButtonPreference;->setVisible(Z)V
    ...
    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_alipay_qrcode:Lcom/android/settings/widget/RadioButtonPreference;

    invoke-virtual {v0, v1}, Lcom/android/settings/widget/RadioButtonPreference;->setVisible(Z)V

    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_alipay_scanning:Lcom/android/settings/widget/RadioButtonPreference;
    ...
    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_paytm:Lcom/android/settings/widget/RadioButtonPreference;
...
.method private initPreference()V
    ...
    invoke-virtual {p0, v0}, Lcom/oneplus/settings/quickpay/QuickPaySettings;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Landroidx/preference/SwitchPreference;

    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_lockscreen:Landroidx/preference/SwitchPreference;

    iget-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_lockscreen:Landroidx/preference/SwitchPreference;
    ...
    iput-object v1, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;

    iget-object v1, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_uninstall_app_category:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_select_default_way_category:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_wecaht_qrcode:Lcom/android/settings/widget/RadioButtonPreference;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_wecaht_scanning:Lcom/android/settings/widget/RadioButtonPreference;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_alipay_qrcode:Lcom/android/settings/widget/RadioButtonPreference;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_alipay_scanning:Lcom/android/settings/widget/RadioButtonPreference;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_way_paytm:Lcom/android/settings/widget/RadioButtonPreference;
...
.method private refreshQuickPayEnableUI(Z)V
    ...
    invoke-virtual {p0}, Lcom/oneplus/settings/quickpay/QuickPaySettings;->getPreferenceScreen()Landroidx/preference/PreferenceScreen;

    move-result-object v0

    iget-object v1, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_select_default_way_category:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_uninstall_app_category:Landroidx/preference/PreferenceCategory;
...
.method private showConfirmChangeHomeAction(ZI)V
    ...
    const-string v1, "longPressHomeActionIndex is out of max length.longPressHomeActionIndex="
...
.method private updateLockHomeAction(Z)V
    ...
    iget-object v3, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;
...
.method private updatePreferenceState()V
    ...
    invoke-virtual {p0}, Lcom/oneplus/settings/quickpay/QuickPaySettings;->getActivity()Landroidx/fragment/app/FragmentActivity;
    ...
    const-string v2, "op_quickpay_default_way"
    ...
    iget-object v6, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_select_default_way_category:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v6, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_uninstall_app_category:Landroidx/preference/PreferenceCategory;
    ...
    :goto_0
    iget-object v9, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mPayWaysNameList:Ljava/util/List;
    ...
    iget-object v9, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->quickpay_select_default_way_category:Landroidx/preference/PreferenceCategory;
    ...
    check-cast v9, Lcom/android/settings/widget/RadioButtonPreference;
    ...
    invoke-virtual {v9, v7}, Lcom/android/settings/widget/RadioButtonPreference;->setChecked(Z)V

    const/4 v6, 0x1

    :cond_0
    invoke-virtual {v9, p0}, Lcom/android/settings/widget/RadioButtonPreference;->setOnPreferenceClickListener(Landroidx/preference/Preference$OnPreferenceClickListener;)V
    ...
    :cond_1
    iget-object v8, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mAllPayWaysPreference:Ljava/util/List;
    ...
    invoke-virtual {v8, v7}, Lcom/android/settings/widget/RadioButtonPreference;->setChecked(Z)V
    ...
    invoke-virtual {v1, v7}, Landroidx/preference/PreferenceCategory;->setVisible(Z)V
    ...
    iget-boolean v6, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mHasFingerprint:Z
    ...
    iget-object v2, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_lockscreen:Landroidx/preference/SwitchPreference;
    ...
    invoke-virtual {v2, v7}, Landroidx/preference/SwitchPreference;->setChecked(Z)V
    ...
    iget-object v10, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_lockscreen:Landroidx/preference/SwitchPreference;
    ...
    iget-object v10, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;

    invoke-virtual {v10, v7}, Landroidx/preference/SwitchPreference;->setChecked(Z)V
    ...
    invoke-virtual {v10, v3}, Landroidx/preference/SwitchPreference;->setChecked(Z)V

    if-nez v8, :cond_b

    iget-object v10, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;

    invoke-virtual {v10, v3}, Landroidx/preference/SwitchPreference;->setEnabled(Z)V

    :cond_b
    :goto_7
    iget-object v10, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_unlockscreen:Landroidx/preference/SwitchPreference;

    invoke-virtual {v10}, Landroidx/preference/SwitchPreference;->isChecked()Z
...
.method private updateUnLockFingerprintLongpressAction(Z)V
    ...
    iget-object v3, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->switch_lockscreen:Landroidx/preference/SwitchPreference;
...
.method public onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget v4, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mDefaultLongPressOnHomeBehavior:I
...
.method public onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mPayWaysKeyList:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mPayWaysValueList:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/oneplus/settings/quickpay/QuickPaySettings;->mAllPayWaysPreference:Ljava/util/List;
