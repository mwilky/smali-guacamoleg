...
.field private static final MMS_PACKAGE_NAME:Ljava/lang/String; = "com.oneplus.mms"
...
.field private static final PROGRESS_MIN_SHOW_TIME:J = 0x1f4L
...
.field private static final WILL_SHOW_PROGRESS_TIME:J = 0x12cL
...
.method private loadShortcutByPackageName(Ljava/lang/String;I)V
    ...
    :goto_1
    iget-object v7, p0, Lcom/oneplus/settings/apploader/OPApplicationLoader;->mAllQuickLaunchShortcuts:Ljava/util/List;
...
.method public loadAllAppList()V
    ...
    iget v7, p0, Lcom/oneplus/settings/apploader/OPApplicationLoader;->mAppType:I
    ...
    invoke-direct {p0, v8, v4}, Lcom/oneplus/settings/apploader/OPApplicationLoader;->getBadgedIcon(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    invoke-virtual {v7, v8}, Lcom/oneplus/settings/better/OPAppModel;->setAppIcon(Landroid/graphics/drawable/Drawable;)V

    iget-object v8, p0, Lcom/oneplus/settings/apploader/OPApplicationLoader;->mAllAppList:Ljava/util/List;
...
.method public loadAllQuickLaunchShortcuts()V
    ...
    :cond_2
    iget-object v2, p0, Lcom/oneplus/settings/apploader/OPApplicationLoader;->resolveinfoAlphaComparator:Ljava/util/Comparator;
