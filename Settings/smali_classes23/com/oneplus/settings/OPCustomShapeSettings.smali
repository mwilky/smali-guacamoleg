...
.method public synthetic lambda$onCreateOptionsMenu$0$OPCustomShapeSettings(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lcom/oneplus/settings/OPCustomShapeSettings;->mOPCustomShapePreference:Lcom/oneplus/settings/ui/OPCustomShapePreference;

    invoke-virtual {v0}, Lcom/oneplus/settings/ui/OPCustomShapePreference;->saveSelectedShape()V

    invoke-virtual {p0}, Lcom/oneplus/settings/OPCustomShapeSettings;->getActivity()Landroidx/fragment/app/FragmentActivity;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/oneplus/settings/OPCustomShapeSettings;->setHasOptionsMenu(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p0}, Lcom/oneplus/settings/OPCustomShapeSettings;->setOnBackPressListener(Lcom/oneplus/settings/OnBackPressListener;)V

    const-string v0, "op_custom_shape_preference"

    invoke-virtual {p0, v0}, Lcom/oneplus/settings/OPCustomShapeSettings;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/oneplus/settings/ui/OPCustomShapePreference;

    iput-object v0, p0, Lcom/oneplus/settings/OPCustomShapeSettings;->mOPCustomShapePreference:Lcom/oneplus/settings/ui/OPCustomShapePreference;
